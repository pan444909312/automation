...
/**
 * 【主干场景】【用户自取】用户选择配送方式为自取，支付成功后直接确认取餐，订单主流程结束
 * <p>
 * 流程：用户下单->自取->支付成功->待接单->等待商家接单（7）->接单并备餐（9）->备餐中（10）->用户确认取餐
 * ->订单主流程结束（22）
 * </p>
 * <p>
 *     <ul>覆盖路径
 *         <li>路径: 1，3， 4， 5， 7，9，10，11，12， 13， 14， 15， 22</li>
 *     </ul>
 * </p>
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/1/3 14:50:28
 */
@SelectClasses({
        // 用户登录
...
public class OrderOfMyselfDeliveryThenUserConfirmOrderScenario {
}
