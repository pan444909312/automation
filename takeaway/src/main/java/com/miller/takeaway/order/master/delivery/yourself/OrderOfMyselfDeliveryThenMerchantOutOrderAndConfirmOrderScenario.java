...
@TestCase(testCaseID = "01HJQY9HJ1H4TNSDDMEYJ8DBB5", name = "【主干场景】【用户自取】用户选择配送方式为自取，支付成功，商家出餐，商家确认用户已取餐，用户确认取餐，订单主流程结束")
public class OrderOfMyselfDeliveryThenMerchantOutOrderAndConfirmOrderScenario {
}
