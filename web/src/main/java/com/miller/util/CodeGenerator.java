...
public class CodeGenerator {
    ...
    public void run() {
        ...
        FastAutoGenerator.create("jdbc:mysql://hp-polar-test-business-master.mysql.polardb.rds.aliyuncs.com:3306/panda_test?allowPublicKeyRetrieval=true", "automation", "20AR@UJsobwLBdih")
