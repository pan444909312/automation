...
(
    ...
    test_case_response_body   varchar(1024) default '' not null comment '最后一次测试用例的响应结果',
    ...
    test_case_request_headers varchar(512)  default '' not null comment '测试用例请求头',
    test_case_request_body    varchar(1024) default '' not null comment '测试用例请求体',
    primary key (id),
