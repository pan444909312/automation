package com.miller.bdm.app.privateShop.add;

import com.miller.bdm.app.privateShop.add.flow.AddPrivateShopFlow;
...
public class AddPrivateShopTests {
    @MethodSource("com.miller.bdm.app.privateShop.add.provider.AddPrivateShopDataProvider#AddPrivateShopList")
    @ParameterizedTest
    @DisplayName("bdm-移动端私海池-私海池商家-新增")
    void QueryPrivateShopList(AddPrivateShopRequestDTO privateShopRequestDTO) {
        ...
        CacheUtils.set(BusinessConstantOfERP.PRIVATE_SHOP_ID_KEY, privateShopResponseDTO.getData());
    }
