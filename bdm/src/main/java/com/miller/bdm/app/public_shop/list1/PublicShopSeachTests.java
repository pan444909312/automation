package com.miller.bdm.app.public_shop.list1;


import com.miller.bdm.app.public_shop.list1.flow.PublicShopSearchFlow;
...
public class PublicShopSeachTests {
    @MethodSource("com.miller.bdm.app.public_shop.list1.provider.PublicShopSeachDataProvider#PublicShopList1")
    @ParameterizedTest
    @DisplayName("bdm-移动端公海池-公海池搜索后商家列表")
