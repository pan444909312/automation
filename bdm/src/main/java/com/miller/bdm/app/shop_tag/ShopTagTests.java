package com.miller.bdm.app.shop_tag;

import com.miller.bdm.app.shop_tag.flow.ShopTagFlow;
...
public class ShopTagTests {
    @MethodSource("com.miller.bdm.app.shop_tag.provider.ShopTagDataProvider#ShopTagList")
    @ParameterizedTest
    @DisplayName("bdm-商家標籤列表")
