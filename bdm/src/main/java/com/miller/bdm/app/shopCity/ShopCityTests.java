package com.miller.bdm.app.shopCity;

import com.miller.bdm.app.shopCity.flow.ShopCityFlow;
import com.miller.bdm.app.shopCity.response.ShopCityResponseDTO;
...
public class ShopCityTests {
    @MethodSource("com.miller.bdm.app.shopCity.provider.ShopCityDataProvider#ShopCityList")
    @ParameterizedTest
    @DisplayName("bdm-商家城市列表")
