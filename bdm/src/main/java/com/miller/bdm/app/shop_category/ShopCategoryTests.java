package com.miller.bdm.app.shop_category;

import com.miller.bdm.app.shop_category.flow.ShopCategoryFlow;
...
public class ShopCategoryTests {
    @MethodSource("com.miller.bdm.app.shop_category.provider.ShopCategoryDataProvider#ShopCategoryList")
    @ParameterizedTest
