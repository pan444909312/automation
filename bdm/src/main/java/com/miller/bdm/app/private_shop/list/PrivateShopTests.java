package com.miller.bdm.app.private_shop.list;

import com.miller.bdm.app.private_shop.list.flow.PrivateShopFlow;
import com.miller.bdm.app.private_shop.list.request.PrivateShopRequestDTO;
import com.miller.bdm.app.private_shop.list.response.PrivateShopResponseDTO;
...
public class PrivateShopTests {
    @MethodSource("com.miller.bdm.app.private_shop.list.provider.PrivateShopDataProvider#PrivateShopList")
    @ParameterizedTest
    @DisplayName("bdm-移动端公海池-公海池商家列表")
