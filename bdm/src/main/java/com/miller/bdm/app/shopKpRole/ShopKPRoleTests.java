package com.miller.bdm.app.shopKpRole;

import com.miller.bdm.app.shopKpRole.flow.ShopKPRoleFlow;
...
public class ShopKPRoleTests {
    @MethodSource("com.miller.bdm.app.shopKpRole.provider.ShopKPRoleDataProvider#ShopKPRoleList")
    @ParameterizedTest
    @DisplayName("bdm-商家KP角色-列表")
    void ShopKPRoleList() {
