...
import com.miller.bdm.login.response.ERPLoginResponseDTO;
...
public class ERPLoginTests {
    ...
    @MethodSource("com.miller.bdm.login.provider.ERPLoginDataProvider#loginDataProviderFromDB")
    @ParameterizedTest
