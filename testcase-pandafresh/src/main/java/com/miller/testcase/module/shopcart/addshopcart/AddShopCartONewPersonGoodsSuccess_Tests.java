 ...
 */
@Scenario(
        scenarioID = "01K06KM1A67ECXKWK4CKTR2GCI", // 自动生成，不要修改
        scenarioName = "pf加购-新人加购新人商品成功",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf加购-新人加购新人商品成功")
public class AddShopCartONewPersonGoodsSuccess_Tests {
