 ...
 */
@Scenario(
        scenarioID = "01K096FFBCK2DP4VCJ1CRE5FFM", // 自动生成，不要修改
        scenarioName = "商品详情-无税的原价",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("商品详情-无税的原价")
public class GetGoodsNoTax_Tests {
    ...
    void shouldSuccess() {
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.result.originalPrice").isEqualTo("\""+x+"\"");
