package com.miller.testcase.module.shopcart.addshopcart;
 ...
 */
@Scenario(
        scenarioID = "01K06KM1A67ECXKWK4CKTR2GCH", // 自动生成，不要修改
        scenarioName = "pf加购-非新人加购新人商品失败",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf加购-非新人加购新人商品失败")
public class AddShopCartONewPersonGoodsFail_Tests {
    ...
    void beforeAll(){
        //查询普通商品
        String sql = "SELECT g.goods_id,gs.goods_sku_id FROM goods g left join goods_sku gs on gs.goods_id=g.goods_id where g.status=1 and g.portal_id=3 and g.is_del=0 and gs.is_del=0 and type=3 limit 10";
        // 查询多条记录
    ...
    void shouldSuccess() {
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.code").isEqualTo(6080);
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.error").isEqualTo("无法加购，该商品为新人专享(6080)");
