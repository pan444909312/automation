package com.miller.testcase.module.goods.recommendgoods;
 ...
 */
@Scenario(
        scenarioID = "01JY132Z6G8YJHNKBFJMTNF287", // 自动生成，不要修改
        scenarioName = "加购推荐：分类页",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("加购推荐：分类页")
public class RecommendGoodsCategory_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValue(requestBody,"pageType",1);
