...
@Scenario(
        scenarioID = "01K49WCKP0ZQ28GE642QZXB7P7", // 自动生成，不要修改
        scenarioName = "pf结算页-配送单-预售商品：加购-结算-进入配送结算页-地址确定未选时间",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf结算页-配送单-预售商品：加购-结算-进入配送结算页-地址确定未选时间")
@Suite
public class GetPreOrderInfoDeliveryPreSaleHasAddressNoTime_Tests {
