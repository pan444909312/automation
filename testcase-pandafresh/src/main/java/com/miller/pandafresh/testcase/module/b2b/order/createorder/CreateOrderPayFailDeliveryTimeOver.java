 ...
 */
@TestFramework
@DisplayName("步骤：b2b创建订单失败：配送时间过期")
public class CreateOrderPayFailDeliveryTimeOver {
    ...
    void shouldSuccess() {
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.message").isEqualTo("配送时间存在变更,请重新前往结算页面！(505)");
    }
} 