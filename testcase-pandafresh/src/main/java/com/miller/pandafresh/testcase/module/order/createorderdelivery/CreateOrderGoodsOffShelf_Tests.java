...
@SelectClasses({
        ...
        CreateOrderGoodsOffShelf.class
})
@Scenario(
        scenarioID = "01K229PRN3TVCQAPPSAXSG072S", // 自动生成，不要修改
        scenarioName = "创建配送单：加购-结算-获取收货地址-获取配送时间段-获取预定单-创建订单-商品下架",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("创建配送单：加购-结算-获取收货地址-获取配送时间段-获取预定单-创建订单-商品下架")
@Suite
public class CreateOrderGoodsOffShelf_Tests {
