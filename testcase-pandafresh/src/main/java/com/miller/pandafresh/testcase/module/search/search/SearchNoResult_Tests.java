 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH28JZ", // 自动生成，不要修改
        scenarioName = "搜索-搜索无结果",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-搜索无结果")
public class SearchNoResult_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValue(requestBody,"keyword","邑");
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.result.records").isEqualTo("[]");
