 ...
 */
@Scenario(
        scenarioID = "01K0E6ZB3Z1N0FXPJR0RVHKW46", // 自动生成，不要修改
        scenarioName = "pf首页-新人专区展示：老用户登录",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf首页-新人专区展示：老用户登录")
public class GetIndexNewPersonAdNotShow_Tests {
