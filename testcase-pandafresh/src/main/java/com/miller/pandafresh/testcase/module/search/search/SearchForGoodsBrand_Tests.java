 ...
 * @author zhangpei
 * @version 2.0
 * @since 2025/12/27 16:56:04
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH29JF", // 自动生成，不要修改
        scenarioName = "搜索-搜索词匹配商品品牌名称",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 5, manualTestTime = 3)
@DisplayName("搜索-搜索词匹配商品品牌名称")
public class SearchForGoodsBrand_Tests {
