 ...
 * @author zhangpei
 * @version 2.0
 * @since 2026/01/06 19:56:04
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH37JW", // 自动生成，不要修改
        scenarioName = "搜索-检查商品规格",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-检查商品规格")
public class SearchResultCheckSku_Tests {
