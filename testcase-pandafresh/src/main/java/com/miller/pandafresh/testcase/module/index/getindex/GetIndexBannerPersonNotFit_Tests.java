 ...
 */
@Scenario(
        scenarioID = "01K0E6ZB3Z1N0FXPJR0RVHKW66", // 自动生成，不要修改
        scenarioName = "pf首页-顶部banner-隐藏：用户身份不符合",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf首页-顶部banner-隐藏：用户身份不符合")
public class GetIndexBannerPersonNotFit_Tests {
    ...
    @BeforeAll
     void beforeAll() throws InterruptedException {
        ...
        try {
            ...
            String sql1 = "update ad a set a.push_user=1 where a.id="+selectOneSql.get("id")+"";
            //将此广告更新为新人可见
    ...
    @AfterAll
     void afterAll(){
        String sql2 = "update ad a set a.push_user=0 where a.id="+selectOneSql.get("id")+"";
        //将此广告更新为所有人可见
