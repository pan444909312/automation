 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH42JW", // 自动生成，不要修改
        scenarioName = "搜索-检查商品烟类型:新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-检查商品烟类型：新索引")
public class SearchResultCheckTobacoNew_Tests {
    ...
    void shouldSuccess() {
        ...
        for (int i = 0; i < goodsList.size(); i++) {
            ...
            Integer name = (Integer) goods.get("isTobacco");
            ...
            Integer expectName = (Integer) expect.get("is_tobacco");
