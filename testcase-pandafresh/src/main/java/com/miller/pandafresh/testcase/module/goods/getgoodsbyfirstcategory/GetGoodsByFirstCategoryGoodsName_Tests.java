 ...
 */
@Scenario(
        scenarioID = "01K0XVBJ5H8Y8NAJT6KW435C41", // 自动生成，不要修改
        scenarioName = "分类页-二级分类商品展示检查：名称正确返回",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("分类页-二级分类商品展示检查：名称正确返回")
public class GetGoodsByFirstCategoryGoodsName_Tests {
    ...
    void shouldSuccess() {
        ...
        for (int i=0;i<goodsList.size();i++) {
            ...
            String nameEn = (String) goods.get("goodsNameEn");
            String nameTC = (String) goods.get("goodsNameTc");
            ...
            String expectNameEn = expect.get("goods_name_EN").toString();
            String expectNameTC = expect.get("goods_name_tc").toString();
