 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH30JC", // 自动生成，不要修改
        scenarioName = "搜索-搜索词匹配商品二级类目名称:新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 5, manualTestTime = 3)
@DisplayName("搜索-搜索词匹配商品二级类目名称：新索引")
public class SearchForGoodsCategorySecondNew_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValue(requestBody,"keyword","茶饮类");
        ...
        for (int i = 0; i < goodsList.size(); i++) {
            ...
            String goodsName = (String) goods.get("secondCategoryName");
            goodsNames.add(goodsName);
        }

        // 断言数组中包含指定的商品类目
        boolean containsExpectedGoods = goodsNames.contains("茶饮类");
