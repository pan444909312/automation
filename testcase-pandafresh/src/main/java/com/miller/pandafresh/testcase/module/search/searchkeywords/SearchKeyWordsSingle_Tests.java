package com.miller.pandafresh.testcase.module.search.searchkeywords;
 ...
 */
@Scenario(
        scenarioID = "01K0C67W3040CMMGYNKNG1MWV3", // 自动生成，不要修改
        scenarioName = "搜索联想词-单个单词",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索联想词-单个单词")
public class SearchKeyWordsSingle_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValue(requestBody,"keyword","g");
        ...
        // 断言数组中包含g开头的关键字
        boolean containsExpectedGoods = keywords.stream().anyMatch(name -> name.contains("果"));
