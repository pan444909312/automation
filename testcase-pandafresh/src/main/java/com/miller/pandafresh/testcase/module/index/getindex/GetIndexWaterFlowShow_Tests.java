 ...
 */
@Scenario(
        scenarioID = "01K0E6ZB3Z1N0FXPJR0RVHKW51", // 自动生成，不要修改
        scenarioName = "pf首页-专题推荐-展示：广告生效中&渠道符合&用户身份符合",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf首页-专题推荐-展示：广告生效中&渠道符合&用户身份符合")
public class GetIndexWaterFlowShow_Tests {

    Map<String, Object> selectOneSql;
    @BeforeAll
     void beforeAll() throws InterruptedException {
        //查找渠道含app的生效的所有用户可见的专题推荐
        ...
        String sql = "SELECT * FROM ad a WHERE a.model=9 and a.del_status=0 and a.`status`=1 " +
                "and a.is_shield_nested_web>3 and a.portal_id=3 and a.push_user=0 and a.end_date>NOW() and a.effect_week='[1,2,3,4,5,6,7]'  ORDER BY a.sort DESC LIMIT 1;";
        try {
            // 查询1条记录
