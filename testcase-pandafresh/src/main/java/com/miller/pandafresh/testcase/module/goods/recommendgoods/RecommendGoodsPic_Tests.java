 ...
 */
@Scenario(
        scenarioID = "01JY132Z6G8YJHNKBFJMTNF290", // 自动生成，不要修改
        scenarioName = "加购推荐：商品图片正确",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 2, manualTestTime = 3)
@DisplayName("加购推荐：商品图片正确")
public class RecommendGoodsPic_Tests {
    ...
    void shouldSuccess() {
        ...
        for (int i=0;i<goodsList.size();i++) {
            ...
            String name = (String) goods.get("goodsPic");
            ...
            String expectName = expect.get("goods_primary_pic_compress").toString();
