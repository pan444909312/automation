 ...
 */
@Scenario(
        scenarioID = "01JY0JQJ9SEC35RYKDC8XVXGMN", // 自动生成，不要修改
        scenarioName = "B2Blogin-登录失败：手机号未注册",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("B2Blogin-登录失败：手机号未注册")
public class LoginWithWrongPhone_Tests {
    ...
    String assertFullField = "module/b2b/loginB2B/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValueByPath(requestBody,"$.pd.phone","12345678901");
