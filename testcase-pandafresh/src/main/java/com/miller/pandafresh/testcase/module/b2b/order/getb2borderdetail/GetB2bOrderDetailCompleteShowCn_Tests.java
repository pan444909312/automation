...
/**
 * GetB2bOrderDetailCompleteShowCn
 *
 * @author zhangpei
 * @version 2.0
 * @since 2025/11/21 14:34:57
 */
@Scenario(
        scenarioID = "01KAJHYZZG0PSY8AKP26FJG5AE", // 自动生成，不要修改
        scenarioName = "b2b订单详情：已完成立即订单展示自动退的cn金额",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("b2b订单详情：已完成立即订单展示自动退的cn金额")
public class GetB2bOrderDetailCompleteShowCn_Tests {
    ...
    void shouldSuccess() {
        ...
        String headers = "module/b2b/order/getb2borderdetailcompleteshowcn/request/headers.json";
        // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
        String params = null;
        // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
        String body = "module/b2b/order/getb2borderdetailcompleteshowcn/request/body.json";
        // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
        String assertFullField = "module/b2b/order/getb2borderdetailcompleteshowcn/response/assert_full_field.json";
