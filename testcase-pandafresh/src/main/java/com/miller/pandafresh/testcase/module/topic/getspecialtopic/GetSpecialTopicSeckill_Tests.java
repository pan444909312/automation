package com.miller.pandafresh.testcase.module.topic.getspecialtopic;
 ...
 */
@Scenario(
        scenarioID = "01JXVNHMWT5RNN4K9N1CQPDJSZ", // 自动生成，不要修改
        scenarioName = "获取专题信息-限时秒杀专题",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("获取专题信息-限时秒杀专题")
public class GetSpecialTopicSeckill_Tests {
    ...
    void beforeAll() {
        //获取临期专题(启用生效中未删除的专题)
        String sql = "SELECT t.* FROM special_topic t  where t.portal_id=3 and t.is_del=0 and t.effect_status=1 and t.special_topic_status=1 and t.type=2 limit 1";
        // 查询多条记录
