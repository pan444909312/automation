 ...
 * @author zhangpei
 * @version 2.0
 * @since 2026/01/05 17:56:04
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH30JW", // 自动生成，不要修改
        scenarioName = "搜索-搜索词匹配商品名称:新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-搜索词匹配商品名称：新索引")
public class SearchForGoodsNameNew_Tests {
    ...
    void shouldSuccess() {
        ...
        // 断言数组中包含指定的商品名称
        boolean containsExpectedGoods = goodsNames.stream().anyMatch(name -> name.contains("东方树叶"));
