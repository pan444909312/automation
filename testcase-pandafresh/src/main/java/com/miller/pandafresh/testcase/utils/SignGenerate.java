...
public final class SignGenerate {
    ...
    public static String getSign(JSONObject json, String appSecret) {
        ...
        log.info("signParams："+str);
        try {
            str = new String(str.getBytes("UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return SignGenerate.encrypt(str, "MD5");
    }
     ...
     * @param请求的所有参数必须已转换为字符串类型
     */
    public static String getSignOfHPF(JSONObject json, String appSecret) {
        Map<String, String> params = toHashMap(json);
        ...
        String str = appSecret + query + appSecret;
        log.info("待加密字符串："+str);
        str = new String(str.getBytes(StandardCharsets.UTF_8));
        return SignGenerate.encryptOfHpf(str, "MD5");
    }
    ...
    public static String encryptOfHpf(String strSrc, String encName) {
        MessageDigest md = null;
        String strDes = null;
    ...
    public static void main(String[] args) throws JSONException {
        ...
        json.remove("sign");
        System.out.println(getSign(json, "merchantKey"));
//        System.out.println(ECloudGenerateUrlUtils.generateURL(json, "merchantKey"));
