 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH34JW", // 自动生成，不要修改
        scenarioName = "搜索-检查商品图片:新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-检查商品图片：新索引")
public class SearchResultCheckPicNew_Tests {
    ...
    void shouldSuccess() {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            String pic = (String) goods.get("goodsPic");
            ...
            String expectPic = expect.get("goods_primary_pic_compress").toString();
