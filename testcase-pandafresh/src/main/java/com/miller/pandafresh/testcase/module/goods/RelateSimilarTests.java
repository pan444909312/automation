...
public class RelateSimilarTests {
    ...
    void shouldSuccessfully() {
        ...
        JSONArray goodsList = TestCaseHelpful.extractValue(responseBody, "data.similarGoodsList");
        String sql = "SELECT * FROM pf_goods_similar s  LEFT JOIN goods g on s.goods_id=g.goods_id WHERE g.portal_id=3 and g.is_del=0 and g.`status`=1 and s.input_goods_id=148717;";
