 ...
 * @author zhangpei
 * @version 2.0
 * @since 2025/06/18 16:20:10
 */
@Scenario(
        scenarioID = "01JY11ZHH1SF954GDVARTHMJ6G", // 自动生成，不要修改
        scenarioName = "融合首页浮窗广告",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("融合首页浮窗广告")
public class GetAdOfFloatWindow_Tests {
    ...
    String assertFullField = "module/getadoffloatwindow/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.result.adVO").isNotNull();
