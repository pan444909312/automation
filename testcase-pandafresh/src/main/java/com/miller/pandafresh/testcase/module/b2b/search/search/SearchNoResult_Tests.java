 ...
 */
@Scenario(
        scenarioID = "01K87ZXZEXH7XJZ72PP3CYWYWE", // 自动生成，不要修改
        scenarioName = "b2b搜索:无结果匹配",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("b2b搜索:无结果匹配")
public class SearchNoResult_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValueByPath(requestBody,"$.pd.keyword","弗负");
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.data.records").isEqualTo("[]");
