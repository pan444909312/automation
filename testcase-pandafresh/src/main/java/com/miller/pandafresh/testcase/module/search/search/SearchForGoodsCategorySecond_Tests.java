 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH29JC", // 自动生成，不要修改
        scenarioName = "搜索-搜索词匹配商品二级类目名称",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 5, manualTestTime = 3)
@DisplayName("搜索-搜索词匹配商品二级类目名称")
public class SearchForGoodsCategorySecond_Tests {
