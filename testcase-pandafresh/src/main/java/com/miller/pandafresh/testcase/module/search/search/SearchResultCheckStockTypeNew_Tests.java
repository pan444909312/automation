 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH40JW", // 自动生成，不要修改
        scenarioName = "搜索-检查商品库存类型:新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-检查商品库存类型：新索引")
public class SearchResultCheckStockTypeNew_Tests {
    ...
    void shouldSuccess() {
        ...
        for (int i = 0; i < goodsList.size(); i++) {
            ...
            Integer name = (Integer) goods.get("inventoryType");
            ...
            Integer expectName = (Integer) expect.get("inventory_type");
