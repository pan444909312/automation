 ...
 */
@TestFramework
@DisplayName("步骤：b2b创建订单失败：缺失收货地址")
public class CreateOrderPayFailNoAddress {
    ...
    void shouldSuccess() {
        ...
        // 从请求体中移除 addressId 参数
        JSONObject jsonObject = JSONUtils.parseObject(requestBody);
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.code").isNotEqualTo(1);
    }
} 