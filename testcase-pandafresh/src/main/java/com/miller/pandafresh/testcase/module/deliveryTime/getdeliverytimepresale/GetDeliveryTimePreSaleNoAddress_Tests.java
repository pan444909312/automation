 ...
 */
@Scenario(
        scenarioID = "01K2PCTKC75KK5K7DE35ZWW05X", // 自动生成，不要修改
        scenarioName = "获取配送时间段:预售单-无地址",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("获取配送时间段:预售单-无地址")
public class GetDeliveryTimePreSaleNoAddress_Tests {
    ...
    void shouldSuccess() {
        ...
        String body = "module/deliveryTime/getdeliverytimepresale/request/body.json";
