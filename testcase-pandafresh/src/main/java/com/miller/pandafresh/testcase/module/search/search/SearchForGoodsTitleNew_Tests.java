 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH30JX", // 自动生成，不要修改
        scenarioName = "搜索-搜索词匹配商品副标题：新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索-搜索词匹配商品副标题：新索引")
public class SearchForGoodsTitleNew_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValue(requestBody,"keyword","副标题");
