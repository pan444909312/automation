package com.miller.pandafresh.testcase.module.ad.getonebyfloatwindow;
 ...
 * @author zhangpei
 * @version 2.0
 * @since 2025/08/28 16:45:52
 */
@Scenario(
        scenarioID = "01JXY6R95F4QXVGXH5M02D8MQN", // 自动生成，不要修改
        scenarioName = "PFapp首页浮窗广告-状态不符",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("PFapp首页浮窗广告-状态不符")
public class GetOneByFloatWindowStatusNotFit_Tests {

    Map<String, Object> selectOneSql;
    @BeforeAll
    void beforeAll() throws InterruptedException {
        //查找渠道包含app的生效的所有用户可见的优先级最高的浮窗广告
    ...
    String uri = TestcaseConfig.HOST + "/ad/getOneByFloatWindow";
    // 接口请求方式。如： GET、POST、PUT、DELETE
    String method = "POST";
    // 请求头。默认从 resources 目录下读取文件。
    String headers = "module/getonebyfloatwindow/request/headers.json";
    // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
    String params = null;
    // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
    String body = "module/getonebyfloatwindow/request/should_success.json";
    // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
    String assert1 = "module/getonebyfloatwindow/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.data").isEqualTo("{}");
