...
@SelectClasses({
        ...
        CreateOrderPayFailGoodsOffShelf.class
})
@Scenario(
        scenarioID = "01K8A4FN5XZTKBFWJQG3RMT6MQ", // 自动生成，不要修改
        scenarioName = "b2b创建订单失败：商品下架",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("b2b创建订单失败：商品下架")
@Suite
public class CreateOrderPayFailGoodsOffShelf_Tests {
