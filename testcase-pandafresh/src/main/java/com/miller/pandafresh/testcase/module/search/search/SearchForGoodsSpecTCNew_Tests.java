 ...
 */
@Scenario(
        scenarioID = "01K0C3VPR6T8F1HQ70SVSH30JG", // 自动生成，不要修改
        scenarioName = "搜索-搜索词匹配商品规格繁体名称：新索引",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 5, manualTestTime = 3)
@DisplayName("搜索-搜索词匹配商品规格繁体名称：新索引")
public class SearchForGoodsSpecTCNew_Tests {
    ...
    void shouldSuccess() {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            String goodsName = FreshTestDBHelpful.executeSelectOneSql(sql).get("spec_value_tc").toString();
