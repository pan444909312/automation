package com.miller.pandafresh.testcase.module.redpacket.getredpacketlistbyorder;
 ...
 */
@Scenario(
        scenarioID = "01JY3BWJDW3ZMGRWXMJ11QMWPB", // 自动生成，不要修改
        scenarioName = "获取订单可用红包：配送单",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("getRedPacketListByOrder")
public class GetRedPacketListByOrderDelivery_Tests {
    ...
    void shouldSuccess() {
        ...
        //配送方式-配送
        requestBody = JSONUtils.updateJsonValue(requestBody,"deliveryMethod",1);
        //红包类型-红包
