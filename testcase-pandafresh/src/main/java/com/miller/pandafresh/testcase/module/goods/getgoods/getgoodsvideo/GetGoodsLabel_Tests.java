 ...
 */
@Scenario(
        scenarioID = "01KAJVJBBKW498Y85DYZAPD5YN", // 自动生成，不要修改
        scenarioName = "商品详情：商品有营销&属性标签",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("商品详情：商品有营销&属性标签")
public class GetGoodsLabel_Tests {
    ...
    void shouldSuccess() {
        ...
        String assertFullField = "module/goods/getgoods/getgoodsvideo/response/assert_full_field_label.json";
