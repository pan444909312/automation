 ...
 */
@Scenario(
        scenarioID = "01K4SDTDQQC9FTKPC480AG0TE4", // 自动生成，不要修改
        scenarioName = "b2b订单列表：待付款订单",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("b2b订单列表：待付款订单")
public class GetB2bOrderListWaitPay_Tests {
    ...
    void shouldSuccess() {
        ...
        requestBody = JSONUtils.updateJsonValueByPath(requestBody,"$.pd.orderStatus",5);
