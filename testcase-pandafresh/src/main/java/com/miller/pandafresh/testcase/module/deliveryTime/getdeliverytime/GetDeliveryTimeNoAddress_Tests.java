 ...
 * @author zhangpei
 * @version 2.0
 * @since 2025/08/29 17:11:36
 */
@Scenario(
        scenarioID = "01JY317E0C3WXMCYKN6SPHGJH5", // 自动生成，不要修改
        scenarioName = "获取配送时间段:普通单-未选地址",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("获取配送时间段:普通单-未选地址")
public class GetDeliveryTimeNoAddress_Tests {
    ...
    void shouldSuccess() {
        ...
        String body = "module/deliveryTime/getdeliverytime/request/bodyNoAddress.json";
