package com.miller.pandafresh.testcase.module.topic.getspecialtopicgoods;
 ...
 */
@Scenario(
        scenarioID = "01K0ZRWYDRT11FGY6KYBEX37NH", // 自动生成，不要修改
        scenarioName = "专题商品-限时秒杀专题：展示专题关联的上架商品",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("专题商品-限时秒杀专题：展示专题关联的上架商品")
public class GetSpecialTopicGoodsSeckill_Tests {
    ...
    void beforeAll(){
        //查询宁波站点下生效中的限时秒杀专题
        String sql = "SELECT * FROM special_topic t WHERE t.type=2 and t.is_del=0 and t.effect_status=1 and t.portal_id=3 ORDER BY t.special_topic_id DESC LIMIT 1;";
        // 查询1条记录
