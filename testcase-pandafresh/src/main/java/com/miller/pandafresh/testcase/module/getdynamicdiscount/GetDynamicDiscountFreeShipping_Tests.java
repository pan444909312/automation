package com.miller.pandafresh.testcase.module.getdynamicdiscount;
 ...
 */
@Scenario(
        scenarioID = "01JXYP37VKYE3GBTD04C8K9CVI", // 自动生成，不要修改
        scenarioName = "首页凑单提示：开启首单免运",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("首页凑单提示：开启首单免运")
public class GetDynamicDiscountFreeShipping_Tests {
    ...
    void shouldSuccess() {
        ...
        TestCaseHelpful.assertThatJson(responseBody).inPath("$.result.freeShipping").isEqualTo(true);
