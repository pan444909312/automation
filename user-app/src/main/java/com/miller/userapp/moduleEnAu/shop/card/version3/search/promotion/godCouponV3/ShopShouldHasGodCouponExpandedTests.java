package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.godCouponV3;
...
@Scenario(scenarioID = "01K9VH77WRQ9TZT8XD8AAK6NA0", scenarioName = "搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：神券标签41-已膨胀至X｜店铺未加码",
...
public class ShopShouldHasGodCouponExpandedTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：神券标签41-已膨胀至X｜店铺未加码")
