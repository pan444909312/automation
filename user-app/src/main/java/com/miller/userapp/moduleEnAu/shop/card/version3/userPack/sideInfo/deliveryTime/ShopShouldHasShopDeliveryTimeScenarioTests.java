package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.sideInfo.deliveryTime;
 ...
 */
@Scenario(scenarioID = "01K7E88BKH5FXQ09S72H8Z37YQ",
        scenarioName = "商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_自取时间_自取频道-商卡二期：自取时间 - 取单独商家自取时间",
...
public class ShopShouldHasShopDeliveryTimeScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺自取商卡-SKYX01_辅助信息_自取时间_自取频道-商卡二期：自取时间 - 取单独商家自取时间 ")
