package com.miller.userapp.moduleEnAu.shop.card.version3.search.feature.evaluation;
 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593Q",
        scenarioName = "搜索列表商卡-SKYX01_营销标_人工营销标签_搜索列表-商卡二期：营销文案 - 无数据",
...
public class ShopShouldHasNoEvaluationFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_人工营销标签_搜索列表-商卡二期：营销文案 - 无数据")
