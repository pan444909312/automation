 ...
 */
@Scenario(scenarioID = "01K7E812EE5QF5D7NTAPAZFMYB",
        scenarioName = "商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_自取距离_自取频道-商卡二期：自取距离 - 取缓存距离",
...
public class ShopShouldHasShopCacheDeliveryDistanceScenarioTests {
   ...
   @ParameterizedTest
   @DisplayName("普通店铺自取商卡-SKYX01_辅助信息_自取距离_自取频道-商卡二期：自取距离 - 取缓存距离 ")
