package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.sideInfo.deliveryDistance;
 ...
 */
@Scenario(scenarioID = "01K7E81BCD7RJQDY1K0H1CK4N9",
        scenarioName = "商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_自取距离_自取频道-商卡二期：自取距离 - 取实际距离*距离权重",
...
public class ShopShouldHasShopRealDeliveryDistanceScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺自取商卡-SKYX01_辅助信息_自取距离_自取频道-商卡二期：自取距离 - 取实际距离*距离权重 ")
