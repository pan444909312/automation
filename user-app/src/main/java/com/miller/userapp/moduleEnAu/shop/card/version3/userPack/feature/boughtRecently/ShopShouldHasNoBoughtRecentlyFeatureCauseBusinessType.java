 ...
 */
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6YD",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_买过的店_店铺业务类型不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseBusinessType {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_买过的店_店铺业务类型不符合买过的店标签时，不返回标签")
