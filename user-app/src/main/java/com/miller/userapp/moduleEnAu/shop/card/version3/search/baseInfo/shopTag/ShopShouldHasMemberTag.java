...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5931",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店前标签：VIP标签_搜索列表-商卡二期：VIP标签",
...
public class ShopShouldHasMemberTag {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店前标签：VIP标签_搜索列表-商卡二期：VIP标签")
