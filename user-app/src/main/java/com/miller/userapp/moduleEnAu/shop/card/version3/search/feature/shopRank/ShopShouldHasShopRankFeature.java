package com.miller.userapp.moduleEnAu.shop.card.version3.search.feature.shopRank;
 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5947",
        scenarioName = "搜索列表商卡-SKYX01_营销标_品类榜单_搜索列表-商卡二期：榜单",
...
public class ShopShouldHasShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_品类榜单_搜索列表-商卡二期：榜单")
