package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.feature.shopRank;
 ...
 */
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6Z4",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_品类榜单_自取频道：榜单 - 无榜单数据",
...
public class ShopShouldHasNoShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_品类榜单_自取频道：榜单 - 无榜单数据")
