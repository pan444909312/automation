...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5935",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签 - 商家不属于会场内的商家列表，不返回标签",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)

@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasNoVenueTagCauseShopNotInVenue {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签 - 商家不属于会场内的商家列表，不返回标签")
