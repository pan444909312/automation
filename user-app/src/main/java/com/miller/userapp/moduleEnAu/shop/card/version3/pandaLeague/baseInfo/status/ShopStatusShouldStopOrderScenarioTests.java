...
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3B8", scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_基础信息_店铺营业状态_首页-商卡二期:店铺营业状态-暂停接单"
...
//        XXLJobUtils.triggerJob(new PropertiesUtils().getProperty(ShopShouldHasLabelScenarioTests.class, "user.app.job.increment.shop.index.update.id"));
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_基础信息_店铺营业状态_首页-商卡二期:店铺营业状态-暂停接单")
