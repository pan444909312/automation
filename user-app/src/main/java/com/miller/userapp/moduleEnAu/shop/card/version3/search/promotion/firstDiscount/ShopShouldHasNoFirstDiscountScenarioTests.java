package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.firstDiscount;
 ...
 */
@Scenario(scenarioID = "01K9VH77WS3962V3FZBZ4V31ZR", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_平台首单_搜索列表-商卡二期：平台首单23-不展示",
...
public class ShopShouldHasNoFirstDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_平台首单_搜索列表-商卡二期：平台首单23-不展示")
