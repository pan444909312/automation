package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.feature.sort;
 ...
 */
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6Z8",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理",
...
public class ShopPartFeatureSort {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理")
