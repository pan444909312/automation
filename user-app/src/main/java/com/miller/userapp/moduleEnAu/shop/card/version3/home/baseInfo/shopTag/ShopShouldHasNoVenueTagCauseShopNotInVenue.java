...
@Scenario(scenarioID = "01K971Z4WFXTNJP025XP3GX0BJ",
        scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店前标签：会场模版标签_首页-商卡二期：会场模版标签 - 商家不属于会场内的商家列表，不返回标签",
...
public class ShopShouldHasNoVenueTagCauseShopNotInVenue {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店前标签：会场模版标签_首页-商卡二期：会场模版标签 - 商家不属于会场内的商家列表，不返回标签")
