 ...
 */
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3E1",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseOrderCnt {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签")
