...
@Scenario(scenarioID = "01K9RPEEDGAQ531N4DDMXMNTZ2",
        scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店前标签优先级-模板标签大于百万补贴标签",
...
public class ShopTagPriorityVenueGTSubsidy {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店前标签优先级-模板标签大于百万补贴标签")
