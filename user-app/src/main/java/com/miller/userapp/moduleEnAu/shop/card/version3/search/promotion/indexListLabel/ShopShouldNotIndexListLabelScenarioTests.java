package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.indexListLabel;
 ...
 */
@Scenario(scenarioID = "01K9VH77WRQ9TZT8XD8AAK6N9X", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_营销标签_搜索列表-商卡二期：营销标签tpye=22-不展示",
...
public class ShopShouldNotIndexListLabelScenarioTests {
    ...
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_营销标签_搜索列表-商卡二期：营销标签tpye=22-不展示")
