package com.miller.userapp.moduleEnAu.shop.card.version3.search.feature.sort;
 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP594A",
        scenarioName = "搜索列表商卡-SKYX01_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理",
...
public class ShopPartFeatureSort {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理")
