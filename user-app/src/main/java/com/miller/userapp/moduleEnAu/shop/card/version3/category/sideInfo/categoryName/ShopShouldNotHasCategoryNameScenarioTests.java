package com.miller.userapp.moduleEnAu.shop.card.version3.category.sideInfo.categoryName;
...
@TestFramework
@Scenario(scenarioID = "01K671EM3GHG2897Z0XTR2EWVD", scenarioName = "用户-品类频道店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-辅助信息-类目-品类频道-商卡二期：类目 - 无数据"
