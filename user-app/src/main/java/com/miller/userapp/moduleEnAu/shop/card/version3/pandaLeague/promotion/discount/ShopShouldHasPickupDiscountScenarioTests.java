 ...
 */
@Scenario(scenarioID = "01K47416DXFVM27WFYXACDTBYZ",
        scenarioName = "商卡(中文)_普通店铺配送商卡_优惠标签_商品折扣_熊猫联盟频道-商卡二期:商品折扣28-自取可用",
...
public class ShopShouldHasPickupDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_优惠标签_商品折扣_熊猫联盟频道-商卡二期:商品折扣28-自取可用")
