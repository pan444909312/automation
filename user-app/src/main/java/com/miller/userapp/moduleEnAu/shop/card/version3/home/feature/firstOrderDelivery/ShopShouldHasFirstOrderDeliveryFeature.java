package com.miller.userapp.moduleEnAu.shop.card.version3.home.feature.firstOrderDelivery;
 ...
 */
@Scenario(scenarioID = "01K0V7PH8ZT17GZDKXCQGMNKBW",
        scenarioName = "普通店铺配送商卡-SKYX01_营销标_首单优先送_首页-商卡二期：首单优先送",
...
public class ShopShouldHasFirstOrderDeliveryFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_营销标_首单优先送_首页-商卡二期：首单优先送")
