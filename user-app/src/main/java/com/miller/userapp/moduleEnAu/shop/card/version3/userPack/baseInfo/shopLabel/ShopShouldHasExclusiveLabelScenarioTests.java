...
@Scenario(scenarioID = "01K7JWZ6K4DWFM9BXDPQD79D43",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺角标_自取频道:独家店铺开启独家角标,会展示独家角标",
...
public class ShopShouldHasExclusiveLabelScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺角标_自取频道:独家店铺开启独家角标,会展示独家角标")
