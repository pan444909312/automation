 ...
 */
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7FW", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31",
...
public class ShopShouldHasVoucherScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31")
