package com.miller.userapp.moduleEnAu.shop.card.version3.pandaLeague.feature.shopRank;
 ...
 */
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3C0",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_品类榜单_首页-商卡二期：榜单 - 无榜单数据",
...
public class ShopShouldHasNoShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_品类榜单_首页-商卡二期：榜单 - 无榜单数据")
