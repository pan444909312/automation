...
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3C8",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_下单人数标签_满足条件，返回下单人数标签",
...
public class ShopShouldHasLastOrderNumFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_人下单人数标签_满足条件，返回下单人数标签")
