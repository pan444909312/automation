package com.miller.userapp.moduleEnAu.shop.card.version3.search.baseInfo.shopLabel;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592S",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:非独家店铺，配置了独家角标也不展示该角标",
...
public class ShopShouldHasNoExclusiveLabelCauseConfigIsClose {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:非独家店铺，配置了独家角标也不展示该角标")
