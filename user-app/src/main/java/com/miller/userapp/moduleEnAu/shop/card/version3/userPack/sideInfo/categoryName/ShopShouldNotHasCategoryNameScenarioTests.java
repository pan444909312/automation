package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.sideInfo.categoryName;
...
@TestFramework
@Scenario(scenarioID = "01K7E80P0TFWTMV6FCRVQ9VKTC", scenarioName = "用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-类目-自取频道-商卡二期：类目 - 无数据"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-类目-自取频道-商卡二期：类目 - 无数据")
