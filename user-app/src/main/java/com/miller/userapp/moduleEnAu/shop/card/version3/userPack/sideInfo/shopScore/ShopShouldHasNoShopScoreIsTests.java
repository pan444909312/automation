...
@Scenario(scenarioID = "01K7E8D63FV9688FKQ6BE5J8VK",
        scenarioName = "商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_店铺评分_自取频道-商卡二期：店铺评分-无数据",
...
//                .set(ShopSearchMiddleEntity::getPraiseAverageNew, 0));
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_店铺评分_自取频道-商卡二期：店铺评分-无数据")
