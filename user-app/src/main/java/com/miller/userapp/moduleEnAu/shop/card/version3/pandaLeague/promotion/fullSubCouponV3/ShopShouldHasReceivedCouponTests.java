...
@Scenario(scenarioID = "01K47416DYTE34FK0ZBRFPPQM8", scenarioName = "普通店铺配送商卡-熊猫联盟频道_优惠标签_神券_熊猫联盟频道-商卡二期-SKYX实验组：账户内最大红包43｜满减红包",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasReceivedCouponTests {
...
//     }
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_优惠标签_神券_熊猫联盟频道-商卡二期-SKYX实验组：账户内最大红包43｜满减红包")
     void couponGodDsicount(ShopListRequestDTO shopListRequestDTO) {
      ...
      assertThat(shopPromoteVOS.get(0).getShowContent()).isEqualTo("¥50红包");
