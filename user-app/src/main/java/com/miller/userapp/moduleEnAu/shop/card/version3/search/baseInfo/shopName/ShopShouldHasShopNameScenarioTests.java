package com.miller.userapp.moduleEnAu.shop.card.version3.search.baseInfo.shopName;
...
/**
 * 搜索列表商卡-SKYX01_基础信息_店铺名称_搜索列表-商卡二期:店铺名称
 *
 * @author Miller Shan
 * @version 1.0
...
public class ShopShouldHasShopNameScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺名称_搜索列表-商卡二期:店铺名称")
