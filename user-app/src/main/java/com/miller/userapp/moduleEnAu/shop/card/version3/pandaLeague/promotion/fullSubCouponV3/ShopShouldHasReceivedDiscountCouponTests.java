package com.miller.userapp.moduleEnAu.shop.card.version3.pandaLeague.promotion.fullSubCouponV3;
...
@Scenario(scenarioID = "01K47416DYTE34FK0ZBRFPPQM9", scenarioName = "普通店铺配送商卡-熊猫联盟频道_优惠标签_账户内最大红包_熊猫联盟频道-商卡二期-SKYX实验组：账户内最大红包43｜折扣红包",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasReceivedDiscountCouponTests {
    ...
    void beforeAll() {
        ...
        UserLoginFlow.loginAndPutToken(userLoginRequestDTO);
         ...
         userCdkeyInfoSql.updateRedPacketUsedStatusExclude(String.valueOf(userId),Long.parseLong(new PropertiesUtils().getProperty(this.getClass(), "user.app.for.test.shop.card.version3.redpacketId5")));
         userCdkeyInfoSql.updateRedPacketUsedStatus(String.valueOf(userId),Long.parseLong(new PropertiesUtils().getProperty(this.getClass(), "user.app.for.test.shop.card.version3.redpacketId5")), (byte) 0);
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_优惠标签_账户内最大红包_熊猫联盟频道-商卡二期-SKYX实验组：账户内最大红包43｜折扣红包")
     void couponGodDsicount(ShopListRequestDTO shopListRequestDTO) {
      ...
      assertThat(shopPromoteVOS.get(0).getShowContent()).isEqualTo("3折红包");
