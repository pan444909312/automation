package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.promotion.discount;
...
public class ShopShouldHasTakeOutDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺自取商卡_优惠标签_商品折扣_自取频道-商卡二期:商品折扣3-外卖可用")
    void shouldExistPickupDiscount(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopPromoteList.get(0).getShowContent()).isEqualTo("低至7.7折");
        assertThat(shopPromoteList.get(0).getTagType()).isEqualTo(2);
