package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.feature.lastOrderNum;
...
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6YX",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_下单人数标签_满足条件，返回下单人数标签",
...
public class ShopShouldHasLastOrderNumFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_人下单人数标签_满足条件，返回下单人数标签")
