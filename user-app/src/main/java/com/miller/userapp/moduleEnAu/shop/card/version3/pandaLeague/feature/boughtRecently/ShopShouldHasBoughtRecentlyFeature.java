package com.miller.userapp.moduleEnAu.shop.card.version3.pandaLeague.feature.boughtRecently;
 ...
 */
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3C6",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签",
...
public class ShopShouldHasBoughtRecentlyFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签")
    void shouldExistEvaluationFeature(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopFeatureVO.getShowContent()).isEqualTo(ShopFeatureEnum.BOUGHT_RECENTLY.getName());
    }
