...
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3E6",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_回头客_首页-商卡二期：回头客 - 回头客展示开关禁用(有服务器本地缓存不会立即生效)",
...
public class ShopShouldHasNoReturnedVisitorFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_回头客_首页-商卡二期：回头客 - 回头客展示开关禁用(有服务器本地缓存不会立即生效)")
