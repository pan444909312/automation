...
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7GD", scenarioName = "搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 折扣红包 - 不展示：对照组",
...
public class ShopShouldHasNoPandaCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 折扣红包 - 不展示：对照组")
