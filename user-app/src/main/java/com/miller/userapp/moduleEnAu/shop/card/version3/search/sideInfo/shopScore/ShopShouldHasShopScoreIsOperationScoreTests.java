package com.miller.userapp.moduleEnAu.shop.card.version3.search.sideInfo.shopScore;
...
@Scenario(scenarioID = "01K9VH77WP0C58RKEXC7J548F4",
        scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_辅助信息_店铺评分_搜索列表-商卡二期：店铺评分-手动设置综合评分",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)_搜索列表商卡-SKYX01_辅助信息_店铺评分_搜索列表-商卡二期：店铺评分-手动设置综合评分")
