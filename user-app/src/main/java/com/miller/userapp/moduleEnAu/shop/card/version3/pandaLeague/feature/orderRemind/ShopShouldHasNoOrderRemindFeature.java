...
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3E2",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单",
...
public class ShopShouldHasNoOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单")
