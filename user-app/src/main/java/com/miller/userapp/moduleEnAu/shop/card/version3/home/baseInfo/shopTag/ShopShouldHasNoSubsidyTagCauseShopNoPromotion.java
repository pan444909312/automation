...
@Scenario(scenarioID = "01K0V5E94ADBN3YE5226AMGTQ4",
        scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店前标签：百万补贴_首页-商卡二期：百万补贴 - 店铺没有一个优惠活动，不返回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)

@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasNoSubsidyTagCauseShopNoPromotion {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店前标签：百万补贴_首页-商卡二期：百万补贴 - 店铺没有一个优惠活动，不返回")
