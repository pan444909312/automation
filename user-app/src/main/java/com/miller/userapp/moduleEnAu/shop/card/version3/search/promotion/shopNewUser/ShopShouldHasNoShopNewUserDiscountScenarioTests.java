package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.shopNewUser;
 ...
 */
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7G3", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_新客爆品_搜索列表-商卡二期：新客爆品25-不展示",
...
public class ShopShouldHasNoShopNewUserDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_新客爆品_搜索列表-商卡二期：新客爆品25-不展示")
