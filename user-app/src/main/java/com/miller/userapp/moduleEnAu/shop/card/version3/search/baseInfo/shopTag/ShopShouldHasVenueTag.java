...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5938",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)

@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasVenueTag {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签")
    void memberBenefitDeliveryDsicount(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopIndexVO.getActivityTagType()).isEqualTo(6);
