package com.miller.userapp.moduleEnAu.shop.card.version3.pandaLeague.feature.dineInSame;
 ...
 */
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3C1",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_堂食同价_首页-商卡二期：堂食同价 - 不展示",
...
public class ShopShouldHasNoDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_堂食同价_首页-商卡二期：堂食同价 - 不展示")
