package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.firstOrder;
...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01K9VH77WS3962V3FZBZ4V31ZM", scenarioName = "用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-SKYX01-优惠标签-新人首单标签-搜索列表-商卡二期：新人首单标签35-不展示：非人群"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-SKYX01-优惠标签-新人首单标签-搜索列表-商卡二期：新人首单标签35-不展示：非人群")
...
//        更新数据库，将user_label表数据label_id设置为0
    ...
    @DisplayName("用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-优惠标签-新人首单标签-搜索列表-商卡二期：新人首单标签35-不展示：非人群")
