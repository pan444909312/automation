package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.baseInfo.shopLabel;
...
/**
 * 普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺角标_自取频道:店铺角标
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/06/25 21:17:39
 */
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6XV",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺角标_自取频道:店铺角标-展示",
...
public class ShopShouldHasLabelScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺角标_自取频道:店铺角标-展示")
