package com.miller.userapp.moduleEnAu.shop.card.version3.pandaLeague.feature.sort;
 ...
 */
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3C9",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_排序_当商家满足当前所有标签时，检查顺序",
...
public class ShopFeatureDefaultSort {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_排序_当商家满足当前所有标签时，检查顺序")
