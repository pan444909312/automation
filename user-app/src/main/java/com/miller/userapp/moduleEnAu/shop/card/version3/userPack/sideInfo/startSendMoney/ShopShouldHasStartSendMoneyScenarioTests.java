package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.sideInfo.startSendMoney;
...
@TestFramework
@Scenario(scenarioID = "01K7E8CF75RMZHXRT9HGQPZTJF", scenarioName = "用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-起送价-商卡二期：起送价"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-起送价-商卡二期：起送价")
