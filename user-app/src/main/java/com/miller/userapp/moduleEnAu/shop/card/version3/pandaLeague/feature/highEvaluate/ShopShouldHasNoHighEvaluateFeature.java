package com.miller.userapp.moduleEnAu.shop.card.version3.pandaLeague.feature.highEvaluate;
...
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3D8",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_评价标签_评价人数不满足配置，不展示",
...
public class ShopShouldHasNoHighEvaluateFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_营销标_评价标签_评价人数不满足配置，不展示")
