...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592K", scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 营业不可预约"
...
public class ShopNoPreOrderSupportStatusOpenScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 营业不可预约")
    ...
    static Stream<Arguments> shopStatusDataProvider() {
        ...
        shopListRequestDTO.setKeywords("营业不可预约"); // 开发代码Bug，没有对 null 进行判断，应该默认给false的
