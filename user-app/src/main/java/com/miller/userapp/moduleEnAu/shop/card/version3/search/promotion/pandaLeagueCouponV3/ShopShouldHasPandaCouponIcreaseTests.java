package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.pandaLeagueCouponV3;
...
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7GC", scenarioName = "搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (加码)",
...
public class ShopShouldHasPandaCouponIcreaseTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (加码)")
