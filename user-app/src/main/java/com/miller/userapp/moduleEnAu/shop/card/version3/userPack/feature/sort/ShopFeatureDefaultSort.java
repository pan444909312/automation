 ...
 */
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6Z7",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_排序_当商家满足当前所有标签时，检查顺序",
...
public class ShopFeatureDefaultSort {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_排序_当商家满足当前所有标签时，检查顺序")
