package com.miller.userapp.moduleEnAu.shop.card.version3.search.sideInfo.deliveryTime;
 ...
 */
@Scenario(scenarioID = "01K9VH77WP0C58RKEXC7J548FD",
        scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_辅助信息_配送时间_搜索列表-商卡二期：配送时间 - 取高峰期出餐时间",
...
public class ShopShouldHasFastigiumDeliveryTimeScenarioTests {
   ...
   @ParameterizedTest
   @DisplayName("搜索列表商卡-SKYX01_辅助信息_配送时间_搜索列表-商卡二期：配送时间 - 取高峰期出餐时间 ")
