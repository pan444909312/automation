package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.sideInfo.feeDiscount;
...
@TestFramework
@Scenario(scenarioID = "01K7E890H5Z3RXHNAM3CW5VCY5", scenarioName = "用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-运费减免优惠-自取频道-商卡二期：运费减免优惠-不展示"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-运费减免优惠-自取频道-商卡二期：运费减免优惠-不展示(当前仍然返回但是客户端不展示)")
public class ShopShouldHasSendMoneyDiscountScenarioTests {
    ...
    @DisplayName("用户-自取频道店铺流-商卡(中文)-普通店铺自取商卡-SKYX01-辅助信息-运费减免优惠-自取频道-商卡二期：运费减免优惠-不展示")
    ...
    void hasSendMoneyDiscountInfo(ShopListRequestDTO ShopListRequestdto) {
        ...
        assertThat(sendMoneyDiscount).isEqualTo(100L);
