...
/**
 * 商卡(英文)_普通店铺配送商卡-SKYX01_优惠标签_会员折扣_首页-商卡二期：会员折扣44-会员身份
 *
 * @author yancancan@hungrypandagroup.com
 */
@Scenario(scenarioID = "TODO_FILL_SCENARIO_ID",
        scenarioName = "商卡(英文)_普通店铺配送商卡-SKYX01_优惠标签_会员折扣_首页-商卡二期：会员折扣44-会员身份",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@TestFramework
@DisplayName("商卡(中文)")
public class ShopShouldHasMemberVipDiscountTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_会员折扣_首页-商卡二期：会员折扣44-会员身份")
    void shouldHasMemberVipDiscount(ShopListRequestDTO shopListRequestDTO) {
