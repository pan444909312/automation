package com.miller.userapp.moduleEnAu.shop.card.version3.search.feature.orderRemind;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5941",
        scenarioName = "搜索列表商卡-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单",
...
public class ShopShouldHasNoOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单")
