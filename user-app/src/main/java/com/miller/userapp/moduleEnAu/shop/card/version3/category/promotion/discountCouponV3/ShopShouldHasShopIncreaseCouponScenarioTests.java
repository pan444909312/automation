 ...
 * date: 2025/07/26
 */
@Scenario(scenarioID = "01K67DEA7EF12N68TH5Y7VEH1Y", scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_店铺红包品类频道-品类频道-商卡二期-SKYX实验组：店铺红包42｜店铺金额加码（满减）",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasShopIncreaseCouponScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_店铺红包品类频道-品类频道-商卡二期-SKYX实验组：店铺红包42｜店铺金额加码（满减）")
