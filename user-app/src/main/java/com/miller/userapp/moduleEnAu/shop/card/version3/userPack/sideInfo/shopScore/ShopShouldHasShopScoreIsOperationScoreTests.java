package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.sideInfo.shopScore;
...
@Scenario(scenarioID = "01K7E8CNRHBWHSNWBJFPA44N91",
        scenarioName = "商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_店铺评分_自取频道-商卡二期：店铺评分-手动设置综合评分",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)_普通店铺自取商卡-SKYX01_辅助信息_店铺评分_自取频道-商卡二期：店铺评分-手动设置综合评分")
