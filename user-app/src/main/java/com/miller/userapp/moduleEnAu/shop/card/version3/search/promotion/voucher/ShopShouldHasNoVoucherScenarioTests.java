package com.miller.userapp.moduleEnAu.shop.card.version3.search.promotion.voucher;
 ...
 */
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7FX", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31-不展示",
...
public class ShopShouldHasNoVoucherScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31-不展示")
