package com.miller.userapp.moduleEnAu.shop.card.version3.userPack.feature.dineInSame;
 ...
 */
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6YK",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_堂食同价_自取频道：堂食同价 - 不展示",
...
public class ShopShouldHasNoDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_堂食同价_自取频道：堂食同价 - 不展示")
