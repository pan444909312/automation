package com.miller.userapp.moduleEnAu.shop.card.version3.search.feature.firstOrderDelivery;
 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593S",
        scenarioName = "搜索列表商卡-SKYX01_营销标_首单优先送_搜索列表-商卡二期：首单优先送 - 不展示",
...
//        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("update hp_sys_app_config set config_value = all where config_key='FIRST_ORDER_DELIVERY_CONFIG'");
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_首单优先送_搜索列表-商卡二期：首单优先送 - 不展示")
