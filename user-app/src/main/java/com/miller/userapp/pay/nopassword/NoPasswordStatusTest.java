...
import com.miller.userapp.pay.nopassword.flow.NoPasswordStatusFlow;
...
public class NoPasswordStatusTest {
    @MethodSource("com.miller.userapp.pay.nopassword.provider.NoPasswordStatusProvider#noPasswordStatusProvider")
    @ParameterizedTest
