...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592J", scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 打烊不可预约"
...
public class ShopNoPreOrderSupportStatusCloseScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 打烊不可预约")
