package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.sortRule;
...
@Scenario(scenarioID = "01KJ6V2PD25THHS9GMPYPH4J98", scenarioName = "搜索列表-商卡二期-SKYX实验组：红包类型标签-优先级（非会员默认排序）",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("搜索列表-商卡二期-SKYX实验组：红包类型标签-优先级（非会员默认排序）")
