...
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS63",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺营业状态_搜索列表-商卡二期:店铺营业状态-忙碌",
...
public class ShopStatusIsBusyScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺营业状态_搜索列表-商卡二期:店铺营业状态-忙碌")
