...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01JV6RCKS63YM5GE0Y9WC3CFP3", scenarioName = "普通天降链路-天降弹窗-智能营销对照组-手动领取-强推活动-弹窗"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 120, maintenanceTime = 0, manualTestTime = 15)
public class GroupPopupForcedCollectPopScenarioTests {
...
//        清除用户已领取的天降数据,红包数据
        ...
        for (GroupPopupForcedCollectPopScenarioTests.RedPacketConfig redPacketConfig : RED_PACKET_CONFIGS) {
...
//        myheaders.put("testGroup", testGroup);
...
//        RequestUtils.getHeaders().remove("cityName");
    ...
    @DisplayName("普通天降链路-天降弹窗-智能营销对照组-手动领取-强推活动-弹窗")
...
//        获取天降结果
    ...
    private void verifyRedPacketConfig(
            ...
            GroupPopupForcedCollectPopScenarioTests.RedPacketConfig config
    ) {
