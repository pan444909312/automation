package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.dineInSame;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS6B",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_堂食同价_搜索列表-商卡二期：堂食同价 - 不展示",
...
public class ShopShouldHasNoDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_堂食同价_搜索列表-商卡二期：堂食同价 - 不展示")
