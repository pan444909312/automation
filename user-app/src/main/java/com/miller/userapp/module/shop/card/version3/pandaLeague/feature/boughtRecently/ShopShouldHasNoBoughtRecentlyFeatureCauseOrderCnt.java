 ...
 */
@Scenario(scenarioID = "01K0V7PH8ZT17GZDKXCQGMNKBK",
        scenarioName = "普通店铺配送商卡-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseOrderCnt {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签")
