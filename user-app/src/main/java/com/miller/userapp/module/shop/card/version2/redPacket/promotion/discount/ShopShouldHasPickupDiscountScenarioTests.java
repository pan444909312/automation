 ...
 */
@Scenario(scenarioID = "01JE82TSQN6PP12069RRHJZRFM",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_优惠标签_商品折扣_首页-商卡二期:商品折扣28-自取可用",
...
public class ShopShouldHasPickupDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_商品折扣_首页-商卡二期:商品折扣28-自取可用")
