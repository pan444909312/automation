...
import com.panda.erp.server.dal.dataobject.game.ActivityGamePrizes;
...
/**
 * @author panjuxiang
 * @since 2025/1/17 15:59
 */

@Scenario(scenarioID = "01JHSME1900G6TQ7JD3X0Y5VH3",
        scenarioName = "抽奖游戏_游戏信息-红包作废，奖品无效",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15, author = "panjuxiang@hungrypandagroup.com"
)
@EnvTag.Test
@DisplayName("抽奖游戏")
public class GameInfoRedPacketCancel {
    private final String gameSn = new PropertiesUtils().getProperty(this.getClass(), "user.app.game.sn01");
    private final String prizesId = new PropertiesUtils().getProperty(this.getClass(), "user.app.game.prizesId.redPacket.cancel");
