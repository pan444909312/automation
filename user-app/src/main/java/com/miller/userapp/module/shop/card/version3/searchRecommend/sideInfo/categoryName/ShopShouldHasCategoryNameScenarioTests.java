...
@TestFramework
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAA7", scenarioName = "用户-搜索推荐列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-辅助信息-类目-搜索推荐列表-商卡二期：类目"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索推荐列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-辅助信息-类目-搜索推荐列表-商卡二期：类目")
