package com.miller.userapp.module.shop.card.version3.searchRecommend.sideInfo.shopScore;
...
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAAK",
        scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_店铺评分_搜索推荐列表-商卡二期：店铺评分-手动设置综合评分",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_店铺评分_搜索推荐列表-商卡二期：店铺评分-手动设置综合评分")
