...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TF", scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：账户内最大红包43｜店铺加码",
...
public class ShopShouldHasReceivedIncreaseCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：账户内最大红包43｜店铺加码")
