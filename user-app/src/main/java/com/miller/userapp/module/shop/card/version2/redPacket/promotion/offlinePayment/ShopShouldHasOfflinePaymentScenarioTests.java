 ...
 */
@Scenario(scenarioID = "01JE84BAG72WBQ99GSV62N8VKE",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_优惠标签_货到付款_首页-商卡二期：货到付款34",
...
public class ShopShouldHasOfflinePaymentScenarioTests {
    ...
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_货到付款_首页-商卡二期：货到付款34")
