 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727SV",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_排序_自定义排序",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@EnvTag.Test
@DisplayName("商卡(中文)")
@Slf4j
public class ShopFeatureCustomSort {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_排序_自定义排序")
