...
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6XZ",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺logo_自取频道:店铺logo-独家商铺开启独家logo，展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasGifLogoScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺logo_自取频道:店铺logo-独家商铺开启独家logo，展示动图")
