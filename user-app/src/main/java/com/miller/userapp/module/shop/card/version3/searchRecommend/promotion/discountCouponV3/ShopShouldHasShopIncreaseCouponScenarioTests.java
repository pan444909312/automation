 ...
 * date: 2025/07/26
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727T3", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_店铺红包搜索列表-搜索列表-商卡二期-SKYX实验组：店铺红包42｜店铺金额加码（满减）",
...
public class ShopShouldHasShopIncreaseCouponScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_店铺红包搜索列表-搜索列表-商卡二期-SKYX实验组：店铺红包42｜店铺金额加码（满减）")
