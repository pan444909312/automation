package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.lastOrderNum;
...
@Scenario(scenarioID = "01KJ6V2PCZX1W1Z0AGVAVEEZW1",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_下单人数标签_不满足下单人数，不返回下单人数标签",
...
public class ShopShouldHasNoLastOrderNumFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_人下单人数标签_不满足下单人数，不返回下单人数标签")
