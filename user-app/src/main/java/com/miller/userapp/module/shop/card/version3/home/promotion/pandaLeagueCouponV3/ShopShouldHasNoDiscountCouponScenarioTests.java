 ...
 */
@EnvTag.Test
@Scenario(scenarioID = "01J46NM6T46BDDJFHRFM4RN9YX", scenarioName = "普通店铺配送商卡-SKYX01_优惠标签_熊猫联盟券_首页-商卡二期：熊猫联盟券40 - 无折扣红包 - 不展示",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("普通店铺配送商卡-SKYX01_优惠标签_熊猫联盟券_首页-商卡二期：熊猫联盟券40 - 无折扣红包 - 不展示 ")
public class ShopShouldHasNoDiscountCouponScenarioTests {
   ...
   @ParameterizedTest
   @DisplayName("普通店铺配送商卡_优惠标签_熊猫联盟券_首页-商卡二期：熊猫联盟券40 - 无折扣红包 - 不展示 ")
