...
@TestFramework
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX72", scenarioName = "商卡(中文)-普通店铺配送商卡-红包适用商家列表-辅助信息-月售-首页-商卡二期：月售"
        , developmentTime = 20, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("商卡(中文)-普通店铺配送商卡-红包适用商家列表-辅助信息-月售-首页-商卡二期：月售")
