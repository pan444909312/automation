package com.miller.userapp.module.shop.card.version3.redPacketShopList.baseInfo.shopLogo;
...
@Scenario(scenarioID = "01K4WBTAVTGF1FTXVC3NJ1GZ0D",
        scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_店铺logo_非独家店铺，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasNoGifLogoCauseIsNotExclusive {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_店铺logo_非独家店铺，该店铺设置了主图动图，不会展示动图")
...
//        assertThat(shopLogoOfERPInterfaceResponse).isEqualTo(shopSearchMiddleEntity.getShopLogo());
    ...
    static Stream<Arguments> staticLogoDataProvider() {
        ...
        shopListRequestDTO.setShopCategoryIds("[3896,3914,5486]"); // 开发代码 Bug，没有对 null 进行判断，应该默认给 false
