...
@Scenario(scenarioID = "01KJ6V2PCZX1W1Z0AGVAVEEZW0",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_下单人数标签_满足条件，返回下单人数标签",
...
public class ShopShouldHasLastOrderNumFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_人下单人数标签_满足条件，返回下单人数标签")
