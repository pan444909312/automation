...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TW", scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 折扣红包 - 不展示：对照组",
...
public class ShopShouldHasNoPandaCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 折扣红包 - 不展示：对照组")
