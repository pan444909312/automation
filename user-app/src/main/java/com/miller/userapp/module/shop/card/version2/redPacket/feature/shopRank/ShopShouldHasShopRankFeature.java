package com.miller.userapp.module.shop.card.version2.redPacket.feature.shopRank;
 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7A",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_营销标_标签3_榜单_首页-商卡二期：榜单",
...
public class ShopShouldHasShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_营销标_标签3_榜单_首页-商卡二期：榜单")
