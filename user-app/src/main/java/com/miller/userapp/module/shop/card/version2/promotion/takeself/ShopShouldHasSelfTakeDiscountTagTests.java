...
@EnvTag.Test
@TestFramework
@DisplayName("用户-首页店铺流-商卡(中文)-普通店铺配送商卡-优惠标签-自取折扣-展示")
public class ShopShouldHasSelfTakeDiscountTagTests {
//    采用店铺2的数据，标签类型：30，自取折扣
    private final Long shopId = Long.parseLong("59750820");
    private final Integer type=30;

    @DisplayName("用户-首页店铺流-商卡(中文)-普通店铺配送商卡-优惠标签-自取折扣-正常展示自取折扣标签")
