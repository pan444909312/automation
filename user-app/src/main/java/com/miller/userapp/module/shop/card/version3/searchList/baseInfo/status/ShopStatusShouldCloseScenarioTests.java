package com.miller.userapp.module.shop.card.version3.searchList.baseInfo.status;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593B", scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺营业状态_搜索列表-商卡二期:店铺营业状态-打烊"
...
public class ShopStatusShouldCloseScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺营业状态_搜索列表-商卡二期:店铺营业状态-打烊")
