...
@Scenario(scenarioID = "01KKJG5F8XHCNJ6C9QJYR5MJG8",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店前标签：VIP标签_搜索列表-商卡二期：VIP标签 - 不返回",
...
public class ShopShouldHasNoMemberTag {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店前标签：VIP标签_搜索列表-商卡二期：VIP标签 - 不返回")
