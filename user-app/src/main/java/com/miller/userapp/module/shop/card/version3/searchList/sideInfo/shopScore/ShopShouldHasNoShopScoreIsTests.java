...
@Scenario(scenarioID = "01K9VH77WP0C58RKEXC7J548F6",
        scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_辅助信息_店铺评分_搜索列表-商卡二期：店铺评分-无数据",
...
//                .set(ShopSearchMiddleEntity::getPraiseAverageNew, 0));
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_搜索列表商卡-SKYX01_辅助信息_店铺评分_搜索列表-商卡二期：店铺评分-无数据")
