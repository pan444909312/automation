...
@Scenario(scenarioID = "01K0V4Y15D7R41V639NWR4GCAM", scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊可预约（不开启预约单）"
...
public class ShopPreOrderSupportStatusCloseNoPreScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊可预约")
