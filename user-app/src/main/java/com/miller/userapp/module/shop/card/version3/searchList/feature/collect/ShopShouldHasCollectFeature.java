package com.miller.userapp.module.shop.card.version3.searchList.feature.collect;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593J",
        scenarioName = "搜索列表商卡-SKYX01_营销标_收藏店铺人数_满足所有条件时，返回：收藏店铺人数标签",
...
public class ShopShouldHasCollectFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_收藏店铺人数_满足所有条件时，返回：收藏店铺人数标签")
