...
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7C",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_辅助信息_店铺评分_首页-商卡二期：店铺评分-历史评分",
...
//       执行定时定时任务-店铺数据更新
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺配送商卡-红包适用商家列表_辅助信息_店铺评分_首页-商卡二期：店铺评分-历史评分")
