package com.miller.userapp.module.shop.card.version3.userPack.feature.orderRemind;
...
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6Z0",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_用户下单提醒_满足所有条件时，返回：用户XX刚刚下单了",
...
public class ShopShouldHasOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_用户下单提醒_满足所有条件时，返回：用户XX刚刚下单了")
