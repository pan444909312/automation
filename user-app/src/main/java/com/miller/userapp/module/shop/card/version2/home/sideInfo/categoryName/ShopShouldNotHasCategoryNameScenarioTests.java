package com.miller.userapp.module.shop.card.version2.home.sideInfo.categoryName;
...
@TestFramework
@Scenario(scenarioID = "01JDR9SSRCPFQ00ECRA2RG74FV", scenarioName = "用户-首页店铺流-商卡(中文)-普通店铺配送商卡-辅助信息-类目-首页-商卡二期：类目 - 无数据"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-首页店铺流-商卡(中文)-普通店铺配送商卡-辅助信息-类目-首页-商卡二期：类目 - 无数据")
