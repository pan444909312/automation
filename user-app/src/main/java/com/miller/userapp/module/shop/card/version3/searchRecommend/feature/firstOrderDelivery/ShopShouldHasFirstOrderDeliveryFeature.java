 ...
 */
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS6E",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_首单优先送_搜索列表-商卡二期：首单优先送",
...
public class ShopShouldHasFirstOrderDeliveryFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_首单优先送_搜索列表-商卡二期：首单优先送")
