...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5918",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店前标签：百万补贴_搜索列表-商卡二期：百万补贴",
...
public class ShopShouldHasSubsidyTag {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店前标签：百万补贴_搜索列表-商卡二期：百万补贴")
