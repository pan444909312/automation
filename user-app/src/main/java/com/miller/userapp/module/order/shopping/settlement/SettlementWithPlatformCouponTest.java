 ...
 * @author heyuan
 * @version 1.0
 * @since 2024/7/17 11:40
 */
public class SettlementWithPlatformCouponTest {
    @BeforeAll
    static void beforeAll() {
        UserLoginFlow.loginByDefaultUser();
    }
    @ParameterizedTest
    @MethodSource("settlementProductShopCoupon")
    @DisplayName("正常流程-平台配送-使用店铺优惠券结算")
     ...
     * 结算-使用店铺优惠券
     */
    static Stream<Arguments> settlementProductShopCoupon() {
        ...
        //店铺优惠券sn
        settlementRequestDTO.setRedUseSn(TestCaseDataForUserConstant.ShopredUserSn);
