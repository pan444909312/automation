package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.shopRank;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD0240HSA3D13SXVR2R",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_品类榜单_搜索列表-商卡二期：榜单",
...
public class ShopShouldHasShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_品类榜单_搜索列表-商卡二期：榜单")
