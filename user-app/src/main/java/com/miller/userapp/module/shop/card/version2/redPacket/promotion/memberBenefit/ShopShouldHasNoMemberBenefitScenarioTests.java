package com.miller.userapp.module.shop.card.version2.redPacket.promotion.memberBenefit;
...
import com.miller.userapp.module.shop.card.version2.redPacket.baseinfo.ShopShouldHasLabelScenarioTests;
...
@Scenario(scenarioID = "01JE84BAG72WBQ99GSV62N8VKB",
        scenarioName = "普通店铺配送商卡-红包适用商家列表_优惠标签_会员权益_首页-商卡二期：会员权益32-不展示",
...
//       执行定时定时任务-店铺数据更新
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_会员权益_首页-商卡二期：会员权益32-不展示")
//    删除配置  会员运费减免+店铺联盟  则不展示
