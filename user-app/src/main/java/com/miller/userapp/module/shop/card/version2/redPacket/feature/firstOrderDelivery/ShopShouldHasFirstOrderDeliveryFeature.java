 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX6X",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_营销标_首单优先送_首页-商卡二期：首单优先送",
...
public class ShopShouldHasFirstOrderDeliveryFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_营销标_首单优先送_首页-商卡二期：首单优先送")
