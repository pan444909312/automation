...
public class ShopShouldHasNoMealsOnTimeCausePriorityFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_营销标_标签7_出餐准时_熊猫联盟频道-商卡二期：出餐准时 - 不展示 - 优先级")
    void shouldNotExistMealsOnTimeCausePriority(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
