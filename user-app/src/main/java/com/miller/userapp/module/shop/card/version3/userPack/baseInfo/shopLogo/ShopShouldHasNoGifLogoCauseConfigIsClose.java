...
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6Y0",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺logo_自取频道:独家店铺未勾选开启独家logo，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasNoGifLogoCauseConfigIsClose {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺logo_自取频道:独家店铺未勾选开启独家logo，该店铺设置了主图动图，不会展示动图")
