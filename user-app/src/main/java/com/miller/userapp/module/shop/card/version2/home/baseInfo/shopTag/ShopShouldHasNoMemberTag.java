package com.miller.userapp.module.shop.card.version2.home.baseInfo.shopTag;
...
@Scenario(scenarioID = "01K0V19DZS3J4P1W64YVFG12SP",
        scenarioName = "普通店铺配送商卡_基础信息_店前标签：VIP标签_首页-商卡二期：VIP标签 - 不返回",
...
public class ShopShouldHasNoMemberTag {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_基础信息_店前标签：VIP标签_首页-商卡二期：VIP标签 - 不返回")
    void memberBenefitDeliveryDsicount(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopIndexVO.getFixedTagSts()).isEqualTo(0);
