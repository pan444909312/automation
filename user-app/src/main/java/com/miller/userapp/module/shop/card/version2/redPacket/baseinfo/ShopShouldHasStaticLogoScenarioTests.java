...
/**
 * 商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺logo_静图_首页-商卡二期:店铺logo-静图
 *
 * @author Miller Shan
 * @version 1.0
...
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7J",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺logo_静图_首页-商卡二期:店铺logo-静图",
...
public class ShopShouldHasStaticLogoScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_基础信息_店铺logo_静图_首页-商卡二期:店铺logo-静图")
    ...
    static Stream<Arguments> staticLogoDataProvider() {
        ...
        // 可以不用传参数
        // 开发代码 Bug，没有对 null 进行判断，应该默认给 false
