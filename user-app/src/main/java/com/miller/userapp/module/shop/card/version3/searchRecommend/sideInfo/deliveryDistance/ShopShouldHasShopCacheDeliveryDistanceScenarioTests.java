 ...
 */
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAA9",
        scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_配送距离_搜索推荐列表-商卡二期：配送距离 - 取缓存距离",
...
public class ShopShouldHasShopCacheDeliveryDistanceScenarioTests {
   ...
   @ParameterizedTest
   @DisplayName("搜索推荐列表商卡-SKYX01_辅助信息_配送距离_搜索推荐列表-商卡二期：配送距离 - 取缓存距离 ")
