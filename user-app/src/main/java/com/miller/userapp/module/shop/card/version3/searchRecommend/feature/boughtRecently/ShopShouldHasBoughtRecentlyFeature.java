package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.boughtRecently;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS67",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签",
...
public class ShopShouldHasBoughtRecentlyFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签")
