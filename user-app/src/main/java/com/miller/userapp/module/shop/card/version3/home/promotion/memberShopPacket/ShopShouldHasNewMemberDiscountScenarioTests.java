...
@Scenario(scenarioID = "01J46NM6T46BDDJFHRFM4RN9YX", scenarioName = "普通店铺配送商卡-SKYX01_优惠标签_新会员优惠标签_首页-商卡二期：新会员优惠标签37",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 10, manualTestTime = 20)
...
//        会员用户登录 user:17048460001  默认登录数据为实验组
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_新会员优惠标签_首页-商卡二期：新会员优惠标签37")
