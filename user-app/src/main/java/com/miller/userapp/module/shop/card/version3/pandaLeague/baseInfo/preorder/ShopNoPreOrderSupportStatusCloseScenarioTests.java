...
@Scenario(scenarioID = "01K0V4Y05EQ9189TN3SZ0D2Q0V", scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊不可预约"
...
public class ShopNoPreOrderSupportStatusCloseScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊不可预约")
