package com.miller.userapp.module.shop.card.version2.redPacket.baseinfo;
...
/**
 * 商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺角标_首页-商卡二期:店铺角标
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/06/25 21:17:39
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7H",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺角标_首页-商卡二期:店铺角标-展示",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 4 * 60, maintenanceTime = 0, manualTestTime = 30)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasLabelScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_基础信息_店铺角标_首页-商卡二期:店铺角标-展示")
