package com.miller.userapp.module.shop.card.version2.home.feature.sort;
 ...
 */
@Scenario(scenarioID = "01K0EE00YY0ZAH255DK3YHHGB5",
        scenarioName = "商卡(中文)_普通店铺配送商卡_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理",
...
public class ShopPartFeatureSort {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理")
