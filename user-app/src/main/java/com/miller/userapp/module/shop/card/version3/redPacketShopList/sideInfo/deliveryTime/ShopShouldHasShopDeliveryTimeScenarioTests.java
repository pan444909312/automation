 ...
 */
@Scenario(scenarioID = "01KE9JG2QWDYJ9ERQ4HSYH8C5B",
        scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_辅助信息_配送时间_红包适用商家列表-商卡二期：配送时间 - 取单独商家配送时间",
...
public class ShopShouldHasShopDeliveryTimeScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_辅助信息_配送时间_红包适用商家列表-商卡二期：配送时间 - 取单独商家配送时间 ")
