package com.miller.userapp.module.shop.card.version2.redPacket.coupon.fullSubCoupon;
...
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7K",
        scenarioName = "普通店铺配送商卡-红包适用商家列表_优惠标签_已领满减红包_首页-商卡二期：已领满减红包38-不展示",
...
public class ShopShouldHasNoShopFullSubCouponScenarioTests {
   ...
   @ParameterizedTest
   @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_已领满减红包_首页-商卡二期：已领满减红包38-不展示 ")
