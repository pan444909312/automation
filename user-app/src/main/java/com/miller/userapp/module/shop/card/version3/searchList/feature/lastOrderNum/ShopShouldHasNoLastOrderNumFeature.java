package com.miller.userapp.module.shop.card.version3.searchList.feature.lastOrderNum;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5940",
        scenarioName = "搜索列表商卡-SKYX01_营销标_下单人数标签_不满足下单人数，不返回下单人数标签",
...
public class ShopShouldHasNoLastOrderNumFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_人下单人数标签_不满足下单人数，不返回下单人数标签")
