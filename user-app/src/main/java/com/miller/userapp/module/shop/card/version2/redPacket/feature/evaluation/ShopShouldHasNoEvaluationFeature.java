package com.miller.userapp.module.shop.card.version2.redPacket.feature.evaluation;
 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX6T",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_营销标_标签3_营销文案_首页-商卡二期：营销文案 - 无数据",
...
public class ShopShouldHasNoEvaluationFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_营销标_标签3_营销文案_首页-商卡二期：营销文案 - 无数据")
