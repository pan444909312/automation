...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592P", scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 营业可预约"
        , author = "panjuxiang@hungrypandagroup.com", developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopPreOrderSupportStatusOpenScenarioTests {
    private final Long shopId = Long.parseLong(new PropertiesUtils().getProperty(this.getClass(), "user.app.for.test.shop.card.version2.open.pre"));
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 营业可预约")
    ...
    static Stream<Arguments> shopStatusDataProvider() {
        ...
        shopListRequestDTO.setKeywords("营业可预约"); // 开发代码Bug，没有对 null 进行判断，应该默认给false的
