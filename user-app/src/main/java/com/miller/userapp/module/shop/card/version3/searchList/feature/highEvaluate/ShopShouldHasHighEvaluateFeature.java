package com.miller.userapp.module.shop.card.version3.searchList.feature.highEvaluate;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593T",
        scenarioName = "搜索列表商卡-SKYX01_营销标_评价标签_满足所有条件时，返回：评价人数标签",
...
public class ShopShouldHasHighEvaluateFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_评价标签_满足所有条件时，返回：评价人数标签")
