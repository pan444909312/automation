 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX6S",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_营销标_标签3_营销文案_首页-商卡二期：营销文案",
...
public class ShopShouldHasEvaluationFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_营销标_标签3_营销文案_首页-商卡二期：营销文案")
