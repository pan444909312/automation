package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.sort;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727SX",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理",
...
public class ShopPartFeatureSort {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_排序_当商家满足部份标签时，取当前可展示的标签作排序处理")
