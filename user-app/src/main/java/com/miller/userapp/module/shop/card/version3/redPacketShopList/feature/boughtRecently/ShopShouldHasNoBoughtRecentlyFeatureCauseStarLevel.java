package com.miller.userapp.module.shop.card.version3.redPacketShopList.feature.boughtRecently;
 ...
 */
@Scenario(scenarioID = "01K4WC2XY368BXVW3NMNNWDNZG",
        scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_营销标_买过的店_店铺星级不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseStarLevel {
    ...
    void beforeAll() {
        ...
        dataShopUserOrderEntity.setShopStarLevel(2.0d);
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_营销标_买过的店_店铺星级不符合买过的店标签时，不返回标签")
