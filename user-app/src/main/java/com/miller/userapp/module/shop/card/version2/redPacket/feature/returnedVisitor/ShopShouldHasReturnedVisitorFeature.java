 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX75",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_营销标_标签3_回头客_首页-商卡二期：回头客",
...
public class ShopShouldHasReturnedVisitorFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_营销标_标签3_回头客_首页-商卡二期：回头客")
