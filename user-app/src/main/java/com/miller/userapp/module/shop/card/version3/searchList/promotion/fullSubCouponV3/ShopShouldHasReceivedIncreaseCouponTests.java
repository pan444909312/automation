...
@Scenario(scenarioID = "01K9VH77WS3962V3FZBZ4V31ZH", scenarioName = "搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：账户内最大红包43｜店铺加码",
...
public class ShopShouldHasReceivedIncreaseCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：账户内最大红包43｜店铺加码")
