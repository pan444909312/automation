package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.indexListLabel;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TM", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_营销标签_搜索列表-商卡二期：营销标签tpye=22-不展示",
...
public class ShopShouldNotIndexListLabelScenarioTests {
    ...
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_营销标签_搜索列表-商卡二期：营销标签tpye=22-不展示")
