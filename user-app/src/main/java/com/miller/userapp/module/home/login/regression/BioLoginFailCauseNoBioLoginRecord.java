...
@Slf4j
public class BioLoginFailCauseNoBioLoginRecord {
    ...
    @ParameterizedTest
    @DisplayName("生物认证失败-无认证记录")
    void testCase() {


        // xxl :user-app-server.bio.auth. = hpcd6ed83c
        // bioAuthToken 加密规则
        String macId = MD5Utils.string2MD5(bioAuth + deviceId + userId + "test");
