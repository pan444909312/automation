...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TR",
        scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_新会员优惠标签_搜索列表-商卡二期：新会员优惠标签37",
...
public class ShopShouldHasNewMemberDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_新会员优惠标签_搜索列表-商卡二期：新会员优惠标签37")
