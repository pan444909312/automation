package com.miller.userapp.module.shop.card.version3.searchList.feature.boughtRecently;
 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593E",
        scenarioName = "搜索列表商卡-SKYX01_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签",
...
public class ShopShouldHasBoughtRecentlyFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签")
