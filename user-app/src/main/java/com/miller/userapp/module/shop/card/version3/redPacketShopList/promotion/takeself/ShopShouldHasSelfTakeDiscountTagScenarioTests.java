...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01KE9JG2QWDYJ9ERQ4HSYH8C50", scenarioName = "用户-红包适用商家列表店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-优惠标签-自取折扣-红包适用商家列表-商卡二期：自取折扣30 - 无独享商品折扣"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-红包适用商家列表店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-优惠标签-自取折扣-红包适用商家列表-商卡二期：自取折扣30 - 无独享商品折扣")
