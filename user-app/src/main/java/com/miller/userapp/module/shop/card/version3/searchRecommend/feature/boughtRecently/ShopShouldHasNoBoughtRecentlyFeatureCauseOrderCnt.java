 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593G",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseOrderCnt {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签")
