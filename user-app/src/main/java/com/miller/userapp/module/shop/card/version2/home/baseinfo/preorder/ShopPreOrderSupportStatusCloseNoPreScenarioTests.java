package com.miller.userapp.module.shop.card.version2.home.baseinfo.preorder;
...
@Scenario(scenarioID = "01JKSWF87Q08HNV9H0JRWX6T52", scenarioName = "商卡(中文)_普通店铺配送商卡_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊可预约（不开启预约单）"
...
public class ShopPreOrderSupportStatusCloseNoPreScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺配送商卡_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊可预约")
