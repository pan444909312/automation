package com.miller.userapp.module.shop.card.version3.category.promotion.sortRule;
...
@Scenario(scenarioID = "01K82XGX5EPNDCS4G7NWCPHAVM", scenarioName = "品类频道-商卡二期-SKYX实验组：红包类型标签-优先级（非会员默认排序）",
