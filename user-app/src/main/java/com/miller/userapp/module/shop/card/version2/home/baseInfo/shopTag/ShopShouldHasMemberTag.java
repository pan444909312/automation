...
@Scenario(scenarioID = "01K0TZ4ZXE7EYS1CBFV78TVF8J",
        scenarioName = "普通店铺配送商卡_基础信息_店前标签：VIP标签_首页-商卡二期：VIP标签",
...
public class ShopShouldHasMemberTag {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_基础信息_店前标签：VIP标签_首页-商卡二期：VIP标签")
    void memberBenefitDeliveryDsicount(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopIndexVO.getFixedTagSts()).isEqualTo(1);
