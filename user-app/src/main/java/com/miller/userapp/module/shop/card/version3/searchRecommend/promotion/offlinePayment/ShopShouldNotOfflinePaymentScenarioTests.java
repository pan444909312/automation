package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.offlinePayment;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TV", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_货到付款_搜索列表-商卡二期：货到付款34-不展示",
...
public class ShopShouldNotOfflinePaymentScenarioTests {
    ...
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_货到付款_搜索列表-商卡二期：货到付款34-不展示")
