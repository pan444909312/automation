...
public class ShopShouldHasNoShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_营销标_标签3_榜单_熊猫联盟频道-商卡二期：榜单 - 无榜单数据")
    void shouldNotExistShopRankFeature(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
