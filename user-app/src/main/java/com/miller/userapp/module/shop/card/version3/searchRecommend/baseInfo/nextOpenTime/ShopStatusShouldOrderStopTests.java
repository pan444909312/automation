package com.miller.userapp.module.shop.card.version3.searchRecommend.baseInfo.nextOpenTime;
...
import com.miller.userapp.module.shop.card.version3.searchRecommend.baseInfo.shopLabel.ShopShouldHasLabelScenarioTests;
...
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJM1",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_下次营业时间_搜索列表-商卡二期：下次营业时间-暂停接单不可预约",
...
//        回复店铺数据=营业
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_下次营业时间_搜索列表-商卡二期：下次营业时间-暂停接单不可预约")
