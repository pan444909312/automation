...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TP",
        scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_会员权益_搜索列表-商卡二期：会员权益32-店铺联盟券",
...
public class ShopShouldHasMemberBenefitShopAllianceScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_会员权益_搜索列表-商卡二期：会员权益32-店铺联盟券")
