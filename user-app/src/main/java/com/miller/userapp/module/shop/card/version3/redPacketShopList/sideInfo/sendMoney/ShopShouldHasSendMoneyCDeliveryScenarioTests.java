...
@TestFramework
@Scenario(scenarioID = "01KE9JG2QXE24BN5BKBEYHKVJB", scenarioName = "用户-红包适用商家列表店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-辅助信息-配送价格-红包适用商家列表-商卡二期：配送价格 - C配"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-红包适用商家列表店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-辅助信息-配送价格-红包适用商家列表-商卡二期：配送价格 - C配")
