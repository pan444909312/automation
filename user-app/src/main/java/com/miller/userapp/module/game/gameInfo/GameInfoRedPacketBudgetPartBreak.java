 ...
 */
@Scenario(scenarioID = "01JN024Z741RTSF49YXC70XEGH",
        scenarioName = "抽奖游戏_游戏信息-红包预算部分熔断，奖品无效",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 15,author = "panjuxiang@hungrypandagroup.com"
)
@EnvTag.Test
@DisplayName("抽奖游戏")
public class GameInfoRedPacketBudgetPartBreak {
    ...
    @ParameterizedTest
    @DisplayName("游戏信息-红包预算部分熔断，奖品无效")
    void shouldExistFastFoodFeature(GameRequestDTO gameRequestDTO) {
        //修改预算为全部熔断
        activityConfigMapper.setActivityStatus(activitySn,3,1);
