package com.miller.userapp.module.shop.card.version3.category.promotion.discount;
 ...
 */
@Scenario(scenarioID = "01K671EM3GHG2897Z0XTR2EWVV",
        scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_商品折扣_首页-商卡二期:商品折扣28-不展示",
...
public class ShopShouldHasNoDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_商品折扣_首页-商卡二期:商品折扣28-不展示")
