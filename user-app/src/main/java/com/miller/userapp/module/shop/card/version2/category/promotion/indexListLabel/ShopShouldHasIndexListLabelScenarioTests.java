...
import com.miller.userapp.module.shop.card.version2.category.promotion.takeself.flow.ShopListFlow;
import com.miller.userapp.module.shop.card.version2.category.promotion.takeself.request.ShopListRequestDTO;
import com.miller.userapp.module.shop.card.version2.category.promotion.takeself.response.ShopListResponseDTO;
 ...
 */
@Scenario(scenarioID = "01J5D0D57WRRFD12T2A4XT58C6",
        scenarioName = "商卡(中文)_普通店铺配送商卡_优惠标签_货到付款_首页-商卡二期：营销标签tpye=22",
        developmentTime = 40, maintenanceTime = 0, manualTestTime = 10)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasIndexListLabelScenarioTests {
//    测试店铺：店铺1,测试标签类型：22，content：东东测试商卡营销标签
    ...
    @DisplayName("普通店铺配送商卡_优惠标签_货到付款_首页-商卡二期：营销标签tpye=22")
    ...
    void hasSelfTakeTag(ShopListRequestDTO ShopListRequestdto){
        ...
        assertThat(showContent).isEqualTo("东东测试商卡营销标签");
    }
