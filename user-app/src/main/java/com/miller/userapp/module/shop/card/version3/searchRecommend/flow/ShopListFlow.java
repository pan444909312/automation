package com.miller.userapp.module.shop.card.version3.searchRecommend.flow;
...
public class ShopListFlow {
     ...
     * 接口_搜索店铺流
     */
    private static final String uri = BusinessConstant.DOMAIN + "/api/user/v1/recommendList";
