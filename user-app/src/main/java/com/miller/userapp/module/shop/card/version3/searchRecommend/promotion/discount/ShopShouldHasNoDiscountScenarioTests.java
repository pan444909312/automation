package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.discount;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727SZ",
        scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_商品折扣_搜索列表-商卡二期:商品折扣28-不展示",
...
public class ShopShouldHasNoDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_商品折扣_搜索列表-商卡二期:商品折扣28-不展示")
