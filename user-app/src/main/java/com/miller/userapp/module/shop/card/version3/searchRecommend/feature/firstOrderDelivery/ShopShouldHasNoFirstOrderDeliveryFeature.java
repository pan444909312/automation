package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.firstOrderDelivery;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS6F",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_首单优先送_搜索列表-商卡二期：首单优先送 - 不展示",
...
//        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("update hp_sys_app_config set config_value = all where config_key='FIRST_ORDER_DELIVERY_CONFIG'");
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_首单优先送_搜索列表-商卡二期：首单优先送 - 不展示")
