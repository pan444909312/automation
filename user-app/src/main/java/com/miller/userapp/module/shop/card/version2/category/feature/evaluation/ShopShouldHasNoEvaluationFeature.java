package com.miller.userapp.module.shop.card.version2.category.feature.evaluation;
 ...
 */
@Scenario(scenarioID = "01JG3GCFH65YA11JQVCHCMQMRP",
        scenarioName = "商卡(中文)_普通店铺配送商卡-品类频道_营销标_标签3_营销文案_品类频道-商卡二期：营销文案 - 无数据",
...
public class ShopShouldHasNoEvaluationFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-品类频道_营销标_标签3_营销文案_品类频道-商卡二期：营销文案 - 无数据")
