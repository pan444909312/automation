package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.voucher;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAA3", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31-不展示",
...
public class ShopShouldHasNoVoucherScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31-不展示")
