...
public class ShopShouldHasReceivedDiscountCouponTests {
    ...
    void beforeAll() {
        ...
        UserLoginFlow.loginAndPutToken(userLoginRequestDTO);
         ...
         userCdkeyInfoSql.updateRedPacketUsedStatus(String.valueOf(userId),Long.parseLong(new PropertiesUtils().getProperty(this.getClass(), "user.app.for.test.shop.card.version3.redpacketId4")), (byte)1);
