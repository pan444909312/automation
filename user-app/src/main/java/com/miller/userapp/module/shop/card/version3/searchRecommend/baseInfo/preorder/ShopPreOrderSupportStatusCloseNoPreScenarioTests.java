package com.miller.userapp.module.shop.card.version3.searchRecommend.baseInfo.preorder;
...
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJM4", scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 打烊可预约（不开启预约单）"
...
public class ShopPreOrderSupportStatusCloseNoPreScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 打烊可预约")
