...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TY", scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (不加码)",
...
public class ShopShouldHasPandaCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (不加码)")
