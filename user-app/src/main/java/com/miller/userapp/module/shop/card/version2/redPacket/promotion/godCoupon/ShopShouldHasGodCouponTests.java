package com.miller.userapp.module.shop.card.version2.redPacket.promotion.godCoupon;
...
@Scenario(scenarioID = "01JE84BAG72WBQ99GSV62N8VK6",
        scenarioName = "普通店铺配送商卡-红包适用商家列表_优惠标签_神券_首页-商卡二期：神券41-有神券正常展示",
...
public class ShopShouldHasGodCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_新会员优惠标签_首页-商卡二期：神券41-有神券正常展示")
