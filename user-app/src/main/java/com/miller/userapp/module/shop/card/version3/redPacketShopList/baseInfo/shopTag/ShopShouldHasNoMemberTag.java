package com.miller.userapp.module.shop.card.version3.redPacketShopList.baseInfo.shopTag;
...
@Scenario(scenarioID = "01K4WBVC42FE11FJN88FCVARM3",
        scenarioName = "普通店铺配送商卡-品类频道页-SKYX01_基础信息_店前标签：VIP标签_品类频道页-商卡二期：VIP标签 - 不返回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)

@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasNoMemberTag {
    private final Long shopId = 911598059L;
    private final Long memberCityID = 1111652L;
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-品类频道页-SKYX01_基础信息_店前标签：VIP标签_品类频道页-商卡二期：VIP标签 - 不返回")
    void memberBenefitDeliveryDsicount(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopSearchMiddleEntity.getFixedTagSts()).isEqualTo(Byte.valueOf("0"));
        assertThat(memberCityId.getFixedTagSts()).isEqualTo(0);
        assertThat(shopIndexVO.getActivityTag()).isNotEqualTo("https://static.hungrypanda.co/panda/174307129084271a7f5b22b5c4525bbf0374301153496.png");
