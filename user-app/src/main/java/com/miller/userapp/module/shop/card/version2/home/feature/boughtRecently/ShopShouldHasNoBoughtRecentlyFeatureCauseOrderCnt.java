 ...
 */
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DCA",
        scenarioName = "商卡(中文)_普通店铺配送商卡_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseOrderCnt {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签")
