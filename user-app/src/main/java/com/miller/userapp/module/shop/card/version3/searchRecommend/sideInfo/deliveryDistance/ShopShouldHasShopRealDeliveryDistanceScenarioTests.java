package com.miller.userapp.module.shop.card.version3.searchRecommend.sideInfo.deliveryDistance;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAAA",
        scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_配送距离_搜索推荐列表-商卡二期：配送距离 - 取实际距离*距离权重",
...
public class ShopShouldHasShopRealDeliveryDistanceScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_辅助信息_配送距离_搜索推荐列表-商卡二期：配送距离 - 取实际距离*距离权重 ")
