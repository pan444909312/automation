package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.takeself;
...
@TestFramework
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAA2", scenarioName = "用户-搜索列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-优惠标签-可自取-搜索列表-商卡二期：可自取33（已删除）"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-优惠标签-可自取-搜索列表-商卡二期：可自取33（已删除）")
...
//    测试店铺：店铺1,测试标签类型：33，content：可自取
    ...
    @DisplayName("用户-搜索列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-优惠标签-可自取-不展示自取标签（已删除）")
