package com.miller.userapp.module.shop.card.version3.searchList.feature.returnedVisitor;
...
public class ShopShouldHasNoReturnedVisitorFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_回头客_搜索列表-商卡二期：回头客 - 回头客展示开关禁用(有服务器本地缓存不会立即生效)")
