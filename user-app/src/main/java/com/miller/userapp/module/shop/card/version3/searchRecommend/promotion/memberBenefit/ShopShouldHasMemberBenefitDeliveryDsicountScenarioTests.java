package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.memberBenefit;
...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TN",
        scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_会员权益_搜索列表-商卡二期：会员权益32-会员运费减免",
...
public class ShopShouldHasMemberBenefitDeliveryDsicountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_会员权益_搜索列表-商卡二期：会员权益32-会员运费免减")
