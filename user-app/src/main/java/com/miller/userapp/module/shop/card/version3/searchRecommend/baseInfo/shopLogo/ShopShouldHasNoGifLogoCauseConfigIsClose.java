...
@Scenario(scenarioID = "01KKJG2W71WWTHG93TCE7N4FWV",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:独家店铺未勾选开启独家logo，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasNoGifLogoCauseConfigIsClose {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:独家店铺未勾选开启独家logo，该店铺设置了主图动图，不会展示动图")
