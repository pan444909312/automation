package com.miller.userapp.module.shop.card.version2.redPacket.feature.deliveryTime;
 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX6P",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_辅助信息_配送时间_首页-商卡二期：配送时间 - 取单独商家配送时间",
...
public class ShopShouldHasShopDeliveryTimeScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_辅助信息_配送时间_首页-商卡二期：配送时间 - 取单独商家配送时间 ")
