 ...
 * date: 2025/07/26
 */
@Scenario(scenarioID = "01K0RF81CW8B1HRFNTJZARKMPV", scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_店铺红包首页-商卡二期-SKYX实验组：店铺红包42",
...
public class ShopShouldHasShopCouponScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_店铺红包首页-商卡二期-SKYX实验组：店铺红包42")
