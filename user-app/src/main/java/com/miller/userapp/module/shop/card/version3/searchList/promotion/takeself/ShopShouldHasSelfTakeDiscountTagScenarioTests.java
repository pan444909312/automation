package com.miller.userapp.module.shop.card.version3.searchList.promotion.takeself;
...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7G1", scenarioName = "用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-SKYX01-优惠标签-自取折扣-搜索列表-商卡二期：自取折扣30 - 无独享商品折扣"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-SKYX01-优惠标签-自取折扣-搜索列表-商卡二期：自取折扣30 - 无独享商品折扣")
