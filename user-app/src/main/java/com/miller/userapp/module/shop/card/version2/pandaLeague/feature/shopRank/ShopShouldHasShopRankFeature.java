package com.miller.userapp.module.shop.card.version2.pandaLeague.feature.shopRank;
 ...
 */
@Scenario(scenarioID = "01JD4566E4NRPX5RPVB934A29F",
        scenarioName = "商卡(中文)_普通店铺配送商卡-熊猫联盟频道_营销标_标签3_熊猫联盟频道-商卡二期：榜单",
...
public class ShopShouldHasShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_营销标_标签3_熊猫联盟频道-商卡二期：榜单")
    void shouldExistShopRankFeature(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
        ...
        assertThat(shopIndexVO.getShopRank()).isEqualTo(shopSearchMiddleEntity.getShopRank());
        assertThat(shopFeatureVO.getShowContent()).isEqualTo(shopIndexVO.getShopRank());
    }
