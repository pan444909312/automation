...
@Scenario(scenarioID = "01K0PE3J9RYZ6JGE8QSNSM7Z1M",
        scenarioName = "商卡(中文)_普通店铺配送商卡_基础信息_店铺logo_非独家店铺，该店铺设置了主图动图，不会展示动图",
...
public class ShopShouldHasNoGifLogoCauseIsNotExclusive {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_基础信息_店铺logo_非独家店铺，该店铺设置了主图动图，不会展示动图")
