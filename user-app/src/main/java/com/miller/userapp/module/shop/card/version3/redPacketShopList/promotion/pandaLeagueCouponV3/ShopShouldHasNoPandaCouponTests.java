...
//@Scenario(scenarioID = "01KE9JG2QWDYJ9ERQ4HSYH8C4M", scenarioName = "普通店铺配送商卡-SKYX01_优惠标签_神券_红包适用商家列表-商卡二期-SKYX实验组：熊猫联盟券40 - 折扣红包 - 不展示：对照组",
...
public class ShopShouldHasNoPandaCouponTests {
    ...
    private static UserCdKeyEntity userCdKeyEntity;
     @BeforeAll
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_神券_红包适用商家列表-商卡二期-SKYX实验组：熊猫联盟券40 - 折扣红包 - 不展示：对照组")
