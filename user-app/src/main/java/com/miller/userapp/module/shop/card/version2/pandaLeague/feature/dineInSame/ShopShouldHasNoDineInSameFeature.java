package com.miller.userapp.module.shop.card.version2.pandaLeague.feature.dineInSame;
 ...
 */
@Scenario(scenarioID = "01JD44JA7PV8H8DE1Z4QM5VFR6",
        scenarioName = "商卡(中文)_普通店铺配送商卡-熊猫联盟频道_营销标_标签4_堂食同价_熊猫联盟频道-商卡二期：堂食同价 - 不展示",
...
public class ShopShouldHasNoDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_营销标_标签4_堂食同价_熊猫联盟频道-商卡二期：堂食同价 - 不展示")
    void shouldNotExistDineInTimeFeature(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
