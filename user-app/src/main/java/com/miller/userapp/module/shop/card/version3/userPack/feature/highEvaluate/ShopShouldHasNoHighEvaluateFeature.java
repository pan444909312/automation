package com.miller.userapp.module.shop.card.version3.userPack.feature.highEvaluate;
...
@Scenario(scenarioID = "01K7JWZ6K5KT6A6ZF9DMT7D6YS",
        scenarioName = "普通店铺配送商卡-自取频道-SKYX01_营销标_评价标签_评价人数不满足配置，不展示",
...
public class ShopShouldHasNoHighEvaluateFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_营销标_评价标签_评价人数不满足配置，不展示")
