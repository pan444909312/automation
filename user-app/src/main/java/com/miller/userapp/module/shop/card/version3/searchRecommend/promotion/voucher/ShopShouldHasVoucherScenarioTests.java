 ...
 */
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAA4", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31",
...
public class ShopShouldHasVoucherScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_代金券_搜索列表-商卡二期：代金券31")
