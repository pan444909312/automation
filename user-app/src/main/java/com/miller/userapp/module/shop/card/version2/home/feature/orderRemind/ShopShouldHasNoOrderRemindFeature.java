...
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DC4",
        scenarioName = "商卡(中文)_普通店铺配送商卡_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单",
...
public class ShopShouldHasNoOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单")
