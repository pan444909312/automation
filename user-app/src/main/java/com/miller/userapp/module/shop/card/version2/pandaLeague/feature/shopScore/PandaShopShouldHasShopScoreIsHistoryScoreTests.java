...
@Scenario(scenarioID = "01JDKTPH8XCS1H0NYAJW3FWF0P",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道_辅助信息_店铺评分_首页-商卡二期：店铺评分-历史评分",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class PandaShopShouldHasShopScoreIsHistoryScoreTests {
...
//       执行定时定时任务-店铺数据更新
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_辅助信息_店铺评分_首页-商卡二期：店铺评分-历史评分")
