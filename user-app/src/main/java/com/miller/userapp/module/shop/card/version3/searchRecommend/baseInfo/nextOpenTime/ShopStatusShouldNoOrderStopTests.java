...
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJM0",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_下次营业时间_搜索列表-商卡二期：下次营业时间-无数据",
...
//       执行定时定时任务-店铺数据更新
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_下次营业时间_搜索列表-商卡二期：下次营业时间-无数据")
