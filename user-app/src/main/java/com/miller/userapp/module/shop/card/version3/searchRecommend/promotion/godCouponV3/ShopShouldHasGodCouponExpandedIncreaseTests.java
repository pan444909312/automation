package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.godCouponV3;
...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TG", scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：神券标签41-已膨胀至X｜店铺加码",
...
public class ShopShouldHasGodCouponExpandedIncreaseTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：神券标签41-已膨胀至X｜店铺加码")
