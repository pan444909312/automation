package com.miller.userapp.module.shop.card.version3.home.baseInfo.shopLogo;
...
@Scenario(scenarioID = "01K0V5AMST0B96BKWHN5BXT7KD",
        scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店铺logo_首页-商卡二期:非独家店铺，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasNoGifLogoCauseIsNotExclusive {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店铺logo_首页-商卡二期:非独家店铺，该店铺设置了主图动图，不会展示动图")
