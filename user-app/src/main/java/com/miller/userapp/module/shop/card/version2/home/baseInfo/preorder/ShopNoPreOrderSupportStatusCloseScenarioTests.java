...
@Scenario(scenarioID = "01JKSWF87Q08HNV9H0JRWX6T54", scenarioName = "商卡(中文)_普通店铺配送商卡_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊不可预约"
...
public class ShopNoPreOrderSupportStatusCloseScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺配送商卡_基础信息_店铺可预约状态_首页-商卡二期：店铺可预约状态 - 打烊不可预约")
