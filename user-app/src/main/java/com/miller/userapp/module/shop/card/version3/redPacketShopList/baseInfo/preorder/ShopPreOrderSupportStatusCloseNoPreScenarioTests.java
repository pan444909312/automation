package com.miller.userapp.module.shop.card.version3.redPacketShopList.baseInfo.preorder;
...
@Scenario(scenarioID = "01KE9JG2QNGFPC88E6BRHRK6FN", scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_店铺可预约状态_红包适用商家列表-商卡二期：店铺可预约状态 - 打烊可预约（不开启预约单）"
...
public class ShopPreOrderSupportStatusCloseNoPreScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_店铺可预约状态_红包适用商家列表-商卡二期：店铺可预约状态 - 打烊可预约")
