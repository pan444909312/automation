...
@Scenario(scenarioID = "01KE9JG2QNGFPC88E6BRHRK6FN", scenarioName = "普通店铺配送商卡-品类频道页-SKYX01_基础信息_店铺可预约状态_品类频道页-商卡二期：店铺可预约状态 - 打烊可预约（不开启预约单）"
...
public class ShopPreOrderSupportStatusCloseNoPreScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-品类频道页-SKYX01_基础信息_店铺可预约状态_品类频道页-商卡二期：店铺可预约状态 - 打烊可预约")
