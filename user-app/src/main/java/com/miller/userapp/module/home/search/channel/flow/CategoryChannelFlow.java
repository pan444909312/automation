package com.miller.userapp.module.home.search.channel.flow;
...
public class CategoryChannelFlow {
    ...
    public CategoryChannelResponseDTO flowCategoryChannel(CategoryChannelRequestDTO CategoryChannelRequestDTO){
        ...
        return HttpUtils.sendPostRequestReturnJavaObject(uri,null,RequestUtils.getHeaders(),CategoryChannelRequestDTO,null, CategoryChannelResponseDTO.class);
