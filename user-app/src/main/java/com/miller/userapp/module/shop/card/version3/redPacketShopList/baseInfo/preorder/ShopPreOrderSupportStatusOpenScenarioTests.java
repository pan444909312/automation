...
@Scenario(scenarioID = "01KE9JG2QNGFPC88E6BRHRK6FQ", scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_店铺可预约状态_红包适用商家列表-商卡二期：店铺可预约状态 - 营业可预约"
...
public class ShopPreOrderSupportStatusOpenScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_店铺可预约状态_红包适用商家列表-商卡二期：店铺可预约状态 - 营业可预约")
