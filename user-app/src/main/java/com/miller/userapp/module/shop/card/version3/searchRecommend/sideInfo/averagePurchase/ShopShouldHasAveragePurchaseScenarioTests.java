...
@TestFramework
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAA5", scenarioName = "用户-搜索推荐列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-辅助信息-人均-搜索推荐列表-商卡二期：人均"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 20, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索推荐列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-辅助信息-人均-搜索推荐列表-商卡二期：人均")
