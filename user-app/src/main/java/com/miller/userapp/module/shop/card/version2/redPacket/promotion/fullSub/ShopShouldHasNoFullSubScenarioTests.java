package com.miller.userapp.module.shop.card.version2.redPacket.promotion.fullSub;
 ...
 */
@Scenario(scenarioID = "01JE84BAG72WBQ99GSV62N8VK5",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_优惠标签_满减_首页-商卡二期：满减29-不展示",
...
public class ShopShouldHasNoFullSubScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_满减_首页-商卡二期：满减29-不展示")
