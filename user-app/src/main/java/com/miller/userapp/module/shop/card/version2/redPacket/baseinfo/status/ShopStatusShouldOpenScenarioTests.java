package com.miller.userapp.module.shop.card.version2.redPacket.baseinfo.status;
...
/**
 * 商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺营业状态_首页-商卡二期:店铺营业状态-营业
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/07/28 17:17:39
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7P", scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺营业状态_首页-商卡二期:店铺营业状态-营业"
...
public class ShopStatusShouldOpenScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_基础信息_店铺营业状态_首页-商卡二期:店铺营业状态-营业")
