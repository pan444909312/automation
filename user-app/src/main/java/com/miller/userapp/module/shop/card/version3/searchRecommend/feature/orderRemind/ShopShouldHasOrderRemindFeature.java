package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.orderRemind;
...
@Scenario(scenarioID = "01KJ6V2PCZX1W1Z0AGVAVEEZW3",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_用户下单提醒_满足所有条件时，返回：用户XX刚刚下单了",
...
public class ShopShouldHasOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_用户下单提醒_满足所有条件时，返回：用户XX刚刚下单了")
