 ...
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX6R",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_营销标_标签4_堂食同价_首页-商卡二期：堂食同价",
...
public class ShopShouldHasDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_营销标_标签4_堂食同价_首页-商卡二期：堂食同价")
