...
@Scenario(scenarioID = "01KKJG6KNJEEYD434VFMBNFZSJ",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签 - 商家不属于会场内的商家列表，不返回标签",
...
public class ShopShouldHasNoVenueTagCauseShopNotInVenue {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签 - 商家不属于会场内的商家列表，不返回标签")
