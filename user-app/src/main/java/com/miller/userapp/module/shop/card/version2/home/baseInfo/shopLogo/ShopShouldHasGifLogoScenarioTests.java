...
@Scenario(scenarioID = "01K0NTZ3XFF8ZTVWCDM7ZEFZXD",
        scenarioName = "商卡(中文)_普通店铺配送商卡_基础信息_店铺logo_首页-商卡二期:店铺logo-独家商铺开启独家logo，展示动图",
...
public class ShopShouldHasGifLogoScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_基础信息_店铺logo_首页-商卡二期:店铺logo-独家商铺开启独家logo，展示动图")
