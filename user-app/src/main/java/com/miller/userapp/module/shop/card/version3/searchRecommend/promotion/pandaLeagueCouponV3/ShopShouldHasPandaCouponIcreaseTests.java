package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.pandaLeagueCouponV3;
...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TX", scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (加码)",
...
public class ShopShouldHasPandaCouponIcreaseTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_神券_搜索列表-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (加码)")
