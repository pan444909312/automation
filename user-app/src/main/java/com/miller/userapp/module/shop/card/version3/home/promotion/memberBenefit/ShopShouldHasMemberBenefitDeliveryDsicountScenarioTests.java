...
@Scenario(scenarioID = "01K0RCYNYFJN63V4DTVRAVYHHW", scenarioName = "普通店铺配送商卡-SKYX01_优惠标签_会员权益_首页-商卡二期：会员权益32-会员运费免减",
...
//                update member_packet set is_del=0 where member_city_id=1111378 and packet_id=888890186;
    ...
    void memberBenefitDeliveryDsicount(ShopListRequestDTO shopListRequestDTO) {
        ...
        ShopListResponseDTO shopList = ShopListFlowNoLogin.getShopListByShopId(shopListRequestDTO,shopId);
