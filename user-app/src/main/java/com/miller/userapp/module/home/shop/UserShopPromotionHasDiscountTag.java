...
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DCN",
        scenarioName = "店铺的优惠信息包含百亿补贴优惠",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@EnvTag.Test
@DisplayName("/api/app/user/shop/promotion")
public class UserShopPromotionHasDiscountTag {
    ...
    void testCase(ShopBaseReqDTO shopBaseReqDTO) {
        ...
        String tagName = (String) JSONPath.eval(JSON.parse(result), "$.result.shopDiscountTagList[0].name");


        assertThat(resultCode).isEqualTo(1000);
        assertThat(tagName).isEqualTo("百万补贴");
