 ...
 */
@Scenario(scenarioID = "01KKJGKRR4FD19D9BDRTJDVD7K",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_买过的店_店铺星级不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseStarLevel {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_买过的店_店铺星级不符合买过的店标签时，不返回标签")
