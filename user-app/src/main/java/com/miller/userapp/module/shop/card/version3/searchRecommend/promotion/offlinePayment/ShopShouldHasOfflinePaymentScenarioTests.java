 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TT", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_货到付款_搜索列表-商卡二期：货到付款34",
...
//    测试店铺：店铺1,测试标签类型：34，content：货到付款
    ...
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_货到付款_搜索列表-商卡二期：货到付款34")
