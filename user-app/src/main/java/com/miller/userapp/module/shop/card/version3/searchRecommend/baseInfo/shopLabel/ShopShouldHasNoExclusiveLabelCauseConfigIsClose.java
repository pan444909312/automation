package com.miller.userapp.module.shop.card.version3.searchRecommend.baseInfo.shopLabel;
...
public class ShopShouldHasNoExclusiveLabelCauseConfigIsClose {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:非独家店铺，配置了独家角标也不展示该角标")
