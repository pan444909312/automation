 ...
 */
@Scenario(scenarioID = "01K4WC2YGY80XASTDFAW9F0PX3",
        scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签",
...
public class ShopShouldHasNoBoughtRecentlyFeatureCauseOrderCnt {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_营销标_买过的店_店铺60天订单量不符合买过的店标签时，不返回标签")
