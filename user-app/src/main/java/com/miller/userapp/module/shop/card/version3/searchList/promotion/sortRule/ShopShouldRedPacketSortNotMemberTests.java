package com.miller.userapp.module.shop.card.version3.searchList.promotion.sortRule;
...
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7G6", scenarioName = "搜索列表-商卡二期-SKYX实验组：红包类型标签-优先级（非会员默认排序）",
