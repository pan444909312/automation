...
@Scenario(scenarioID = "01KJ6V2PCZX1W1Z0AGVAVEEZW2",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单",
...
public class ShopShouldHasNoOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单")
