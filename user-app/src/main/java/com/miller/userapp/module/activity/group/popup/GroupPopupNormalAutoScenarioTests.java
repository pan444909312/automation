...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01JV6RCKS63YM5GE0Y9WC3CFP2", scenarioName = "普通天降链路-天降弹窗-智能营销对照组-直塞模式-普通活动"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 120, maintenanceTime = 0, manualTestTime = 15)
public class GroupPopupNormalAutoScenarioTests {
...
//        清除用户已领取的天降数据&红包信息
        ...
        for (GroupPopupNormalAutoScenarioTests.RedPacketConfig redPacketConfig : RED_PACKET_CONFIGS) {
...
//        修改heades实验：去掉ZNYX
    ...
    @DisplayName("普通天降链路-天降弹窗-智能营销对照组-直塞模式-普通活动")
...
//        获取天降结果
    ...
    private void verifyRedPacketConfig(
            ...
            GroupPopupNormalAutoScenarioTests.RedPacketConfig config
    ) {
