 ...
 */
@Scenario(scenarioID = "01KE9JG2QWDYJ9ERQ4HSYH8C53", scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_代金券_红包适用商家列表-商卡二期：代金券31",
...
public class ShopShouldHasVoucherScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_代金券_红包适用商家列表-商卡二期：代金券31")
