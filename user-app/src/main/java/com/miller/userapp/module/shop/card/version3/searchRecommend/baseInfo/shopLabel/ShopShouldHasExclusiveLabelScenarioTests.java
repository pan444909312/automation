...
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJM7",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:独家店铺开启独家角标,会展示独家角标",
...
public class ShopShouldHasExclusiveLabelScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:独家店铺开启独家角标,会展示独家角标")
