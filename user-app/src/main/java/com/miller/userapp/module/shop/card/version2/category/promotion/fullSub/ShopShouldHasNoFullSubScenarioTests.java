package com.miller.userapp.module.shop.card.version2.category.promotion.fullSub;
 ...
 */
@Scenario(scenarioID = "01J46NM6SN57R40GPWSY4V9G1D",
        scenarioName = "商卡(中文)_普通店铺配送商卡_优惠标签_满减_首页-商卡二期：满减29-不展示",
...
public class ShopShouldHasNoFullSubScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_优惠标签_满减_首页-商卡二期：满减29-不展示")
