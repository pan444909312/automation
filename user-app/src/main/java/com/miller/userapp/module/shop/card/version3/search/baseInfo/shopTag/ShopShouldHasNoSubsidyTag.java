...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP5914",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店前标签：百万补贴_搜索列表-商卡二期：百万补贴 - 店铺不在招商列表，不返回",
...
public class ShopShouldHasNoSubsidyTag {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店前标签：百万补贴_搜索列表-商卡二期：百万补贴 - 店铺不在招商列表，不返回")
