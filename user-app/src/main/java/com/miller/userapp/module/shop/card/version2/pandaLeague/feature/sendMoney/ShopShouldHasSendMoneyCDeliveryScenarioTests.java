...
@TestFramework
@Scenario(scenarioID = "01JDR9SSRB28118W2EDV5WVDEY", scenarioName = "用户-首页店铺流-商卡(中文)-普通店铺配送商卡-熊猫联盟频道-辅助信息-配送价格-熊猫联盟频道-商卡二期：配送价格 - C配"
        , author = "shandongdong@hungrypandagroup.com", developmentTime = 5, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-首页店铺流-商卡(中文)-普通店铺配送商卡-熊猫联盟频道-辅助信息-配送价格-熊猫联盟频道-商卡二期：配送价格 - C配")
