 ...
 */
@Scenario(scenarioID = "01KE9JG2QWDYJ9ERQ4HSYH8C4C", scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_营销标签_品类频道-商卡二期：营销标签tpye=22-不展示",
...
public class ShopShouldNotIndexListLabelScenarioTests {
    ...
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_营销标签_品类频道-商卡二期：营销标签tpye=22-不展示")
