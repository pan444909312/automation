package com.miller.userapp.module.shop.card.version3.searchList.promotion.fullSub;
 ...
 */
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7FZ", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_满减_搜索列表-商卡二期：满减29-不展示",
...
public class ShopShouldHasNoFullSubScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_满减_搜索列表-商卡二期：满减29-不展示")
