package com.miller.userapp.module.shop.card.version3.pandaLeague.promotion.memberBenefit;
...
@Scenario(scenarioID = "01K47416DYTE34FK0ZBRFPPQMG",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道_优惠标签_会员权益_熊猫联盟频道-商卡二期：会员权益32-会员运费减免",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 20 + 30, manualTestTime = 15)
...
public class ShopShouldHasMemberBenefitDeliveryDsicountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_优惠标签_会员权益_熊猫联盟频道-商卡二期：会员权益32-会员运费免减")
