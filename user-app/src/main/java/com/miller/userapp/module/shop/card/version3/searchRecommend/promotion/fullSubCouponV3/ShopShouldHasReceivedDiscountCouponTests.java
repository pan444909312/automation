package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.fullSubCouponV3;
...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TE", scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_账户内最大红包_搜索列表-商卡二期-SKYX实验组：账户内最大红包43｜折扣红包",
...
public class ShopShouldHasReceivedDiscountCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_账户内最大红包_搜索列表-商卡二期-SKYX实验组：账户内最大红包43｜折扣红包")
