package com.miller.userapp.module.shop.card.version2.pandaLeague.feature.mealsOnTime;
 ...
 */
@Scenario(scenarioID = "01JD43V1GC0AAKRQK9Q3SKXCRK",
        scenarioName = "商卡(中文)_普通店铺配送商卡-熊猫联盟频道_营销标_标签7_出餐准时_熊猫联盟频道-商卡二期：出餐准时",
        author = "shandongdong@hungrypandagroup.com", developmentTime = 10, maintenanceTime = 5, manualTestTime = 10)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasMealsOnTimeFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_营销标_标签7_出餐准时_熊猫联盟频道-商卡二期：出餐准时")
    void shouldExistMealsOnTimeFeature(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
