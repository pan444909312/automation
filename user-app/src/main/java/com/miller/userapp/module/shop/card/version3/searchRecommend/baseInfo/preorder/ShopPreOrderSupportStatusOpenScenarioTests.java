...
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJM6", scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 营业可预约"
...
public class ShopPreOrderSupportStatusOpenScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 营业可预约")
