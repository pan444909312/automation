...
@Scenario(scenarioID = "01K0V7PH8ZT17GZDKXCQGMNKC8",
        scenarioName = "普通店铺配送商卡-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单",
...
public class ShopShouldHasNoOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_营销标_用户下单提醒_不满足条件时不展示｜24h无人下单")
