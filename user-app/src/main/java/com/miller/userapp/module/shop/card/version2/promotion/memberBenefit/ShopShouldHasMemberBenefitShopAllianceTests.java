...
import com.miller.userapp.mapper.shop.ShopMemberCityMapper;
...
//     用户未登录，会员店铺配置了运费减免，展示运费减免红包
       private static ShopMemberCityMapper ShopMemberCityMapper ;

    @BeforeAll
    static void beforeAll() {
         SqlSession sqlSession = DBUtils.getDBOfPandaTest();
        ShopMemberCityMapper = sqlSession.getMapper(ShopMemberCityMapper.class);
    }
    @AfterAll
