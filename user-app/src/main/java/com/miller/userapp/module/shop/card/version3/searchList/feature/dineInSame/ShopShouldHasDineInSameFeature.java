package com.miller.userapp.module.shop.card.version3.searchList.feature.dineInSame;
 ...
 */
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP593M",
        scenarioName = "搜索列表商卡-SKYX01_营销标_堂食同价_搜索列表-商卡二期：堂食同价",
...
public class ShopShouldHasDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_营销标_堂食同价_搜索列表-商卡二期：堂食同价")
