...
@Scenario(scenarioID = "01K0V5AM9J87APF1RASK7GW16C",
        scenarioName = "普通店铺配送商卡-SKYX01_基础信息_店铺logo_首页-商卡二期:独家店铺未勾选开启独家logo，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasNoGifLogoCauseConfigIsClose {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_基础信息_店铺logo_首页-商卡二期:独家店铺未勾选开启独家logo，该店铺设置了主图动图，不会展示动图")
