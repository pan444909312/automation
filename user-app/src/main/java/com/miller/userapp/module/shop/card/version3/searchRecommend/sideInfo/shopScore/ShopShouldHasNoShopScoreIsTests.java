...
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAAH",
        scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_店铺评分_搜索推荐列表-商卡二期：店铺评分-无数据",
...
//                .set(ShopSearchMiddleEntity::getPraiseAverageNew, 0));
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_店铺评分_搜索推荐列表-商卡二期：店铺评分-无数据")
