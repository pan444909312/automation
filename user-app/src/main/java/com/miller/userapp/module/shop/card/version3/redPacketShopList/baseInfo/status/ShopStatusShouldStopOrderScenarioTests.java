...
@Scenario(scenarioID = "01KE9JG2QPPC9TX67MZTJYXW95", scenarioName = "普通店铺配送商卡-品类频道页-SKYX01_基础信息_店铺营业状态_品类频道页-商卡二期:店铺营业状态-暂停接单"
...
//        XXLJobUtils.triggerJob(new PropertiesUtils().getProperty(ShopShouldHasLabelScenarioTests.class, "user.app.job.increment.shop.index.update.id"));
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-品类频道页-SKYX01_基础信息_店铺营业状态_品类频道页-商卡二期:店铺营业状态-暂停接单")
