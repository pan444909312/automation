 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727T0",
        scenarioName = "商卡(中文)_搜索推荐列表商卡_优惠标签_商品折扣_搜索列表-商卡二期:商品折扣28-自取可用",
...
public class ShopShouldHasPickupDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡_优惠标签_商品折扣_搜索列表-商卡二期:商品折扣28-自取可用")
