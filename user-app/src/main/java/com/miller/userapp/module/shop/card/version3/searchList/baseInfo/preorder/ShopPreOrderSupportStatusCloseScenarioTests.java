...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592N", scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺可预约状态_搜索列表-商卡二期：店铺可预约状态 - 打烊可预约"
        , author = "panjuxiang@hungrypandagroup.com", developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopPreOrderSupportStatusCloseScenarioTests {
