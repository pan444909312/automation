...
@Scenario(scenarioID = "01KKJGEP8XW4YBGTV20VKV54VF",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签 - 会场关闭，不返回标签",
...
public class ShopShouldHasNoVenueTagCauseVenueClose {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签 - 会场关闭，不返回标签")
