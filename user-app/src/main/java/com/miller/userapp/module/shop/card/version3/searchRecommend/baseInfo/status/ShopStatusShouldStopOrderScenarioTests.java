...
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS66", scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺营业状态_搜索列表-商卡二期:店铺营业状态-暂停接单"
...
//        XXLJobUtils.triggerJob(new PropertiesUtils().getProperty(ShopShouldHasLabelScenarioTests.class, "user.app.job.increment.shop.index.update.id"));
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺营业状态_搜索列表-商卡二期:店铺营业状态-暂停接单")
