package com.miller.userapp.module.shop.card.version2.home.feature.highEvaluate;
...
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DC0",
        scenarioName = "商卡(中文)_普通店铺配送商卡_营销标_评价标签_评价人数不满足配置，不展示",
...
public class ShopShouldHasNoHighEvaluateFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_营销标_评价标签_评价人数不满足配置，不展示")
    void shouldExistEvaluationFeature(ShopListRequestDTO shopListRequestDTO) {
        ...
        int evaluationOver4UserCnt180dByShopId = dataShopHomeRecommendLabelMapper.getEvaluationOver4Usercnt180dByShopId(shopId);
        Integer cardEvaluateNum = Integer.parseInt(RedisUtils.getRedisInstance().get("CARD_EVALUATE_NUM").toString());
