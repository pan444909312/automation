package com.miller.userapp.module.shop.card.version3.userPack.promotion.memberBenefit;
...
@Scenario(scenarioID = "01K7EE2BWY5839G3R05DV7HRXN",
        scenarioName = "普通店铺自取商卡-SKYX01_优惠标签_会员权益_自取频道-商卡二期：会员权益32-不展示",
...
//        XXLJobUtils.triggerJob(new PropertiesUtils().getProperty(ShopShouldHasLabelScenarioTests.class, "user.app.job.increment.shop.index.update.id"));
    ...
    @ParameterizedTest
    @DisplayName("普通店铺自取商卡-SKYX01_优惠标签_会员权益_自取频道-商卡二期：会员权益32-不展示")
...
//        获取自取频道店铺列表数据
    ...
    static Stream<Arguments> staticDataProvider() {
        ...
        shopListRequestDTO.setLongitude("121.44801");
        shopListRequestDTO.setLatitude("37.46353");
