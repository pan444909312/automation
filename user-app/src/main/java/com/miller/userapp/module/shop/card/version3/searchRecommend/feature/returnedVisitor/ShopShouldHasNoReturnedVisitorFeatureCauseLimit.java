 ...
 */
@Scenario(scenarioID = "01KKJGY6YGHFK8VWWA63G0Y4DM",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_回头客_搜索列表-商卡二期：回头客，不满足最低限制，不展示",
...
public class ShopShouldHasNoReturnedVisitorFeatureCauseLimit {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_回头客_搜索列表-商卡二期：回头客，不满足最低限制，不展示")
