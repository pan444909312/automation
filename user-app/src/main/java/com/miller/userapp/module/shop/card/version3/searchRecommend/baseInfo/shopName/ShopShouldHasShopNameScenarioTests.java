package com.miller.userapp.module.shop.card.version3.searchRecommend.baseInfo.shopName;
...
/**
 * 搜索推荐列表商卡-SKYX01_基础信息_店铺名称_搜索列表-商卡二期:店铺名称
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/07/28 12:17:39
 */
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS62",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺名称_搜索列表-商卡二期:店铺名称",
...
public class ShopShouldHasShopNameScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺名称_搜索列表-商卡二期:店铺名称")
