package com.miller.userapp.module.shop.card.version3.searchRecommend.promotion.fullSub;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TC", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_满减_搜索列表-商卡二期：满减29-不展示",
...
public class ShopShouldHasNoFullSubScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_满减_搜索列表-商卡二期：满减29-不展示")
