package com.miller.userapp.module.shop.card.version3.searchList.baseInfo.shopLogo;
...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592W",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:店铺logo-独家商铺开启独家logo，展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasGifLogoScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:店铺logo-独家商铺开启独家logo，展示动图")
...
//        assertThat(shopLogoOfERPInterfaceResponse).isEqualTo(shopSearchMiddleEntity.getShopLogoGif());
    ...
    static Stream<Arguments> staticLogoDataProvider() {
        ...
        shopListRequestDTO.setKeywords("商卡自动化"); // 开发代码 Bug，没有对 null 进行判断，应该默认给 false
