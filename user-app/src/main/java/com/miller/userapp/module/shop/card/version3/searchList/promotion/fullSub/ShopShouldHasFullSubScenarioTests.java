 ...
 */
@Scenario(scenarioID = "01K9VH77WQY47DMTPAXDEGW7FY", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_满减_搜索列表-商卡二期：满减29",
        author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@EnvTag.Test
@TestFramework
@DisplayName("搜索列表商卡-SKYX01_优惠标签_满减_搜索列表-商卡二期：满减29")
