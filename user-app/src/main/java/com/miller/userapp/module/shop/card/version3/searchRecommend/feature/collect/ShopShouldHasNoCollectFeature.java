...
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS69",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_收藏店铺人数_收藏人数不满足配置，不展示",
...
public class ShopShouldHasNoCollectFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_收藏店铺人数_收藏人数不满足配置，不展示")
