 ...
 * date: 2025/07/26
 */
@Scenario(scenarioID = "01K0RHQEYSFCJTKQ3E79MNPB6E", scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_店铺红包-首页-商卡二期-SKYX实验组：店铺红包42｜店铺金额加码+门槛减码（折扣）",
...
public class ShopShouldHasShopIncreaseDiscountCouponScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_普通店铺配送商卡-SKYX01_优惠标签_店铺红包-首页-商卡二期-SKYX实验组：店铺红包42｜店铺金额加码+门槛减码（折扣）")
    void shouldShowPandLeagueFullSubCouponLabel(ShopListRequestDTO shopListRequestDTO) {
        ...
        assertThat(shopPromoteList.get(1).getShowContent()).isEqualTo("¥4折无门槛");
