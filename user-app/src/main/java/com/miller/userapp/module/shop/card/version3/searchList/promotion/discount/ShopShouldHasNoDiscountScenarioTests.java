package com.miller.userapp.module.shop.card.version3.searchList.promotion.discount;
 ...
 */
@Scenario(scenarioID = "01K9VH77WXZFYFKS4VMCY74DDJ",
        scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_商品折扣_搜索列表-商卡二期:商品折扣28-不展示",
...
public class ShopShouldHasNoDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_优惠标签_商品折扣_搜索列表-商卡二期:商品折扣28-不展示")
