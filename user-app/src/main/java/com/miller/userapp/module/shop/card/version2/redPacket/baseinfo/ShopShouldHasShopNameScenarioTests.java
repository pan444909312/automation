...
/**
 * 商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺名称_首页-商卡二期:店铺名称
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/07/28 12:17:39
 */
@Scenario(scenarioID = "01JE88B2J6482ZXB6ZFYBXQX7K",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_基础信息_店铺名称_首页-商卡二期:店铺名称",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 3 * 60, maintenanceTime = 0, manualTestTime = 30)
@EnvTag.Test
@DisplayName("商卡(中文)")
public class ShopShouldHasShopNameScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_基础信息_店铺名称_首页-商卡二期:店铺名称")
