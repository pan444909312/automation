package com.miller.userapp.module.shop.card.version3.redPacketShopList.sideInfo.startSendMoney;
...
@TestFramework
@Scenario(scenarioID = "01KE9JG2QY1NG81ECGPA99PN0J", scenarioName = "用户-红包适用商家列表店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-辅助信息-起送价-商卡二期：起送价"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 15, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-红包适用商家列表店铺流-商卡(中文)-普通店铺配送商卡-SKYX01-辅助信息-起送价-商卡二期：起送价")
