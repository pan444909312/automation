...
@Scenario(scenarioID = "01KKJGF9C6D916380GECNGR28Y",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店前标签优先级-模板标签大于百万补贴标签",
...
public class ShopTagPriorityVenueGTSubsidy {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店前标签优先级-模板标签大于百万补贴标签")
