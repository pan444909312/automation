 ...
 */
@Scenario(scenarioID = "01JDRD8431APQJK9DDH3E2N2H3",
        scenarioName = "商卡(中文)_普通店铺配送商卡-熊猫联盟频道_优惠标签_商品折扣_熊猫联盟频道-商卡二期:商品折扣28-不展示",
...
public class ShopShouldHasNoDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_优惠标签_商品折扣_熊猫联盟频道-商卡二期:商品折扣28-不展示")
    void shouldNotExistDiscount(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
