...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01JV6RCKS63YM5GE0Y9WC3CFP4", scenarioName = "普通天降链路-天降弹窗-智能营销对照组-直塞模式-强推活动"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 120, maintenanceTime = 0, manualTestTime = 15)
public class GroupPopupForcedAutoScenarioTests {

//    强推计划1张券基础配置
    private static final List<RedPacketConfig> RED_PACKET_CONFIGS = Arrays.asList(
            new RedPacketConfig(888895244L, 500, 1000)
    );
    @BeforeAll
...
//        清除用户已领取的天降数据&红包信息
        ...
        for (GroupPopupForcedAutoScenarioTests.RedPacketConfig redPacketConfig : RED_PACKET_CONFIGS) {
...
//        修改heades实验：去掉ZNYX
    ...
    @DisplayName("普通天降链路-天降弹窗-智能营销对照组-直塞模式-强推活动")
...
//        获取天降结果
    ...
    private void verifyRedPacketConfig(
            ...
            GroupPopupForcedAutoScenarioTests.RedPacketConfig config
    ) {
