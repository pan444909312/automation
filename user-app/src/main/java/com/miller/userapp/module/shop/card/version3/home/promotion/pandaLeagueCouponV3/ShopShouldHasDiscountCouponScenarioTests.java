 ...
 */
@EnvTag.Test
@Scenario(scenarioID = "01J46NM6T46BDDJFHRFM4RN9YX", scenarioName = "普通店铺配送商卡-SKYX01_优惠标签_熊猫联盟券_首页-商卡二期：熊猫联盟券40 - 折扣红包",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("普通店铺配送商卡-SKYX01_优惠标签_熊猫联盟券_首页-商卡二期：熊猫联盟券40 - 折扣红包 ")
public class ShopShouldHasDiscountCouponScenarioTests {
   ...
   void beforeAll() {
      ...
      userLoginRequestDTO.setAccount(new PropertiesUtils().getProperty(UserLoginFlow.class, "user.app.account.for.shop.card.version2.pandaDiscount.user.account"));
      userLoginRequestDTO.setPassword(MD5Util.string2MD5(new PropertiesUtils().getProperty(UserLoginFlow.class, "user.app.account.for.shop.card.version2.pandaDiscount.user.password")));
