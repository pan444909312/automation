package com.miller.userapp.module.shop.card.version3.pandaLeague.baseInfo.shopLogo;
...
@Scenario(scenarioID = "01M2N3P4Q5R6S7T8U9V0W1X3B0",
        scenarioName = "普通店铺配送商卡-熊猫联盟频道-SKYX01_基础信息_店铺logo_非独家店铺，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasNoGifLogoCauseIsNotExclusive {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道-SKYX01_基础信息_店铺logo_非独家店铺，该店铺设置了主图动图，不会展示动图")
