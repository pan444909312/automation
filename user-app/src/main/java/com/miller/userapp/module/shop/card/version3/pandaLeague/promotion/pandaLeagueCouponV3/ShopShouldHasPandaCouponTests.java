...
@Scenario(scenarioID = "01K0RT0MQZCD06MDRYWXNWTTA8", scenarioName = "普通店铺配送商卡-SKYX01_优惠标签_神券_首页-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (不加码)",
...
public class ShopShouldHasPandaCouponTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-SKYX01_优惠标签_神券_首页-商卡二期-SKYX实验组：熊猫联盟券40 - 满减红包 (不加码)")
