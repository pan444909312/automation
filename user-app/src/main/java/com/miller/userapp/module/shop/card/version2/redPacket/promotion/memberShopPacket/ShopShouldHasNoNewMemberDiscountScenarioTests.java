...
@Scenario(scenarioID = "01JE84BAG72WBQ99GSV62N8VKD",
        scenarioName = "普通店铺配送商卡-红包适用商家列表_优惠标签_新会员优惠标签_首页-商卡二期：新会员优惠标签37-不展示",
...
public class ShopShouldHasNoNewMemberDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_新会员优惠标签_首页-商卡二期：新会员优惠标签37-不展示")
