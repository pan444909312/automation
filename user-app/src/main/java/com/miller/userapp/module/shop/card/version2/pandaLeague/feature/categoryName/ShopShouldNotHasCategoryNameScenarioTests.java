...
@TestFramework
@Scenario(scenarioID = "01JDR9SSRCPFQ00ECRA2RG74G1", scenarioName = "用户-首页店铺流-商卡(中文)-普通店铺配送商卡-熊猫联盟频道-辅助信息-类目-首页-商卡二期：类目 - 无数据"
        , developmentTime = 15, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-首页店铺流-商卡(中文)-普通店铺配送商卡-熊猫联盟频道-辅助信息-类目-首页-商卡二期：类目 - 无数据")
