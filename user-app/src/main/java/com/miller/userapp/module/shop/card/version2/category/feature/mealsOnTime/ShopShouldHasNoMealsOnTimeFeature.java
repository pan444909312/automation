 ...
 */
@Scenario(scenarioID = "01JH7C6EZWY6D9ASSG7GT6EY7E",
        scenarioName = "商卡(中文)_普通店铺配送商卡-品类频道_营销标_标签7_出餐准时_品类频道-商卡二期：出餐准时 - 不展示",
...
public class ShopShouldHasNoMealsOnTimeFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-品类频道_营销标_标签7_出餐准时_品类频道-商卡二期：出餐准时 - 不展示")
