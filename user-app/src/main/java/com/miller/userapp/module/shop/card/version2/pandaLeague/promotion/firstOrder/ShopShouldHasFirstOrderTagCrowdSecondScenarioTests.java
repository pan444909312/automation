...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01JDR9SSRB28118W2EDV5WVDF6", scenarioName = "用户-首页店铺流-商卡(中文)-普通店铺配送商卡-熊猫联盟频道-优惠标签-新人首单标签-首页-商卡二期：新人首单标签35-新人人群1"
        , developmentTime = 10, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-首页店铺流-商卡(中文)-普通店铺配送商卡-熊猫联盟频道-优惠标签-新人首单标签-熊猫联盟频道-商卡二期：新人首单标签35-新人人群2")
...
//        测试数据预处理，将user_label表数据label_id设置为2
        ...
        shopNewUserLabelMapper.update(
                                new LambdaUpdateWrapper<UserLabelEntity>().eq(UserLabelEntity::getDeviceId,distinctId).eq(UserLabelEntity::getUserId,userId).set(UserLabelEntity::getLabelId,2)
        );
        //        清除设备对应的活动数据
    ...
    @ParameterizedTest
    void hasFirstOrderTagCrowdSecond(ShopListPandaLeagueRequestDTO ShopListRequestdto){
