package com.miller.userapp.module.shop.card.version3.userPack.promotion.firstOrder.flow;

import com.miller.service.framework.http.HttpUtils;
import com.miller.userapp.constants.BusinessConstant;
import com.miller.userapp.module.shop.card.version3.userPack.promotion.firstOrder.request.ShopListRequestDTO;
...
//        RequestUtils.getHeaders().put("authorization", null);
    ...
    public static ShopListResponseDTO getShopListByShopId(ShopListRequestDTO shopListRequestDTO, Long shopId) {
        try {
            ...
            // 发送请求获取数据
            com.miller.userapp.module.shop.card.version3.userPack.response.ShopListResponseDTO shopListResponse = HttpUtils.sendPostRequestReturnJavaObject(
                    uri,
                    null,
                    RequestUtils.getHeaders(),
                    RequestUtils.putBodyOfJson(shopListRequestDTO),
                    null,
                    com.miller.userapp.module.shop.card.version3.userPack.response.ShopListResponseDTO.class
            );
