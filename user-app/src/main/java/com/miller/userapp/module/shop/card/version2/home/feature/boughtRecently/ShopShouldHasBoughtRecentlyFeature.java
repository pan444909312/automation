package com.miller.userapp.module.shop.card.version2.home.feature.boughtRecently;
 ...
 */
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DC9",
        scenarioName = "商卡(中文)_普通店铺配送商卡_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签",
...
public class ShopShouldHasBoughtRecentlyFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_营销标_买过的店_返回条件：满足下列所有条件时，返回买过的店标签")
