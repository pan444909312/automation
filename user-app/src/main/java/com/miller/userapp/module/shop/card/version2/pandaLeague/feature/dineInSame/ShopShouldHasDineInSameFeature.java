 ...
 */
@Scenario(scenarioID = "01JD44NQPHF2T628ZCJVRYBWEA",
        scenarioName = "商卡(中文)_普通店铺配送商卡-熊猫联盟频道_营销标_标签4_堂食同价_熊猫联盟频道-商卡二期：堂食同价",
...
public class ShopShouldHasDineInSameFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_营销标_标签4_堂食同价_熊猫联盟频道-商卡二期：堂食同价")
    void shouldExistDineInSameFeature(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
