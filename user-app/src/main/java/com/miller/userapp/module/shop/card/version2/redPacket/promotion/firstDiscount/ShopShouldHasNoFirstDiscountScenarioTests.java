 ...
 */
@Scenario(scenarioID = "01JE82VG4KNMAMYDH2M9YCJE1Y",
        scenarioName = "商卡(中文)_普通店铺配送商卡-红包适用商家列表_优惠标签_新客爆品_首页-商卡二期：平台首单23-不展示",
...
public class ShopShouldHasNoFirstDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表_优惠标签_新客爆品_首页-商卡二期：平台首单23-不展示")
