package com.miller.userapp.module.shop.card.version3.userPack.baseInfo.preorder;
...
@Scenario(scenarioID = "01K7JWPQRVRY38M41CF88A28WV", scenarioName = "普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺可预约状态_自取频道：店铺可预约状态 - 打烊可预约（不开启预约单）"
...
public class ShopPreOrderSupportStatusCloseNoPreScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-自取频道-SKYX01_基础信息_店铺可预约状态_自取频道：店铺可预约状态 - 打烊可预约")
