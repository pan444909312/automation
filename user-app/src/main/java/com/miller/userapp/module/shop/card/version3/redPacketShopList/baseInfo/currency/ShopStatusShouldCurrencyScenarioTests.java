package com.miller.userapp.module.shop.card.version3.redPacketShopList.baseInfo.currency;
...
@Scenario(scenarioID = "01KE9JG2QMB3EEST2GW77WREZY",
        scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_红包适用商家列表-商卡二期：货币符号",
...
public class ShopStatusShouldCurrencyScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_基础信息_红包适用商家列表-商卡二期：货币符号")
