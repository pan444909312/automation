...
@Scenario(scenarioID = "01KKJGF3QAR7JRD2P0HQVXEEKJ",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签",
...
public class ShopShouldHasVenueTag {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店前标签：会场模版标签_搜索列表-商卡二期：会场模版标签")
