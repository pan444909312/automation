 ...
 */
@Scenario(scenarioID = "01KE9JG2QWDYJ9ERQ4HSYH8C58",
        scenarioName = "商卡(中文)_普通店铺配送商卡-SKYX01_辅助信息_配送距离_红包适用商家列表-商卡二期：配送距离 - 取缓存距离",
...
public class ShopShouldHasShopCacheDeliveryDistanceScenarioTests {
   ...
   @ParameterizedTest
   @DisplayName("普通店铺配送商卡-SKYX01_辅助信息_配送距离_红包适用商家列表-商卡二期：配送距离 - 取缓存距离 ")
