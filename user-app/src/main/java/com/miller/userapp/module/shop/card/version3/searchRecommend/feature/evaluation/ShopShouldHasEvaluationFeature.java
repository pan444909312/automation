 ...
 */
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS6C",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_人工营销标签_搜索列表-商卡二期：营销文案",
...
public class ShopShouldHasEvaluationFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_人工营销标签_搜索列表-商卡二期：营销文案")
