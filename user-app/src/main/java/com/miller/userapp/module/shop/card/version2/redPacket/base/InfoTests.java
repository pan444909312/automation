package com.miller.userapp.module.shop.card.version2.redPacket.base;

import com.miller.data.center.merchant.TestCaseDataForMerchantConstant;
import com.miller.service.framework.annotation.EnvTag;
import com.miller.service.framework.annotation.Scenario;
import com.miller.userapp.constants.ResponseConstant;
import com.miller.userapp.module.shop.card.version2.redPacket.base.flow.InfoFlow;
import com.miller.userapp.module.shop.card.version2.redPacket.base.request.InfoRequestDTO;
import com.miller.userapp.module.shop.card.version2.redPacket.base.response.InfoResponseDTO;
 ...
 */
@EnvTag.Test
@Scenario(scenarioID = "01J5CW57N1KMMD1W7D0S2SKWYC", scenarioName = "店铺首页-店铺信息", author = "shandongdong@hungrypandagroup.com", developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
