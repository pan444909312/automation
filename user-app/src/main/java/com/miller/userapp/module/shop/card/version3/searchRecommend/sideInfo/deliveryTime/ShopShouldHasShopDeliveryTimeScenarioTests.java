package com.miller.userapp.module.shop.card.version3.searchRecommend.sideInfo.deliveryTime;
 ...
 */
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAAB",
        scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_辅助信息_配送时间_搜索推荐列表-商卡二期：配送时间 - 取单独商家配送时间",
...
public class ShopShouldHasShopDeliveryTimeScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_辅助信息_配送时间_搜索推荐列表-商卡二期：配送时间 - 取单独商家配送时间 ")
