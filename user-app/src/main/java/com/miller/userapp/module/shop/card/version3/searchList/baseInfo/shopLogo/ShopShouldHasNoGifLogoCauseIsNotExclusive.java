...
@Scenario(scenarioID = "01K9RWTX9S9QKGYT6AKTVP592Y",
        scenarioName = "搜索列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:非独家店铺，该店铺设置了主图动图，不会展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasNoGifLogoCauseIsNotExclusive {
    ...
    @ParameterizedTest
    @DisplayName("搜索列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:非独家店铺，该店铺设置了主图动图，不会展示动图")
