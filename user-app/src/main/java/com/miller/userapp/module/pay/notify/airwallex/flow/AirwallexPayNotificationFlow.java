...
public class AirwallexPayNotificationFlow {
    private static final String uri = new PropertiesUtils().getProperty(AirwallexPayNotificationFlow.class,"pay.server.notification.app.url.domain")+ "/api/pandaPay/v1/notify/payment/airwallexPay/v1";
