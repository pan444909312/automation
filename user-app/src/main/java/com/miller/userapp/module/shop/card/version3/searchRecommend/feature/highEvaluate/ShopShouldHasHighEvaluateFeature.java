package com.miller.userapp.module.shop.card.version3.searchRecommend.feature.highEvaluate;
...
@Scenario(scenarioID = "01KJ6V2PCXY737WX6NNT2JKS6G",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_评价标签_满足所有条件时，返回：评价人数标签",
...
public class ShopShouldHasHighEvaluateFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_评价标签_满足所有条件时，返回：评价人数标签")
