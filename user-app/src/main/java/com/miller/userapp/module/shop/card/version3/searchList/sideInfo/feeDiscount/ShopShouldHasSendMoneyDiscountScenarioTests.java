package com.miller.userapp.module.shop.card.version3.searchList.sideInfo.feeDiscount;
...
@TestFramework
@Scenario(scenarioID = "01K9VH77WP0C58RKEXC7J548FB", scenarioName = "用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-SKYX01-辅助信息-运费减免优惠-搜索列表-商卡二期：运费减免优惠"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索列表店铺流-商卡(中文)-搜索列表商卡-SKYX01-辅助信息-运费减免优惠-搜索列表-商卡二期：运费减免优惠")
