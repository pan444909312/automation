...
/**
 * 搜索推荐列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:店铺角标
 *
 * @author Miller Shan
 * @version 1.0
 * @since 2024/06/25 21:17:39
 */
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJM8",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:店铺角标-展示",
...
public class ShopShouldHasLabelScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺角标_搜索列表-商卡二期:店铺角标-展示")
