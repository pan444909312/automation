 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727SW",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_排序_当商家满足当前所有标签时，检查顺序",
...
public class ShopFeatureDefaultSort {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_排序_当商家满足当前所有标签时，检查顺序")
