package com.miller.userapp.module.shop.card.version3.searchList.promotion.discountCouponV3;
 ...
 * date: 2025/07/26
 */
@Scenario(scenarioID = "01K9VH77WW9MEK6T14CJHZPNRZ", scenarioName = "商卡(中文)_搜索列表商卡-SKYX01_优惠标签_店铺红包搜索列表-商卡二期-SKYX实验组：店铺红包42",
...
public class ShopShouldHasShopCouponScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("商卡(中文)_搜索列表商卡-SKYX01_优惠标签_店铺红包搜索列表-商卡二期-SKYX实验组：店铺红包42")
