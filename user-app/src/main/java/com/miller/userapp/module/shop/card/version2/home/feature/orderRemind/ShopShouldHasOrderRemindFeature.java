package com.miller.userapp.module.shop.card.version2.home.feature.orderRemind;
...
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DC3",
        scenarioName = "商卡(中文)_普通店铺配送商卡_营销标_用户下单提醒_满足所有条件时，返回：用户XX刚刚下单了",
...
public class ShopShouldHasOrderRemindFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡_营销标_用户下单提醒_满足所有条件时，返回：用户XX刚刚下单了")
