 ...
 */
@Scenario(scenarioID = "01JDRD8EWT5T1W4VCMY6HG26T4",
        scenarioName = "商卡(中文)_普通店铺配送商卡-熊猫联盟频道_优惠标签_商品折扣_熊猫联盟频道-商卡二期:商品折扣28-外卖可用",
        author = "shandongdong@hungrypandagroup.com", developmentTime = 40, maintenanceTime = 0, manualTestTime = 15)
@EnvTag.Test
@TestFramework
@DisplayName("商卡(中文)")
public class ShopShouldHasTakeoutDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-熊猫联盟频道_基础信息_店铺角标_熊猫联盟频道-商卡二期:商品折扣28-外卖可用")
    void shouldExistTakeoutDiscount(ShopListPandaLeagueRequestDTO shopListPandaLeagueRequestDTO) {
