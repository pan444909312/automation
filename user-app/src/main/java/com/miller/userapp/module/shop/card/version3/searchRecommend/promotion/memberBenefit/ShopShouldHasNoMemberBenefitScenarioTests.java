...
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727TQ",
        scenarioName = "搜索推荐列表商卡-SKYX01_优惠标签_会员权益_搜索列表-商卡二期：会员权益32-不展示",
...
//        XXLJobUtils.triggerJob(new PropertiesUtils().getProperty(ShopShouldHasLabelScenarioTests.class, "user.app.job.increment.shop.index.update.id"));
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_会员权益_搜索列表-商卡二期：会员权益32-不展示")
