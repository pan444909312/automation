...
@Scenario(scenarioID = "01JYJWRY2YSPDAQ90V0NJPGDJF",
        scenarioName = "获取验证码失败-区号黑名单",
...
@Slf4j
public class SendVerificationCodeBlackAreaCodeFail {
...
//        RedisUtils.getRedisInstance().set("message-server:IMG_CAPTCHA:" + captchaToken + 1, checkCode, 6000L);
    ...
    Stream<Arguments> staticDataProvider() {
        ...
        smsSendVerificationCodeReq.setAreaCode("44");
