package com.miller.userapp.module.shop.card.version3.searchRecommend.sideInfo.feeDiscount;
...
@TestFramework
@Scenario(scenarioID = "01KJ6V2PD3THERT8YEQDHNCAAC", scenarioName = "用户-搜索推荐列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-辅助信息-运费减免优惠-搜索推荐列表-商卡二期：运费减免优惠"
        , author = "yancancan@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("用户-搜索推荐列表店铺流-商卡(中文)-搜索推荐列表商卡-SKYX01-辅助信息-运费减免优惠-搜索推荐列表-商卡二期：运费减免优惠")
