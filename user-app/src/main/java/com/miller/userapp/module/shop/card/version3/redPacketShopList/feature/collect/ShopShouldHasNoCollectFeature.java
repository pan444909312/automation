package com.miller.userapp.module.shop.card.version3.redPacketShopList.feature.collect;
...
@Scenario(scenarioID = "01K4WC3MJYP40SQVMQSY9AFQ2Y",
        scenarioName = "普通店铺配送商卡-红包适用商家列表-SKYX01_营销标_收藏店铺人数_收藏人数不满足配置，不展示",
...
public class ShopShouldHasNoCollectFeature {
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-红包适用商家列表-SKYX01_营销标_收藏店铺人数_收藏人数不满足配置，不展示")
