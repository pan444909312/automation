...
@Scenario(scenarioID = "01JDKG0QVJ4RAV5A860KGNMN4S",
        scenarioName = "普通店铺配送商卡-品类频道_优惠标签_会员权益_首页-商卡二期：会员权益32-店铺联盟券",
        author = "shandongdong@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)

@EnvTag.Test
@DisplayName("商卡(中文)")
public class CategoryShopShouldHasMemberBenefitShopAllianceScenarioTests {
...
//         update member_packet set is_del=0 where member_city_id=1111378 and packet_id=888890186;
    ...
    @ParameterizedTest
    @DisplayName("普通店铺配送商卡-品类频道_优惠标签_会员权益_首页-商卡二期：会员权益32-店铺联盟券")
