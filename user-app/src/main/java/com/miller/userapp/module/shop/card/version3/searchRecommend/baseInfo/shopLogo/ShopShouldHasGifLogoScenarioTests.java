...
@Scenario(scenarioID = "01KJ6V2PCWMV9036PKPMBHNJMB",
        scenarioName = "搜索推荐列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:店铺logo-独家商铺开启独家logo，展示动图（新逻辑不判断独家逻辑）",
...
public class ShopShouldHasGifLogoScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_基础信息_店铺logo_搜索列表-商卡二期:店铺logo-独家商铺开启独家logo，展示动图")
