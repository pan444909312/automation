 ...
 */
@Scenario(scenarioID = "01KJ6V2PCZX1W1Z0AGVAVEEZW6",
        scenarioName = "搜索推荐列表商卡-SKYX01_营销标_品类榜单_搜索列表-商卡二期：榜单 - 无榜单数据",
...
public class ShopShouldHasNoShopRankFeature {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_营销标_品类榜单_搜索列表-商卡二期：榜单 - 无榜单数据")
