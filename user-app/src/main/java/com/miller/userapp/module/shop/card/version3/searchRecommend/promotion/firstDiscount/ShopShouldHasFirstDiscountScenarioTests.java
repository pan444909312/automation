 ...
 */
@Scenario(scenarioID = "01KJ6V2PD176CZRX8RXKA727T5", scenarioName = "商卡(中文)_搜索推荐列表商卡-SKYX01_优惠标签_平台首单_搜索列表-商卡二期：平台首单23",
...
public class ShopShouldHasFirstDiscountScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("搜索推荐列表商卡-SKYX01_优惠标签_平台首单_搜索列表-商卡二期：平台首单23")
