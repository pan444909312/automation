package com.miller.testcaseuserapp.factory;

import com.miller.service.framework.util.CurlParser;
import com.miller.testcaseuserapp.utils.TestCaseGenerator;
...
public class TestcaseFactory {
    ...
    public static final String JAVA_BASE_PATH = System.getProperty("user.dir") + "/" + MODULE_NAME + "/src/main/java/com/miller/testcaseuserapp/module";
