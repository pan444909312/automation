...
@Scenario(
        ...
        scenarioName = "店铺流_熊猫联盟频道-膨胀通享商家_店铺-召回-关联招商计划：招商计划已过期 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀通享商家_店铺-召回-关联招商计划：招商计划已过期 - 不召回")
public class LeagueAllianceInvitationExpired_Tests {
