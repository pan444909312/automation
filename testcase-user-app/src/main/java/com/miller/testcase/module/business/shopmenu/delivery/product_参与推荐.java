...
@Scenario(
        scenarioID = "01K4PQY5Z1867M7VS753X0D9N1",
        scenarioName = "商卡-商品信息-参与个性化推荐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-参与个性化推荐商品")
public class product_参与推荐 {
    ...
    String assert1 = "module/home/shop/response/product_参与推荐.json";
    @DisplayName("正向流程")
    @Test
