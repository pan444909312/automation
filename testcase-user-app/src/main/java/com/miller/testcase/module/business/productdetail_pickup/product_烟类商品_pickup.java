...
@Scenario(
        scenarioID = "01KM75MXA6CPM1ETW4QJVJ4NC9",
        scenarioName = "自取商品详情页-商品类型：烟类商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品类型：烟类商品")
public class product_烟类商品_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538086&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_烟类商品.json";
