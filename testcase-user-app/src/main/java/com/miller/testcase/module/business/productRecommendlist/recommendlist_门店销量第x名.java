...
@Scenario(
        scenarioID = "01K797G7RCDJEKWHBC1SGBT1EH",
        scenarioName = "商品详情推荐列表-商品标签：门店销量第x名",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品标签：门店销量第x名")
public class recommendlist_门店销量第x名 {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.recommendProductList[*].systemMarketingTags[*][?(@.tagType==1)]");
