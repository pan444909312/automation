...
@Scenario(
        scenarioID = "01JWG5M9EX4VFA9VD4RQ3R9GKH",
        scenarioName = "进入店铺获取自取菜单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("进入店铺获取自取菜单")
public class MenuListPickUpTab {
    // 接口请求的 path
    ...
    String body = "module/home/shop/request/get_pickupmenulist.json";
    // 断言
