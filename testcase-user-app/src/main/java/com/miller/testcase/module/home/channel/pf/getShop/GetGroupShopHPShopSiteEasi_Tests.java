 ...
 */
@Scenario(
        scenarioID = "01K2ET8BAPF270Q9JSR3WFDYPY", // 自动生成，不要修改
        scenarioName = "品类专题_店铺召回：店铺有效状态-站点-HP（EASI APP） - 不召回",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("品类专题_店铺召回：店铺有效状态-站点-HP（EASI APP） - 不召回")
public class GetGroupShopHPShopSiteEasi_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.channelPfGetShopVOByShopId(875457817,0,55,0, null, null, testGroupNew, null,null,"99",null);
        // 检查响应体为空
