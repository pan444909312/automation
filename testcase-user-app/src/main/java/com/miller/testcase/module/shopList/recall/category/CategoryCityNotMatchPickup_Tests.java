 ...
 */
@Scenario(
        scenarioID = "01K49CXRZJ3SF8EKVB5AWNNE8Y", // 自动生成，不要修改
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.getShopVOByShopId("811629144", "19157826865", "123456a", testGroupNew, null,null, null);
        // 检查响应体不为空
