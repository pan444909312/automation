...
@Scenario(
        scenarioID = "01K4BYR40Z450ZYAR48R1K4NKT",
        scenarioName = "商卡-商品信息-商品类型：烟类商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-商品类型：烟类商品")
public class product_烟类商品 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_烟类商品.json";
    @DisplayName("正向流程")
    @Test
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[*].productList[?(@.productId==82538086)]");        // 步骤4: 断言响应结果，直接拷贝抓包响应结果作为断言。基本固定写法，不需要修改
