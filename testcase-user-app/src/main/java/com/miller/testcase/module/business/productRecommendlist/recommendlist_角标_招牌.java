...
@Scenario(
        scenarioID = "01K795S3MG2V0WGV88WR0VFQY7",
        scenarioName = "商品详情推荐列表-角标：招牌",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-角标：招牌")
public class recommendlist_角标_招牌 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_角标-招牌.json";
