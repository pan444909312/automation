...
@Scenario(
        scenarioID = "01K4BWX1E5TF36TT1SW3GCFYR7",
        scenarioName = "商卡-商品信息-无规格",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-无规格")
public class product_无规格 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_无规格.json";
    @DisplayName("正向流程")
    @Test
