...
@Scenario(
        scenarioID = "01K4PVMYT0HAJ1T2RCHNWNV7H1",
        scenarioName = "商品详情页-角标：招牌",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-角标：招牌")
public class product_角标_招牌 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538084&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
