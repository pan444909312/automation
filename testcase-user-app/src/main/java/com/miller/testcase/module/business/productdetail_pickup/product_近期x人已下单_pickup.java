...
@Scenario(
        scenarioID = "01KM75QCKDQPQEMDM38TZPV0WG",
        scenarioName = "自取商品详情页-商品标签：近期x人已下单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品标签：近期x人已下单")
public class product_近期x人已下单_pickup {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.productDetail.systemMarketingTags[*][?(@.tagType==4)]");
