...
@Scenario(
        scenarioID = "01KM75H6021PVGQZ2M1GW01GXW",
        scenarioName = "自取商品详情页-角标：无角标",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-角标：无角标")
public class product_无角标_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_无角标.json";
