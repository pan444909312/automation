...
@Scenario(
        scenarioID = "01KM75FVVT5GQF5QZXTXENSY3K",
        scenarioName = "自取商品详情页-无规格",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-无规格")
public class product_无规格_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_无规格.json";
