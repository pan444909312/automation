...
@Scenario(
        scenarioID = "01KBPXSVCMASZXWQ0FH463YTA4",
        scenarioName = "进入店铺获取自取列表特殊菜单-新客专享菜单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("进入店铺获取自取列表特殊菜单-新客专享菜单")
public class newUserMenu {
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[?(@.menuInfo.menuType==10)].menuInfo");
