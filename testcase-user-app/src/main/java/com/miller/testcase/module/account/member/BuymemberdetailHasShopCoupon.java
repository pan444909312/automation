 ...
 */
@Scenario(
        scenarioID = "01K38V8B6CPNSAX8W58CDJRSQ0", // 自动生成，不要修改
        scenarioName = "会员购买页-有会员店铺红包",
        author = "panjuxiang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("会员购买页-有会员店铺红包")
public class BuymemberdetailHasShopCoupon {
...
//        headers.put("Authorization", TestCaseHelpful.login("13999900002", "123456"));
        ...
        Object result = TestCaseHelpful.extractValue(responseBody, "$.result.memberBenefitlList[?(@.benefitType==6)]");
