...
@Scenario(
        scenarioID = "01K4BXBFNAJMCTGH04PZBPAVHW",
        scenarioName = "商卡-商品信息-商品类型：普通商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-商品类型：普通商品")
public class product_普通商品 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_普通商品.json";
    @DisplayName("正向流程")
    @Test
