 ...
 */
@Scenario(
        scenarioID = "01K99V405KWZ48NE2CJHERBGNG", // 自动生成，不要修改
        scenarioName = "店铺流_红包适用商家列表_自取拓圈_店铺-召回：不配送可自取",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_红包适用商家列表_自取拓圈_店铺-召回：不配送可自取")
public class RedPacketPickupOnly_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.redPacketGetShopVOByShopId("636655006", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null);
        // 检查响应体不为空
