...
@Scenario(scenarioID = "01K21XREW1MT6YRHQSFDFFB7XM",
        scenarioName = "搜索无结果页推荐列表-店铺角标展示成功",
...
public class SearchRecommendListHasShopLabel {
    ...
    void shouldReturnSuccessfully() {
        ...
        Object label = TestCaseHelpful.extractValue(responseBody, "$.result.shopList[0].newShopLabelUrl");
        TestCaseHelpful.assertThat(label).isNotNull();
