...
public class 搜索店铺中的店铺特色字段_能匹配到 {
    ...
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "店铺特色");
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("店铺特色")).isEqualTo(true);
