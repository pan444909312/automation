...
@Scenario(
        scenarioID = "01KM7627TPPYEJQ88SB9011DS3",
        scenarioName = "自取商品详情页-非限售商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-非限售商品")
public class product_非限售_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_非限售.json";
