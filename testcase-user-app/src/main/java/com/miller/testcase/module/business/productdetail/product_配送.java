...
@Scenario(
        scenarioID = "01K4PWFYE7YQVR5XN8C9ZSNJZ0",
        scenarioName = "商品详情页-商品取货方式：配送",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-商品取货方式：配送")
public class product_配送 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82542042&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_配送.json";
