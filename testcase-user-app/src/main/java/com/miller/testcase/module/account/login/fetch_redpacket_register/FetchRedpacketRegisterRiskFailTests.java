...
/**
 * fetch redpacket register
 *
 * @author yancancan
 * @version 2.0
 * @since 2025/09/26 18:28:54
 */
@Scenario(
        scenarioID = "01K62S344KMX16M6XNTAFPJFX3", // 自动生成，不要修改
...
public class FetchRedpacketRegisterRiskFailTests {
...
//        // 清除已注册用户数据
    ...
    void shouldSuccess() {
        ...
        String headers = "module/account/login/fetch_redpacket_register/request/headers.json";
        // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
        String params = null;
        // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
        String body = "module/account/login/fetch_redpacket_register/request/body.json";
        // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
        String assertFullField = "module/account/login/fetch_redpacket_register/response/assert_full_field.json";
