...
public class 搜索店铺中的店铺位置字段_不能匹配到 {
    ...
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "位置");
