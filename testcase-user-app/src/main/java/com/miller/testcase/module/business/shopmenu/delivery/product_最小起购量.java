...
@Scenario(
        scenarioID = "01K4PR8AZ9J9W5ZRF3YKZFQGVN",
        scenarioName = "商卡-商品信息-最小起购量商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-最小起购量商品")
public class product_最小起购量 {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[*].productList[?(@.productId==82541875)]");        // 步骤4: 断言响应结果，直接拷贝抓包响应结果作为断言。基本固定写法，不需要修改
