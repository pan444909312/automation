...
@Scenario(
        scenarioID = "01K794RR8P1S4ZT81W06096586",
        scenarioName = "商品详情推荐列表-角标：无角标",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-角标：无角标")
public class recommendlist_无角标 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_无角标.json";
