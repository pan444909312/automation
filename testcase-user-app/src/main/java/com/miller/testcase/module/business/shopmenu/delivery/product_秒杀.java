package com.miller.testcase.module.business.shopmenu.delivery;
...
@Scenario(
        scenarioID = "01KM798MM799ND0GYBARDC7WAV",
        scenarioName = "商卡-商品信息-秒杀商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-秒杀商品")
public class product_秒杀 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/app/user/v1/shop/menuList";
    // 请求方式
    String method = "POST";
    // 请求头
    String headers = "module/business/shopmenu/dilivery/8.79.5/request/headers.json";
    ...
    String assert1 = "module/home/shop/response/product_秒杀.json";
    @DisplayName("正向流程")
    @Test
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[*].productList[?(@.productId==82646811)]");        // 步骤4: 断言响应结果，直接拷贝抓包响应结果作为断言。基本固定写法，不需要修改
