...
@Scenario(
        scenarioID = "01K797YDY96F152P5QA1WQ2FJF",
        scenarioName = "商品详情推荐列表-不参与个性化推荐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-不参与个性化推荐商品")
public class recommendlist_不参与推荐 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82591674&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_不参与推荐.json";
