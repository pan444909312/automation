...
@Scenario(
        scenarioID = "01K4PV3WHFK1Q3JBF28KSFZBDA",
        scenarioName = "商品详情页-不参与个性化推荐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-不参与个性化推荐商品")
public class product_不参与推荐 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82541873&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
