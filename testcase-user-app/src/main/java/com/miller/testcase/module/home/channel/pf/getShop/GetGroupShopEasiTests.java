...
/**
 * 品类专题_店铺召回：店铺有效状态-站点-EASI（HP APP） - 不召回
 *
 * @author zhangpei
 * @version 2.0
 * @since 2026/03/10
 */
@Scenario(
        scenarioID = "01KKB7JN607NP6Q9ZKBMHP0NMS", // 自动生成，不要修改
        scenarioName = "品类专题_店铺召回：店铺有效状态-站点-EASI（HP APP） - 不召回",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("品类专题_店铺召回：店铺有效状态-站点-EASI（HP APP） - 不召回")
public class GetGroupShopEasiTests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.channelPfGetShopVOByShopId(245578346,0,55,0, null, null, testGroupNew, null,null,null,null);
