...
@Scenario(
        scenarioID = "01K7945N4BRZJVYFXNQFKTV7AJ",
        scenarioName = "商品详情推荐列表-参与个性化推荐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-参与个性化推荐商品")
public class recommendlist_参与推荐 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_参与推荐.json";
