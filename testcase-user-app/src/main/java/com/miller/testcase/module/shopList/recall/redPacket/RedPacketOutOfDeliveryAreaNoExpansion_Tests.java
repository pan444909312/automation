 ...
 */
@Scenario(
        scenarioID = "01KJYETM4J56NBJT21G7D4TWKT", // 自动生成，不要修改
        scenarioName = "店铺流_红包适用商家列表_无自取拓圈_店铺-召回-无自取拓圈：超配-配送围栏可自取 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_红包适用商家列表_无自取拓圈_店铺-召回-无自取拓圈：超配-配送围栏可自取 - 不召回")
public class RedPacketOutOfDeliveryAreaNoExpansion_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.redPacketGetShopVOByShopId("804560545", "19157826865", "123456a", testGroupNew, "123.43297", "41.80478", null, null, null, null, null);
        // 检查响应体不为空
