package com.miller.testcase.module.home.game.checkin;
...
public class Checkin_Tests {
    ...
    static void beforeAll(){
        ...
        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("update hp_activity_game_user_reward_record set is_del=1 where user_id=1398716670");
    ...
    void shouldSuccess() {
        ...
        String uri = TestcaseConfig.HOST_APP + "/api/user/activity/game/check/in";
        // 接口请求方式。如： GET、POST、PUT、DELETE
        String method = "POST";
        // 请求头。默认从 resources 目录下读取文件。
        String headers = "module/home/game/checkin/request/headers.json";
        // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
        String params = null;
        // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
        String body = "module/home/game/checkin/request/body.json";
        // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
        String assertFullField = "module/home/game/checkin/response/assert_full_field.json";
