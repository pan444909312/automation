...
@Scenario(
        scenarioID = "01KM75J478XAEEBW6751KE476C",
        scenarioName = "自取商品详情页-最小起购量商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-最小起购量商品")
public class product_最小起购量_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82541875&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_最小起购量.json";
