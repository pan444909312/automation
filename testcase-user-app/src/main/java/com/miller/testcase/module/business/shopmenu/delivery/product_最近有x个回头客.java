 ...
 */
@Scenario(
        scenarioID = "01K4CHF20479C6764CB7FFW35B", // 自动生成，不要修改
        scenarioName = "商卡-商品信息-商品标签：最近有x个回头客",
        author = "yaoqianhu@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("商卡-商品信息-商品标签：最近有x个回头客")
public class product_最近有x个回头客 {
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[*].productList[?(@.productId==82539065)].systemMarketingTags[*][?(@.tagType==5)]");
