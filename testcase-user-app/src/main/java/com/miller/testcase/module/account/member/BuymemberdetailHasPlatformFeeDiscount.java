 ...
 */
@Scenario(
        scenarioID = "01K38V7JHDDB2FSQ98WNA72YFY", // 自动生成，不要修改
        scenarioName = "会员购买页-有服务费减免",
        author = "panjuxiang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("会员购买页-有服务费减免")
public class BuymemberdetailHasPlatformFeeDiscount {
    ...
    void shouldSuccess() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody, "$.result.memberBenefitlList[?(@.benefitType==7)]");
