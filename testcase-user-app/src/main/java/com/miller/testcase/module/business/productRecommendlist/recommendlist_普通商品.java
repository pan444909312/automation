...
@Scenario(
        scenarioID = "01K794WCA6Q8YAQCAYS05GV3S5",
        scenarioName = "商品详情推荐列表-商品类型：普通商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品类型：普通商品")
public class recommendlist_普通商品 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_普通商品.json";
