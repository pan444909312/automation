...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.categoryGetShopVOByShopId("360757058", "19157826865", "123456a", testGroupNew, "120.58611","29.99576", null,null,null,null,null);
        // 检查响应体不为空
...
//        assertThat(responseShopBody).isNull();
        ...
        var responseShopBody1 = TestCaseHelpful.categoryGetShopVOByShopId("3924", "19157826865", "123456a", testGroupNew, "120.58611","29.99576", null,null,null,null,null);
        // 检查响应体不为空
//        assertThat(responseShopBody).isNotNull();
        // 检查响应体为空
