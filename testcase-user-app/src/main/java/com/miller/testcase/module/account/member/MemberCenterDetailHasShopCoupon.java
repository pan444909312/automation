...
public class MemberCenterDetailHasShopCoupon {
    ...
    void shouldReturnSuccessfully() {
        ...
        Object result1 = TestCaseHelpful.extractValue(responseBody, "$.result.memberCenterBenefitList[?(@.benefitType==6)]");
        Object result2 = TestCaseHelpful.extractValue(responseBody, "$.result.memberDetailBenefitDescList[?(@.benefitType==6)].name");

        TestCaseHelpful.assertThat(result1.toString()).isNotEqualTo("[]");
        TestCaseHelpful.assertThat(result2.toString()).isEqualTo("[\"会员店铺红包\"]");
