...
@Scenario(
        scenarioID = "01KM7A5AFGX2HTXMQ5X81G1BTE",
        scenarioName = "商卡-商品信息-非秒杀",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-非秒杀")
public class product_非秒杀 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_非秒杀.json";
    @DisplayName("正向流程")
    @Test
