...
@Scenario(scenarioID = "01KBM4VRHGAWXRF255CKKE1APM",
        scenarioName = "搜索_搜索词的同义词会被召回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("/api/user/v2/search")
public class 搜索_搜索词的同义词会被召回 {
    private static final String uri = TestcaseConfig.HOST_APP + "/api/user/v2/search";

    private String shopId = "469532708";
    private String shopIdTongYiCi = "159605027";


    @DisplayName("搜索_搜索词的同义词会被召回")
    @Test
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "盒马");
        ...
        Object result3 = TestCaseHelpful.extractValue(responseBody, "$.result.shopList[?(@.shopId==" + shopIdTongYiCi + ")]");
        Object result4 = TestCaseHelpful.extractValue(responseBody, "$.result.shopList[?(@.shopId==" + shopIdTongYiCi + ")].shopName");
        ...
        TestCaseHelpful.assertThat(result3.toString()).isNotEqualTo("[]");
        TestCaseHelpful.assertThat(result4.toString().contains("永辉")).isEqualTo(true);
