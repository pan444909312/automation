 ...
 */
@Scenario(
        scenarioID = "01JZT5KMX0W6RQP1GQVHY0RD17", // 自动生成，不要修改
        scenarioName = "pf融合开关：开启&不在ab测&HPapp",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("pf融合开关：开启&不在ab测&HPapp")
public class GetHpfConfigNotInABHP_Tests {
