 ...
 */
@Scenario(
        scenarioID = "01K3QA3TE4ZZC0X3TVVM4Y1SY3", // 自动生成，不要修改
        scenarioName = "微信小程序渠道：新账户注册失败（验证码错误）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("微信小程序渠道：新账户注册失败（验证码错误）")
public class WXCheckCodeRegisterFailTests {
    ...
    static void beforeAll(){
        ...
        String telephone = getPhoneNumber("15900000010");
