...
@Scenario(scenarioID = "01K73T8D4P54YP9QCXF29R8QXQ",
        scenarioName = "搜索_检查搜索词在名称中间的商品所在的店铺被召回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("/api/user/v2/search")
public class 搜索_检查搜索词在名称中间的商品所在的店铺被召回 {
    private static final String uri = TestcaseConfig.HOST_APP + "/api/user/v2/search";

    private String shopId = "469532708";
    private String productId = "82552230";

    @DisplayName("搜索_检查搜索词在名称中间的商品所在的店铺被召回")
    @Test
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "炸鸡");
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("炸鸡")).isEqualTo(false);
        TestCaseHelpful.assertThat(result3.toString().contains("炸鸡")).isEqualTo(true);
