package com.miller.testcase.module.shopList.recall.redPacket.presaleShop;
 ...
 * @author HuYang
 * @version 2.0
 * @since 2026/03/06 13:30:40
 */
@Scenario(
        scenarioID = "01KJYETM4J56NBJT21G7D4TWM7", // 自动生成，不要修改
        scenarioName = "店铺流_红包适用商家列表_预售店铺_自取拓圈_店铺-召回-自取拓圈：超配-配送范围可自取-预售店铺",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_红包适用商家列表_预售店铺_自取拓圈_店铺-召回-自取拓圈：超配-配送范围可自取-预售店铺")
public class RedPacketOutOfDeliveryDistancePickupPresale_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.redPacketGetShopVOByShopId("263043897", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null);
        // 检查响应体不为空
