 ...
 */
@Scenario(
        scenarioID = "01KJYETM4J56NBJT21G7D4TWKZ", // 自动生成，不要修改
        scenarioName = "店铺流_红包适用商家列表_预售店铺_店铺-召回-普通店铺-预售店铺状态：预售店铺配置已删除",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_红包适用商家列表_预售店铺_店铺-召回-普通店铺-预售店铺状态：预售店铺配置已删除")
public class RedPacketPresaleConfigDeletedPresale_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.redPacketGetShopVOByShopId("160521236", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null);
        // 检查响应体不为空
