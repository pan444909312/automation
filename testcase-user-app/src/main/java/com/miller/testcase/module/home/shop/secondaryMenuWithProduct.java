...
@Scenario(
        scenarioID = "01K102XGQV57AW79J9MQ3PT9JX",
        scenarioName = "超市店铺商品二级菜单数据",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("超市店铺商品二级菜单数据")
public class secondaryMenuWithProduct {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/app/user/shop/secondaryMenuWithProduct";
    // 请求方式
    String method = "POST";
    // 请求头
    String headers = "module/headers.json";
    // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求
    String body = "module/home/shop/request/secondaryMenuWithProductReq.json";
    // 断言
    String assert2 = "module/home/shop/response/secondaryMenuWithProductResp.json";
