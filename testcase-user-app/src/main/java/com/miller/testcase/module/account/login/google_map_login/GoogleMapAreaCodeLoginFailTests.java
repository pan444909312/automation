 ...
 */
@Scenario(
        scenarioID = "01K3QMSKHYHR8E3MBRDW7R9VS0", // 自动生成，不要修改
        scenarioName = "GFO渠道：老用户登录失败（验证码区号不匹配）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("GFO渠道：老用户登录失败（验证码区号不匹配）")
public class GoogleMapAreaCodeLoginFailTests {
