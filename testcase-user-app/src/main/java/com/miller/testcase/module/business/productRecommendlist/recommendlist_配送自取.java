...
@Scenario(
        scenarioID = "01K794ZXQPH0JN2344G61TX46V",
        scenarioName = "商品详情推荐列表-商品取货方式：配送+自取",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品取货方式：配送+自取")
public class recommendlist_配送自取 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_配送+自取.json";
