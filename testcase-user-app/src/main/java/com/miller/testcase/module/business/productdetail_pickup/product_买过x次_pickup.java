...
@Scenario(
        scenarioID = "01KM75DK2D7194AEZMC7136BYD",
        scenarioName = "自取商品详情页-商品标签：买过x次",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品标签：买过x次")
public class product_买过x次_pickup {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.productDetail.systemMarketingTags[*][?(@.tagType==3)]");
