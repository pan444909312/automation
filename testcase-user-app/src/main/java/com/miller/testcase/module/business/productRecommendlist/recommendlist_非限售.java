...
@Scenario(
        scenarioID = "01K7959SYHJTE3FCQTYAZRF2HX",
        scenarioName = "商品详情推荐列表-非限售商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-非限售商品")
public class recommendlist_非限售 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_非限售.json";
