...
@Scenario(
        scenarioID = "01JXCFQVEE8628AEASMKP8QDW1",
        scenarioName = "进入店铺获取自取菜单的商品分页列表",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("进入店铺获取自取菜单的商品分页列表")
public class MenuProductPageList_pickup {
    // 接口请求的 path
    ...
    String body = "module/home/shop/request/pickup_ProductPageListReq.json";
    // 断言
    String assert2 = "module/home/shop/response/ProductPageListResp.json";
