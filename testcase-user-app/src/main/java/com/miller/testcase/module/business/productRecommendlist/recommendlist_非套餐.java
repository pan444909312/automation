...
@Scenario(
        scenarioID = "01K795JH21TV9K780QH7DYBY6F",
        scenarioName = "商品详情推荐列表-非套餐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-非套餐商品")
public class recommendlist_非套餐 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_非套餐.json";
