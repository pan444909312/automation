...
@Scenario(
        scenarioID = "01K4PVZK2VB3AHPBQ0V81M2RN9",
        scenarioName = "商品详情页-商品类型：大麻商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-商品类型：大麻商品")
public class product_大麻商品 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538087&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
