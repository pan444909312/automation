...
@Scenario(
        scenarioID = "01K4PV6JS2FD2KD38QC02XBSD6",
        scenarioName = "商品详情页-最小起购量商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-最小起购量商品")
public class product_最小起购量 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82541875&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
