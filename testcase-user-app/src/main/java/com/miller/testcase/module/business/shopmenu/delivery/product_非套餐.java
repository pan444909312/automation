...
@Scenario(
        scenarioID = "01K4BT138S70GRDJPGVVYEJ4RK",
        scenarioName = "商卡-商品信息-非套餐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-非套餐商品")
public class product_非套餐 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_非套餐.json";
    @DisplayName("正向流程")
    @Test
