...
@Scenario(
        scenarioID = "01K78YRQ5QBSFKJSGEQ84Y8DPD",
        scenarioName = "商品详情推荐列表-商品基本信息",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品基本信息")
public class recommendlist_baseinfo {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/response/recommendlistBaseInfolResp.json";
