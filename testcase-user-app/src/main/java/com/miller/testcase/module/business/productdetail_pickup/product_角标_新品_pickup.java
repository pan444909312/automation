...
@Scenario(
        scenarioID = "01KM75NYTXVZ57YDENF0PTQE0M",
        scenarioName = "自取商品详情页-角标：新品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-角标：新品")
public class product_角标_新品_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82537918&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_角标-新品.json";
