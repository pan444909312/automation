 ...
 */
@Scenario(
        scenarioID = "01KCGT6FW69F9FH6RW8AGGQR4Y", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀通享商家【去使用】_店铺-召回-融合店铺：列表有融合店铺",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀通享商家【去使用】_店铺-召回-融合店铺：列表有融合店铺")
public class LeagueAllianceUseListHasPFHybridShop_Tests {
