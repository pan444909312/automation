...
@Scenario(scenarioID = "01K44ESB5Q98B2FNA12X6BB50F",
        scenarioName = "拉取启动页广告-跳转活动专题",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("/api/user/v1/launchAd/pull")
public class LaunchAdJumpModuleActivity {
    private static final String uri = TestcaseConfig.HOST_APP + "/api/user/v1/launchAd/pull";

    @BeforeAll
    void beforeAll() {
        LaunchAdUtils.initCityLaunchAd("九江市");
        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("update hp_launch_ad set state = 1 where la_id = 278");
    }

    @AfterAll
    void afterAll() {
        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("update hp_launch_ad set state = 0 where la_id = 278");
    }

    @DisplayName("拉取启动页广告-跳转活动专题")
    @Test
    void shouldReturnSuccessfully() {
        ...
        TestCaseHelpful.assertThat(jumpUrl.toString()).isEqualTo("hptakeout://module=deeplink&action=openPage&params=**&callback=CALLBACK_NAME&code=ac0999f5bb47898");
        TestCaseHelpful.assertThat((int)jumpType).isEqualTo(3);
