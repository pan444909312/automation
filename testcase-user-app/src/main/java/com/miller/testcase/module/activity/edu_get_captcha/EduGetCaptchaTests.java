package com.miller.testcase.module.activity.edu_get_captcha;
 ...
 * @author yancancan
 * @version 2.0
 * @since 2025/06/13 16:17:55
 */
@Scenario(
        scenarioID = "01JXM5VTSQRBTXW3HE7XNEH50R", // 自动生成，不要修改
        scenarioName = "edu_get_captcha",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("edu_get_captcha")
public class EduGetCaptchaTests {
    // TestcaseConfig.HOST 是接口的请求域名。 后面的 + "是接口的请求路径"
    String uri = TestcaseConfig.Host_Mobile + "/api/app/user/edu/getCaptcha";
