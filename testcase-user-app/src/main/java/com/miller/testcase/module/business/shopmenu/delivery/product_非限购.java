...
@Scenario(
        scenarioID = "01K4PJV1NSM1KTK8X1MSJW9XK5",
        scenarioName = "商卡-商品信息-非限购商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-非限购商品")
public class product_非限购 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_非限购.json";
    @DisplayName("正向流程")
    @Test
