...
public class 搜索店铺中的店铺名称字段_能匹配到 {
    ...
    void shouldReturnSuccessfully() {
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("店铺名称")).isEqualTo(true);
