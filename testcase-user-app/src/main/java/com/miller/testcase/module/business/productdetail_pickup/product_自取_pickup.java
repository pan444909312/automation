...
@Scenario(
        scenarioID = "01KM75NBYG43W3E6NH1KHJJM4P",
        scenarioName = "自取商品详情页-商品取货方式：自取",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品取货方式：自取")
public class product_自取_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82542043&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_自取.json";
