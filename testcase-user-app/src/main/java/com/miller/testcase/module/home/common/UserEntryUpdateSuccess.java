...
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DDF",
        scenarioName = "App词条更新接口成功",
...
public class UserEntryUpdateSuccess {
    ...
    void shouldReturnSuccessfully() {
        ...
        String requestBody = TestCaseHelpful.getJsonRequestBody("module/home/common/request/UserEntryUpdateReq.json");
        String responseBody = TestCaseHelpful.sendRequest("POST", uri, null, headers, requestBody);
        String expectedStr = TestCaseHelpful.getFileContent("module/home/common/response/UserEntryUpdateResp.json");
