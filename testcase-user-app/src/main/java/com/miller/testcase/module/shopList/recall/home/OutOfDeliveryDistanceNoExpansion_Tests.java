 ...
 */
@Scenario(
        scenarioID = "01KJYETM4J56NBJT21G7D4TWK0", // 自动生成，不要修改
        scenarioName = "店铺流_首页_无自取拓圈_店铺-召回-无自取拓圈：超配-配送范围可自取 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_首页_无自取拓圈_店铺-召回-无自取拓圈：超配-配送范围可自取 - 不召回")
public class OutOfDeliveryDistanceNoExpansion_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.getShopVOByShopId("804560545", "19157826865", "123456a", testGroupNew,"123.35797","41.78124", null);
        // 检查响应体不为空
