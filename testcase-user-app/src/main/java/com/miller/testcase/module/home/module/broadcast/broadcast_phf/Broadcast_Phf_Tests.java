package com.miller.testcase.module.home.module.broadcast.broadcast_phf;
 ...
 * @author yaoqianhu
 * @version 2.0
 * @since 2025/08/05 17:57:14
 */
@Scenario(
        scenarioID = "01K1WTKRHATEJ7EAMESWMFTBGW", // 自动生成，不要修改
        scenarioName = "一人食专区：一人食专区正常展示",
        author = "yaoqianhu@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("一人食专区：一人食专区正常展示")
public class Broadcast_Phf_Tests {
    ...
    void shouldSuccess() {
        ...
        String headers = "module/home/module/broadcast/broadcast_phf/request/headers.json";
        // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
        String params = null;
        // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
        String body = "module/home/module/broadcast/broadcast_phf/request/body.json";
        // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
        String assertFullField = "module/home/module/broadcast/broadcast_phf/response/assert_full_field.json";
