...
@Scenario(
        scenarioID = "01K799M2EAHJP877VQMT1GPX4S",
        scenarioName = "商品详情推荐列表-最小起购量商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-最小起购量商品")
public class recommendlist_最小起购量 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82591675&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_最小起购量.json";
