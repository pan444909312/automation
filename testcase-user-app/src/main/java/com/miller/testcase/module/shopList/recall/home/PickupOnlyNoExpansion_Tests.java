 ...
 */
@Scenario(
        scenarioID = "01KJYETM4J56NBJT21G7D4TWJZ", // 自动生成，不要修改
        scenarioName = "店铺流_首页_无自取拓圈_店铺-召回-无自取拓圈：不配送可自取 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_首页_无自取拓圈_店铺-召回-无自取拓圈：不配送可自取 - 不召回")
public class PickupOnlyNoExpansion_Tests {
