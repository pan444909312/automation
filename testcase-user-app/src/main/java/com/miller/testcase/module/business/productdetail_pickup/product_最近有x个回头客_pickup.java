package com.miller.testcase.module.business.productdetail_pickup;
...
@Scenario(
        scenarioID = "01KM75M6P1TW62E5Q0HSN780S5",
        scenarioName = "自取商品详情页-商品标签：最近有x个回头客",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品标签：最近有x个回头客")
public class product_最近有x个回头客_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82539065&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String assert1 = "module/home/shop/response/product_最近有x个回头客.json";
    @DisplayName("正向流程")
    @Test
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.productDetail.systemMarketingTags[*][?(@.tagType==5)]");
