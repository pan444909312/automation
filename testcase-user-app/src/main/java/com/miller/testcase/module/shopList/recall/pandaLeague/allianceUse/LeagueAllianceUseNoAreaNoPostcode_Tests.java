 ...
 */
@Scenario(
        scenarioID = "01KB4XKH2C2X1EQP71VJW0EMEP", // 自动生成，不要修改
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.pandaLeagueGetShopVOByShopId("708582858", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null, "[{\n\"redPacketId\": 888896287,\n\"redPacketScopeType\": 2,\n\"userCdKeyId\": 1727087097493\n}]", "1", null);
        // 检查响应体不为空
