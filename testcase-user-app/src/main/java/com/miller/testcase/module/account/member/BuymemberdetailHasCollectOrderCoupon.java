 ...
 */
@Scenario(
        scenarioID = "01K38V0YJ3KXB3BPA8398T9BW1", // 自动生成，不要修改
        scenarioName = "会员购买页-有集单返红包",
        author = "panjuxiang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("会员购买页-有集单返红包")
public class BuymemberdetailHasCollectOrderCoupon {
...
//        headers.put("Authorization", TestCaseHelpful.login("13999900002", "123456"));
        ...
        Object result = TestCaseHelpful.extractValue(responseBody, "$.result.memberBenefitlList[?(@.benefitType==3)]");
