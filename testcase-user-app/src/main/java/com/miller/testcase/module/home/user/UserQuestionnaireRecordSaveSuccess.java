...
@Scenario(scenarioID = "01JVKR6DPZH7V8WK4B381AMV6N",
        scenarioName = "问卷记录保存成功",
...
public class UserQuestionnaireRecordSaveSuccess {
    ...
    void shouldReturnSuccessfully() {
        ...
        String requestBody = TestCaseHelpful.getJsonRequestBody("module/home/user/request/UserQuestionnaireRecordSaveReq.json");
        String responseBody = TestCaseHelpful.sendRequest("POST", uri, null, headers, requestBody);
        String expectedStr = TestCaseHelpful.getFileContent("module/home/user/response/UserQuestionnaireRecordSaveResp.json");
