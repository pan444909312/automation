...
@Scenario(
        scenarioID = "01K4PVDR1R6ZWJ6QX9SCRF4FW7",
        scenarioName = "商品详情页-角标：新品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-角标：新品")
public class product_角标_新品 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82537918&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
