 ...
 */
@Scenario(
        scenarioID = "01K4CHJAAY78E6G3K347XCV5QA", // 自动生成，不要修改
        scenarioName = "商卡-商品信息-商品标签：商品营销标签",
        author = "yaoqianhu@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("商卡-商品信息-商品标签：商品营销标签")
public class product_商品营销标签 {
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[*].productList[?(@.productId==82539065)].systemMarketingTags[*][?(@.tagType==6)]");
