...
public class MemberCenterDetailHasPlatformCoupon {
    ...
    void shouldReturnSuccessfully() {
        ...
        Object result1 = TestCaseHelpful.extractValue(responseBody, "$.result.memberCenterBenefitList[?(@.benefitType==1)]");
        Object result2 = TestCaseHelpful.extractValue(responseBody, "$.result.memberDetailBenefitDescList[?(@.benefitType==1)].name");

        TestCaseHelpful.assertThat(result1.toString()).isNotEqualTo("[]");
        TestCaseHelpful.assertThat(result2.toString()).isEqualTo("[\"平台券\"]");
