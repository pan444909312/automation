 ...
 */
@Scenario(
        scenarioID = "01K2ETE6434EXAZVG4YY07JJ2W", // 自动生成，不要修改
        scenarioName = "品类专题_店铺召回：店铺有效状态-站点-HP及EASI（EASI APP）",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("品类专题_店铺召回：店铺有效状态-站点-HP及EASI（EASI APP）")
public class GetGroupShopHPAndEasiShopSiteEasi_Tests {
    ...
    void shouldSuccess() {
        ...
        var responseShopBody = TestCaseHelpful.channelPfGetShopVOByShopId(305457843,0,55,0, null, null, testGroupNew, null,null,"99",null);
        // 检查响应体不为空
