...
@Scenario(
        scenarioID = "01K793KC3K0AKP14CGB7HP4JM9",
        scenarioName = "商品详情推荐列表-商品状态：上线",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品状态：上线")
public class recommendlist_上线 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_上线.json";
