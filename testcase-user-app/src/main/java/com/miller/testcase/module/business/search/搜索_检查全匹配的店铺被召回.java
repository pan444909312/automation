...
@Scenario(scenarioID = "01K5EC5EJ7YGKJVS472R44PRR1",
        scenarioName = "搜索_检查全匹配的店铺被召回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("/api/user/v2/search")
public class 搜索_检查全匹配的店铺被召回 {
    private static final String uri = TestcaseConfig.HOST_APP + "/api/user/v2/search";

    private String shopId = "302310267";

    @DisplayName("搜索_检查全匹配的店铺被召回")
    @Test
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "包笼天下");
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("包笼天下")).isEqualTo(true);
