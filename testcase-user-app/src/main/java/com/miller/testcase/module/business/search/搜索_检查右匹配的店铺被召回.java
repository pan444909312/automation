...
public class 搜索_检查右匹配的店铺被召回 {
    ...
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "和平");
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("和平早餐店")).isEqualTo(true);
