...
@Scenario(
        scenarioID = "01K79924V0HPCRX3N0Y9HRXRJE",
        scenarioName = "商品详情推荐列表-限售商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-限售商品")
public class recommendlist_限售 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_限售.json";
