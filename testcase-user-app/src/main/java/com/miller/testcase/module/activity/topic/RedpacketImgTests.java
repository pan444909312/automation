...
@Scenario(
        scenarioID = "01JWSS1KB2H2X5WV4YW6GE43G9",
        scenarioName = "获取活动专题信息-红包楼层",
...
public class RedpacketImgTests {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/activity/getRedPacketImageByModuleId";
    // 请求方式
    String method = "POST";
    // 请求头
    String headers = "module/activity/topic/activityinfo/request/headers_topic.json";
    // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求
    String body = "module/activity/topic/redpacketurl/request/success.json";
    // 断言
    String assert2 = "module/activity/topic/redpacketurl/response/assert_some_fields.json";
    @DisplayName("获取活动专题信息-红包楼层")
    @Test
    void shouldReturnSuccessfully() {
        ...
        params.put("moduleId","d98f7c94431ceaa6d066a4a45dcf3e10");
//        params.put("pageNo",1);
