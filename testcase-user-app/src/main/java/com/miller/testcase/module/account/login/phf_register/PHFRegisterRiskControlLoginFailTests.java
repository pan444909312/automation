 ...
 */
@Scenario(
        scenarioID = "01K45071G2XG4T8FNTG6Z9V1Y3", // 自动生成，不要修改
        scenarioName = "小程序-拼好饭/奶茶渠道：新账户注册失败（设备注册账号已达上限）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("小程序-拼好饭/奶茶渠道：新账户注册失败（设备注册账号已达上限）")
public class PHFRegisterRiskControlLoginFailTests {
