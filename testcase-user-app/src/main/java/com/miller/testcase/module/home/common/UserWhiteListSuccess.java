...
@Scenario(scenarioID = "01JVKR6DPY3AY792BTB6AE5DDH",
        scenarioName = "白名单校验成功",
...
public class UserWhiteListSuccess {
    ...
    void shouldReturnSuccessfully() {
        ...
        String requestBody = TestCaseHelpful.getJsonRequestBody("module/home/common/request/UserWhiteListReq.json");
        String responseBody = TestCaseHelpful.sendRequest("POST", uri, null, headers, requestBody);
        String expectedStr = TestCaseHelpful.getFileContent("module/home/common/response/UserWhiteListResp.json");
