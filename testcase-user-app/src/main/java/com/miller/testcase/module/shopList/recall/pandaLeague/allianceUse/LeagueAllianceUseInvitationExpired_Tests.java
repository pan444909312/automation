 ...
 */
@Scenario(
        scenarioID = "01KCGT6FW69F9FH6RW8AGGQR4T", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀通享商家【去使用】_店铺-召回-关联招商计划：招商计划已过期 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀通享商家【去使用】_店铺-召回-关联招商计划：招商计划已过期 - 不召回")
public class LeagueAllianceUseInvitationExpired_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.pandaLeagueGetShopVOByShopId("712493821", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null, "1", "[{\n\"redPacketId\": 888896287,\n\"redPacketScopeType\": 2,\n\"userCdKeyId\": 1727087097493\n}]", "1", null);
        // 检查响应体不为空
