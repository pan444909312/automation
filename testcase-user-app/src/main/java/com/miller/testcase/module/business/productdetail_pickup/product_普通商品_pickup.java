...
@Scenario(
        scenarioID = "01KM75HC5Q67RESXQRF3BCZ6GW",
        scenarioName = "自取商品详情页-商品类型：普通商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品类型：普通商品")
public class product_普通商品_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_普通商品.json";
