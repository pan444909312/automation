...
@Scenario(
        scenarioID = "01KM75NYCKW16DF1G577X1QBPH",
        scenarioName = "自取商品详情页-角标：招牌",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-角标：招牌")
public class product_角标_招牌_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538084&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_角标-招牌.json";
