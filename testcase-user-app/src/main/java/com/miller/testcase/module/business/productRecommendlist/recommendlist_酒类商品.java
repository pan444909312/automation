...
@Scenario(
        scenarioID = "01K798DK3MJVFKBK2XG5N7JV76",
        scenarioName = "商品详情推荐列表-商品类型：酒类商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品类型：酒类商品")
public class recommendlist_酒类商品 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_酒类商品.json";
