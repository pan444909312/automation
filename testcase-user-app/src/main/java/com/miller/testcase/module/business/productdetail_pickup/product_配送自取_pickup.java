...
@Scenario(
        scenarioID = "01KM75QZXP4SPSWCYDEPK2J8NR",
        scenarioName = "自取商品详情页-商品取货方式：配送+自取",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品取货方式：配送+自取")
public class product_配送自取_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_配送+自取.json";
