 ...
 */
@Scenario(
        scenarioID = "01KB4XKH2BR908KHSFEH004KQG", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回：非熊猫联盟店铺专享商家",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回：非熊猫联盟店铺专享商家")
public class LeagueExclusiveUseMerchantNotPandaLeagueShop_Tests {
