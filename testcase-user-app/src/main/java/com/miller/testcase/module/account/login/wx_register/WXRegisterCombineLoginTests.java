 ...
 */
@Scenario(
        scenarioID = "01K30HSCAAST4J2R542P842151", // 自动生成，不要修改
        scenarioName = "wx register combine login",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("微信小程序渠道：新账户注册成功")
public class WXRegisterCombineLoginTests {
