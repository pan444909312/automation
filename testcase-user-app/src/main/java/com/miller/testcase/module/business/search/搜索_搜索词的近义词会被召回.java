...
public class 搜索_搜索词的近义词会被召回 {
    ...
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "河马");
