...
@Scenario(
        scenarioID = "01K7984QTAP4YF4G5WHPDAGYM5",
        scenarioName = "商品详情推荐列表-限购商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-限购商品")
public class recommendlist_限购 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_限购.json";
