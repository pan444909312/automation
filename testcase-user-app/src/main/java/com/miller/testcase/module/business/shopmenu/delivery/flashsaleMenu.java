...
@Scenario(
        scenarioID = "01KM7AR7WBJYSQD0P4WVYHPMNR",
        scenarioName = "进入店铺配送列表获取特殊菜单-秒杀菜单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("进入店铺配送列表获取特殊菜单-秒杀菜单")
public class flashsaleMenu {
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[?(@.menuInfo.menuType==21)].menuInfo");
