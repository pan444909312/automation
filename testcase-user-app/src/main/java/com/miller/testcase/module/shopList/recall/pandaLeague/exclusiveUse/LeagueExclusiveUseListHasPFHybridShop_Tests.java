 ...
 * @author HuYang
 * @version 2.0
 * @since 2025/11/27 21:30:00
 */
@Scenario(
        scenarioID = "01KB4XKH2BR908KHSFEH004KQD", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回-融合店铺：列表有融合店铺",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回-融合店铺：列表有融合店铺")
public class LeagueExclusiveUseListHasPFHybridShop_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.pandaLeagueGetShopVOByShopId("937168010", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null, "1", "[{\n\"redPacketId\": 888896287,\n\"redPacketScopeType\": 2,\n\"userCdKeyId\": 1727087097493\n}]", null, null);
        // 检查响应体不为空
...
//        var responseShopBody1 = TestCaseHelpful.getShopVOByShopId("3924", "19157826865", "123456a", testGroupNew, "120.58611","29.99576", null);
        // 检查响应体不为空
//        assertThat(responseShopBody).isNotNull();
        // 检查响应体为空
