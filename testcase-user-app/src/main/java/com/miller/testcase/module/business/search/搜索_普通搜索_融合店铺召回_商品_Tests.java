 ...
 * @author 张培
 * @version 2.0
 * @since 2025/10/28 11:53:23
 */
@Scenario(
        scenarioID = "01JZQ67ERFWEM68JA3V20M9WMR", // 自动生成，不要修改
        scenarioName = "搜索_普通搜索_融合店铺_商品_融合店铺有白菜商品”",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("搜索_普通搜索_融合店铺_商品_融合店铺有白菜商品")
public class 搜索_普通搜索_融合店铺召回_商品_Tests {
    // 待搜索的词
    String searchWord = "白菜";
    @BeforeAll
    void beforeAll() {
    ...
    void shouldSuccess() {
        ...
        String headers = "module/home/search/chinese/regression_testing/搜索_普通搜索_融合店铺_商品/request/headers.json";
