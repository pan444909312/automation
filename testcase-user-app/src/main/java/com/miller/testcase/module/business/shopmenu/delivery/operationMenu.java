...
@Scenario(
        scenarioID = "01JZW4K1TQX1HEQYG6FV5T46HH",
        scenarioName = "进入店铺获取特殊菜单-运营菜单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("进入店铺获取特殊菜单-运营菜单")
public class operationMenu {
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[?(@.menuInfo.menuType==2)].menuInfo");
