...
@Scenario(
        scenarioID = "01K4PTK1R4FAV5NDFXRSJ4NJ7E",
        scenarioName = "商品详情页-是套餐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-是套餐商品")
public class product_是套餐 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82457768&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
