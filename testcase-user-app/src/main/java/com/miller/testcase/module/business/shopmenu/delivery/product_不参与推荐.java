...
@Scenario(
        scenarioID = "01K4PR2W7S9PY7BA5S24SCXR6H",
        scenarioName = "商卡-商品信息-不参与个性化推荐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-不参与个性化推荐商品")
public class product_不参与推荐 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_不参与推荐.json";
    @DisplayName("正向流程")
    @Test
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.menuList[0].subMenuList[*].productList[?(@.productId==82541873)]");        // 步骤4: 断言响应结果，直接拷贝抓包响应结果作为断言。基本固定写法，不需要修改
