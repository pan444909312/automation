 ...
 * @author yancancan
 * @version 2.0
 * @since 2025/08/28 14:07:08
 */
@Scenario(
        scenarioID = "01K3Q8PENJH6VKBW5291X9S1P3", // 自动生成，不要修改
        scenarioName = "WEB站渠道：新账户注册失败（验证码错误）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("WEB站渠道：新账户注册失败（验证码错误）")
public class WebCheckCodeRegisterFailTests {
