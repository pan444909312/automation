...
@Scenario(
        scenarioID = "01K4A0ZXHDVGPTFZ1CBNT3J9SP",
        scenarioName = "商卡-商品信息-商品基本信息",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-商品基本信息")
public class product_baseinfo {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_baseinfo.json";
    @DisplayName("正向流程")
    @Test
