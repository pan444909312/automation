...
public class 搜索_检查搜索词在名称中间的店铺被召回 {
    ...
    void shouldReturnSuccessfully() {
        ...
        String newRequestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.keywords", "奶茶");
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("咖啡&奶茶小店")).isEqualTo(true);
