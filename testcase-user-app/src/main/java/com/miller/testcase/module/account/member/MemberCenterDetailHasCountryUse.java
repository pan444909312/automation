...
public class MemberCenterDetailHasCountryUse {
    ...
    void shouldReturnSuccessfully() {
        ...
        Object result1 = TestCaseHelpful.extractValue(responseBody, "$.result.memberCenterBenefitList[?(@.benefitType==10)]");
        Object result2 = TestCaseHelpful.extractValue(responseBody, "$.result.memberDetailBenefitDescList[?(@.benefitType==10)].name");

        TestCaseHelpful.assertThat(result1.toString()).isNotEqualTo("[]");
        TestCaseHelpful.assertThat(result2.toString()).isEqualTo("[\"全国通用\"]");
