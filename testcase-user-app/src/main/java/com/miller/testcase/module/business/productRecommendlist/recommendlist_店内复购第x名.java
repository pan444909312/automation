...
@Scenario(
        scenarioID = "01K797MS50X7HRNZCSWTQBWRVR",
        scenarioName = "商品详情推荐列表-商品标签：店内复购第x名",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品标签：店内复购第x名")
public class recommendlist_店内复购第x名 {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.recommendProductList[*].systemMarketingTags[*][?(@.tagType==2)]");
