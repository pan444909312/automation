 ...
 */
@Scenario(
        scenarioID = "01KJYETM4J56NBJT21G7D4TWKY", // 自动生成，不要修改
        scenarioName = "店铺流_红包适用商家列表_预售店铺_店铺-召回-美食城-预售店铺",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_红包适用商家列表_预售店铺_店铺-召回-美食城-预售店铺")
public class RedPacketFoodCourtPresale_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.redPacketGetShopVOByShopId("638845643", "19157826865", "123456a", testGroupNew, null, null, null, null, null, null, null);
        // 检查响应体不为空
