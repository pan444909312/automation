...
public class 搜索单个字_需要召回匹配到的相关店铺 {
    ...
    void shouldReturnSuccessfully() {
        ...
        TestCaseHelpful.assertThat(result2.toString().contains("包")).isEqualTo(true);
