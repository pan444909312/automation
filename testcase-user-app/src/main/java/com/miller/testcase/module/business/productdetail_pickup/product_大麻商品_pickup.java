...
@Scenario(
        scenarioID = "01KM75ERSKW85SPT945J9HAA23",
        scenarioName = "自取商品详情页-商品类型：大麻商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品类型：大麻商品")
public class product_大麻商品_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538087&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_大麻商品.json";
