...
@Scenario(
        scenarioID = "01KM740A0NSGG04Z8TEAMEGPFJ",
        scenarioName = "自取商品详情页-商品状态：上线",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品状态：上线")
public class product_上线_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_上线.json";
