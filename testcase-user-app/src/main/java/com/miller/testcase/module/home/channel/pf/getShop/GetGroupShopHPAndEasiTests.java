...
/**
 * 品类专题_店铺召回：店铺有效状态-站点-HP及EASI（HP APP）
 *
 * @author zhangpei
 * @version 2.0
 * @since
 */
@Scenario(
        scenarioID = "01KKB4KKJVGVE1SQA376F79EYH", // 自动生成，不要修改
        scenarioName = "品类专题_店铺召回：店铺有效状态-站点-HP及EASI（HP APP）",
        author = "zhangpei@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("品类专题_店铺召回：店铺有效状态-站点-HP及EASI（HP APP）")
public class GetGroupShopHPAndEasiTests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.channelPfGetShopVOByShopId(305457843,0,55,0, null, null, testGroupNew, null,null,null,null);
        // 检查响应体不为空
