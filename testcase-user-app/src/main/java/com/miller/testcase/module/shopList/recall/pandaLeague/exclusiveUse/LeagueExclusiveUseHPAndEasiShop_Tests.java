 ...
 * @author HuYang
 * @version 2.0
 * @since 2025/11/27 17:00:00
 */
@Scenario(
        scenarioID = "01KB4XKH2BR908KHSFEH004KQ6", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回：店铺有效状态-站点-HP及EASI（HP APP）",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回：店铺有效状态-站点-HP及EASI（HP APP）")
public class LeagueExclusiveUseHPAndEasiShop_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.pandaLeagueGetShopVOByShopId("305457843", "19157826865", "123456a", testGroupNew, null, null, "1", null, null, null, null, "1", "[{\n\"redPacketId\": 888896287,\n\"redPacketScopeType\": 2,\n\"userCdKeyId\": 1727087097493\n}]", null, null);
        // 检查响应体不为空
