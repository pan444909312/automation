...
@Scenario(
        scenarioID = "01K4PVWFP4P0P5NCMF85S0Y57Q",
        scenarioName = "商品详情页-商品类型：酒类商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-商品类型：酒类商品")
public class product_酒类商品 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538085&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
