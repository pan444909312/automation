 ...
 */
@Scenario(
        scenarioID = "01K99V405JEG96JMC7ND24PNN0", // 自动生成，不要修改
        scenarioName = "店铺流_红包适用商家列表_店铺-召回-配送围栏：围栏优先-未配置围栏且配置邮编-请求无邮编",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_红包适用商家列表_店铺-召回-配送围栏：围栏优先-未配置围栏且配置邮编-请求无邮编")
