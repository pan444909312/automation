...
@Scenario(
        scenarioID = "01K797J2EYMVD7PPYQKT0BC9R1",
        scenarioName = "商品详情推荐列表-商品标签：近期x人已下单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品标签：近期x人已下单")
public class recommendlist_近期x人已下单 {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.recommendProductList[*].systemMarketingTags[*][?(@.tagType==4)]");
