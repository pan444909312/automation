package com.miller.testcase.module.coverage.specialsCard;
 ...
 */
@Scenario(
        scenarioID = "01K1WK017D7V8SHKXDGH6DWX7N", // 自动生成，不要修改
        scenarioName = "首页专题卡片-首页推荐无数据",
        author = "panjuxiang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("首页专题卡片-首页推荐无数据")
public class SpecialsCardRecommendHasNoData {
    ...
    String assert1 = "module/activity/specialsCard/response/assert_full_field2.json";

    @DisplayName("正向流程")
    @Test
    void shouldSuccess() {
        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("UPDATE module_activity_card set card_state = 0 WHERE id = 147");
