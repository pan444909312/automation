 ...
 */
@Scenario(
        scenarioID = "01K32N37CVCB1SKMNFVP4Y0WZ5", // 自动生成，不要修改
        scenarioName = "店铺流_召回_首页_店铺-召回-店铺在店铺限制数量范围内",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_召回_首页_店铺-召回-店铺在店铺限制数量范围内")
public class RedPacketWithinMaxMapRadius_Tests {
