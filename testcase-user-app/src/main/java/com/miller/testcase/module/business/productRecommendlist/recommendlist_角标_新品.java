...
@Scenario(
        scenarioID = "01K795S42GSRE9PXTKFVF5XYY9",
        scenarioName = "商品详情推荐列表-角标：新品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-角标：新品")
public class recommendlist_角标_新品 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_角标-新品.json";
