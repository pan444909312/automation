...
@Scenario(
        scenarioID = "01K4PTV6MC11QH8XMWK5W3Z57Q",
        scenarioName = "商品详情页-限售商品",
...
public class product_限售 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82491370&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
