...
@Scenario(
        scenarioID = "01KM75EFB33Z58Y7385MPFD2G7",
        scenarioName = "自取商品详情页-商品标签：商品营销标签",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品标签：商品营销标签")
public class product_商品营销标签_pickup {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.productDetail.systemMarketingTags[*][?(@.tagType==6)]");
