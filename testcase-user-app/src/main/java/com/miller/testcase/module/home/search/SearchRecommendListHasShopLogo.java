...
@Scenario(scenarioID = "01K21XRAFVCWV3SQBGAAJA6H6K",
        scenarioName = "搜索无结果页推荐列表-店铺logo展示成功",
...
public class SearchRecommendListHasShopLogo {
    ...
    void shouldReturnSuccessfully() {
        ...
        Object logo = TestCaseHelpful.extractValue(responseBody, "$.result.shopList[0].shopLogo");
        TestCaseHelpful.assertThat(logo).isNotNull();
