...
@Scenario(
        scenarioID = "01JZSN6GRQY72ACT42WDYABQ3W",
        scenarioName = "店铺NFC信息接口",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("店铺NFC信息接口")
public class nfcinfo {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/app/user/shop/nfc/info";
    // 请求方式
    String method = "POST";
    // 请求头
    ...
    // 断言
    String assert2 = "module/home/shop/response/nfcInfoResp.json";
