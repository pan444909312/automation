...
@Scenario(
        scenarioID = "01JWSS1KB2H2X5WV4YW6GE43GF",
...
@DisplayName("品类专题-店铺召回：店铺营业状态-打烊可预约")
public class GetGroupShopPreOrderCloseSupportTests {

    @DisplayName("品类专题-店铺召回：店铺营业状态-打烊可预约")
    @Test
    void shouldReturnSuccessfully() {
        var responseShopBody = TestCaseHelpful.channelPfGetShopVOByShopId(786901653,0,55,0, null, null, null, null,null,null,null);
        // 检查响应体不为空
