package com.miller.testcase.module.account.login.fetch_redpacket_register_combine_login;
 ...
 */
@Scenario(
        scenarioID = "01K3QN8RJ7VWTN1Q1CB4V3VFWD", // 自动生成，不要修改
        scenarioName = "拼手气渠道：新用户注册失败（错误验证码）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("拼手气渠道：新用户注册失败（错误验证码）")
public class FetchRedpacketRegisterCheckCodeLoginFailTests {
