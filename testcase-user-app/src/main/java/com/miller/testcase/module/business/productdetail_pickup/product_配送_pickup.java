...
@Scenario(
        scenarioID = "01KM75QMZ6RZP7TGN4EQ7SG561",
        scenarioName = "自取商品详情页-商品取货方式：配送",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品取货方式：配送")
public class product_配送_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82542042&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_配送_不支持的取货方式.json";
