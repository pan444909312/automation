...
public class MemberCenterDetailHasDeliveryCoupon {
    ...
    void shouldReturnSuccessfully() {
        ...
        Object result1 = TestCaseHelpful.extractValue(responseBody, "$.result.memberCenterBenefitList[?(@.benefitType==2)]");
        Object result2 = TestCaseHelpful.extractValue(responseBody, "$.result.memberDetailBenefitDescList[?(@.benefitType==2)].name");

        TestCaseHelpful.assertThat(result1.toString()).isNotEqualTo("[]");
        TestCaseHelpful.assertThat(result2.toString()).isEqualTo("[\"运费券\"]");
