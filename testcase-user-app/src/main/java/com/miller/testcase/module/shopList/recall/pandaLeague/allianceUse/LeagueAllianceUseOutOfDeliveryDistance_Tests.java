 ...
 */
@Scenario(
        scenarioID = "01KCGT6FW7G0Q9T5GVYW04Z23H", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀通享商家【去使用】_店铺-召回-配送范围：配送最大距离<店铺距用户距离 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀通享商家【去使用】_店铺-召回-配送范围：配送最大距离<店铺距用户距离 - 不召回")
public class LeagueAllianceUseOutOfDeliveryDistance_Tests {
