 ...
 */
@Scenario(
        scenarioID = "01K3Q9H07VV5E83BRSFAA4EXVN", // 自动生成，不要修改
        scenarioName = "微信小程序渠道：老用户登录失败（验证码区号不匹配）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("微信小程序渠道：老用户登录失败（验证码区号不匹配）")
public class WXAreaCodeLoginFailTests {
