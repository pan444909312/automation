...
@Scenario(scenarioID = "01JVKR6DPZH7V8WK4B381AMV6K",
        scenarioName = "其他人在搜获取成功",
...
public class SearchOtherPeopleSuccess {
    ...
    void shouldReturnSuccessfully() {
        ...
        String requestBody = TestCaseHelpful.getJsonRequestBody("module/home/search/request/SearchOtherPeopleReq.json");
        String responseBody = TestCaseHelpful.sendRequest("POST", uri, null, headers, requestBody);
        String expectedStr = TestCaseHelpful.getFileContent("module/home/search/response/SearchOtherPeopleResp.json");
