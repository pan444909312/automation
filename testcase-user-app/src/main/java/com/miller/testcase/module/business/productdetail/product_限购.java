...
@Scenario(
        scenarioID = "01K4PV026Y0T9RAYKX0FXG57A1",
        scenarioName = "商品详情页-限购商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-限售商品")
public class product_限购 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82541874&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
