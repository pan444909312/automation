package com.miller.testcase.module.activity.popup.user_popup_force_plan_auto;
...
/**
 * user popup force plan auto
 *
 * @author yancancan
 * @version 2.0
 * @since 2025/08/05 18:28:10
 */
@Scenario(
...
public class UserPopupForcePlanAutoTests {
    ...
    @Test
    void shouldSuccess() {
        int cdkey_numbers = PandaTestDBHelpful.executeSelectListSql("select * from user_cdkey where user_id='1398718113' and red_packet_id=\"888895445\"\n").size();
        // TestcaseConfig.HOST 是接口的请求域名。 后面的 + "是接口的请求路径"
        String uri = TestcaseConfig.HOST_APP + "/api/user/popup";
        // 接口请求方式。如： GET、POST、PUT、DELETE
        String method = "GET";
        // 请求头。默认从 resources 目录下读取文件。
        String headers = "module/activity/popup/user_popup_force_plan_auto/request/headers.json";
        // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
        String params = "module/activity/popup/user_popup_force_plan_auto/request/params.json";
...
//        var requestBody = TestCaseHelpful.getJsonRequestBody(body);
        ...
        int cdkey_numbers_new = PandaTestDBHelpful.executeSelectListSql("select * from user_cdkey where user_id='1398718113' and red_packet_id=\"888895445\"\n").size();
        TestCaseHelpful.assertThat(cdkey_numbers_new).isEqualTo(cdkey_numbers+1);
