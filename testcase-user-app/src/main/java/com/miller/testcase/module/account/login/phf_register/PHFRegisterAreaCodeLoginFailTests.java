 ...
 */
@Scenario(
        scenarioID = "01K44ZS48P28JD0W0B0N9JYD4V", // 自动生成，不要修改
        scenarioName = "小程序-拼好饭/奶茶渠道：新账户注册失败（验证码区号不匹配）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("小程序-拼好饭/奶茶渠道：新账户注册失败（验证码区号不匹配）")
public class PHFRegisterAreaCodeLoginFailTests {
