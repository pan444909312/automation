...
@Scenario(
        scenarioID = "01KM75CT1CDSS1Y182XZ43E4KR",
        scenarioName = "自取商品详情页-不参与个性化推荐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-不参与个性化推荐商品")
public class product_不参与推荐_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82541873&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_不参与推荐.json";
