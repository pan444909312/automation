package com.miller.testcase.module.home.search.chinese.regression_testing.搜索_普通搜索_多个店铺_商品;
...
//         MerchantFactory.quickCreateMerchant(MerchantFactory.City.JIUJIANG, "搜索自动化店铺1");
//         MerchantFactory.quickCreateMerchant(MerchantFactory.City.JIUJIANG, "搜索自动化店铺2");
...
//        XXLJobUtils.triggerJob("298");
    ...
    void afterAll() {
        ...
        // 删除 店铺，先打烊
        // MerchantFactory.closedMerchant("搜索自动化店铺1");
        // MerchantFactory.deleteMerchant("搜索自动化店铺1");
        // MerchantFactory.closedMerchant("搜索自动化店铺2");
        // MerchantFactory.deleteMerchant("搜索自动化店铺2");
    }
    ...
    void shouldSuccess() {
        ...
        String headers = "module/home/search/chinese/regression_testing/搜索_普通搜索_多个店铺_商品/request/headers.json";
        // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
        String params = null;
        // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
        String body = "module/home/search/chinese/regression_testing/搜索_普通搜索_多个店铺_商品/request/body.json";
        // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
        String assertFullField = "module/home/search/chinese/regression_testing/搜索_普通搜索_多个店铺_商品/response/assert_full_field.json";
        ...
        // 断言数组中包含指定的店铺名称
        boolean containsExpectedShop1 = shopNames.stream().anyMatch(name -> name.contains("搜索自动化店铺1"));
        boolean containsExpectedShop2 = shopNames.stream().anyMatch(name -> name.contains("搜索自动化店铺2"));
