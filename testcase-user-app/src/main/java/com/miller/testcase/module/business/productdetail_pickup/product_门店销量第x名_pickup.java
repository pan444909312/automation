...
@Scenario(
        scenarioID = "01KM7608K7JC1ZCQ1ETP35F6WG",
        scenarioName = "自取商品详情页-商品标签：门店销量第x名",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品标签：门店销量第x名")
public class product_门店销量第x名_pickup {
    // 接口请求的 path
    ...
    public void getMenuListSuccessfully() {
        ...
        Object result = TestCaseHelpful.extractValue(responseBody,"$.result.productDetail.systemMarketingTags[*][?(@.tagType==1)]");
