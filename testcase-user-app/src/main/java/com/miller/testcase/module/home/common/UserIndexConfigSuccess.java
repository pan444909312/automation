...
public class UserIndexConfigSuccess {
    ...
    void shouldReturnSuccessfully() {
        ...
        String requestBody = TestCaseHelpful.getJsonRequestBody("module/home/common/request/UserIndexConfigReq.json");
        String responseBody = TestCaseHelpful.sendRequest("POST", uri, null, headers, requestBody);
        String expectedStr = TestCaseHelpful.getFileContent("module/home/common/response/UserIndexConfigResp.json");
