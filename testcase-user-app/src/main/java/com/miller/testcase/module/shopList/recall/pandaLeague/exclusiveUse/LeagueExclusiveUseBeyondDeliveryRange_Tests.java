 ...
 * @author HuYang
 * @version 2.0
 * @since 2025/11/27 10:30:00
 */
@Scenario(
        scenarioID = "01KB4XKH2AQVSXT7CJR4H29F0P", // 自动生成，不要修改
        scenarioName = "店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回：可视距离<店铺距用户距离 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀专享商家【去使用】_店铺-召回：可视距离<店铺距用户距离 - 不召回")
public class LeagueExclusiveUseBeyondDeliveryRange_Tests {
