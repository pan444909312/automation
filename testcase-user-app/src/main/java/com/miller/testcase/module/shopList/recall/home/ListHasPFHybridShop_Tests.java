package com.miller.testcase.module.shopList.recall.home;

import com.miller.service.framework.annotation.Scenario;
import com.miller.service.util.XXLConfUtils;
import com.miller.testcase.module.business.search.搜索_普通搜索_多个店铺_商品_Tests;
 ...
 */
@Scenario(
        scenarioID = "01K49W5YRSZR21306XQMZVR56C", // 自动生成，不要修改
...
public class ListHasPFHybridShop_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.getShopVOByShopId("360757058", "19157826865", "123456a", testGroupNew, "120.58611","29.99576", null);
        // 检查响应体不为空
