...
@Scenario(
        scenarioID = "01K4PVFYZ3C1QTYBQB47GZ5QVY",
        scenarioName = "商品详情页-角标：火爆",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情页-角标：火爆")
public class product_角标_火爆 {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82538083&deliveryType=1";
    // 请求方式
    String method = "GET";
    // 请求头
