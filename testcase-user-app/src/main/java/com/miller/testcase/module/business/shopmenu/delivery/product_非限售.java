...
@Scenario(
        scenarioID = "01K4AE95YZ10BW42GY4S05GJ0J",
        scenarioName = "商卡-商品信息-非限售商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-非限售商品")
public class product_非限售 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_非限售.json";
    @DisplayName("正向流程")
    @Test
