package com.miller.testcase.module.web_edit_address;
 ...
 * @author 单东东
 * @version 2.0
 * @since 2025/06/12 18:09:44
 */
@Scenario(
        scenarioID = "01JXHSVVQ4DFTTMH96TRYXFZE9", // 自动生成，不要修改
        scenarioName = "web edit address",
...
public class Web_Edit_Address_Tests {
    ...
    String body = "module/web_edit_address/request/should_success.json";
    // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
    String assert1 = "module/web_edit_address/response/assert_full_field.json";
