...
@Scenario(
        scenarioID = "01JXCP30RXGQPG2Q6QVRVXBNFY",
        scenarioName = "地址详情_Web站",
...
public class AddressDetailsTests {
    ...
    String body = "module/account/address/request/AddressDetailsReq.json";
    // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 paras 参数
    String params = "module/account/address/request/AddressDetailsParamsReq.json";
    // 断言
    String assert1 = "module/account/address/response/AddressDetailsResp.json";
