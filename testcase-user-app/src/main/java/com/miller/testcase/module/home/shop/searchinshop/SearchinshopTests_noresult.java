 ...
 */
@Scenario(
        scenarioID = "01K1WQC1G24CB30GM4B0P5QW4A", // 自动生成，不要修改
        scenarioName = "店铺内搜索-无结果",
        author = "yaoqianhu@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 25, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺内搜索-无结果")
public class SearchinshopTests_noresult {
    ...
    String params = "module/home/shop/searchinshop/request/params_noresult.json";
    // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求可能没有请求体。作用同请求头
    String body = null;
    // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
    String assert1 = "module/home/shop/searchinshop/response/assert_full_field_noresult.json";
