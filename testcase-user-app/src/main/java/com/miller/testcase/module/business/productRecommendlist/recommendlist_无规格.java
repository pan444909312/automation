...
@Scenario(
        scenarioID = "01K794HYEH0B7J9RRZ3ZXVY3D5",
        scenarioName = "商品详情推荐列表-无规格",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-无规格")
public class recommendlist_无规格 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_无规格.json";
