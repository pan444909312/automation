 ...
 */
@Scenario(
        scenarioID = "01K805N6FCC8FY752P73FZHX3G", // 自动生成，不要修改
        scenarioName = "查看外卖店铺评论展示-最新",
        author = "yaoqianhu@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("查看外卖店铺评论展示-最新")
public class 查看外卖店铺评论展示_最新_Tests {
    ...
    void shouldSuccess() {
        ...
        String params = "module/business/shopevaluate/查看外卖店铺评论展示_最新/request/params.json";
