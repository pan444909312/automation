...
@Scenario(scenarioID = "01K73SN2QDMV9HMNPZM9M3XJ6Y",
        scenarioName = "搜索_检查左匹配的商品所在的店铺被召回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("/api/user/v2/search")
public class 搜索_检查左匹配的商品所在的店铺被召回 {
    private static final String uri = TestcaseConfig.HOST_APP + "/api/user/v2/search";

    private String shopId = "208586771";
    private String productId = "82551721";

    @DisplayName("搜索_检查左匹配的商品所在的店铺被召回")
    @Test
