 ...
 */
@Scenario(
        scenarioID = "01K2EV1H66Q3078JJPZ3QM5CXJ", // 自动生成，不要修改
        scenarioName = "中文版_店铺流_召回_首页_店铺-召回：店铺有效状态-站点-HP（PF APP）",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("中文版_店铺流_召回_首页_店铺-店铺-召回：店铺有效状态-站点-HP（PF APP）")
public class HPShopSitePF_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.getShopVOByShopId("875457817", "19157826865", "123456a", testGroupNew, null,null, "20");
        // 检查响应体不为空
