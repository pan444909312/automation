 ...
 */
@Scenario(
        scenarioID = "01K38VJ4C49N5H0PJ4N58N0Y9A", // 自动生成，不要修改
        scenarioName = "会员购买页-有全国通用",
...
//        headers.put("Authorization", TestCaseHelpful.login("13999900002", "123456"));
        ...
        Object result = TestCaseHelpful.extractValue(responseBody, "$.result.memberBenefitlList[?(@.benefitType==10)]");
