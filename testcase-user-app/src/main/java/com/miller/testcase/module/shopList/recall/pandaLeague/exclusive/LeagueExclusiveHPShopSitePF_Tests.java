...
@Scenario(
        ...
        scenarioName = "店铺流_红包适用商家列表_店铺-召回：店铺有效状态-站点-HP（PF APP）",
...
public class LeagueExclusiveHPShopSitePF_Tests {
...
//        需要修改实验时，传入新的全量实验
        ...
        var responseShopBody = TestCaseHelpful.pandaLeagueGetShopVOByShopId("875457817", "19157826865", "123456a", testGroupNew, null, null, "20", null, null, null, null, null, null, null, null);
        // 检查响应体不为空
