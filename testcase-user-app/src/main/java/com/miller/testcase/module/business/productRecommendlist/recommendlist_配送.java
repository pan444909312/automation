...
@Scenario(
        scenarioID = "01K7995DVE5S7HCMM0VGJM643N",
        scenarioName = "商品详情推荐列表-商品取货方式：配送",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-商品取货方式：配送")
public class recommendlist_配送 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_配送.json";
