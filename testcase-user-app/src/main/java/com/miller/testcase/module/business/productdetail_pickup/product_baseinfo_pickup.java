...
@Scenario(
        scenarioID = "01KM73ZBHJS15Z4Z9F31GASNPP",
        scenarioName = "自取商品详情页-商品基本信息",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-商品基本信息")
public class product_baseinfo_pickup {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/response/ProductBaseInfolResp.json";
