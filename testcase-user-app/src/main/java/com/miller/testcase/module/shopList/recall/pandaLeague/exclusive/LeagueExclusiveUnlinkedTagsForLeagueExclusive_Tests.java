...
@Scenario(
        ...
        scenarioName = "店铺流_熊猫联盟频道-膨胀专享商家_店铺-召回：配置未关联标签的店铺 - 不召回",
        author = "huyang@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("店铺流_熊猫联盟频道-膨胀专享商家_店铺-召回：配置未关联标签的店铺 - 不召回")
public class LeagueExclusiveUnlinkedTagsForLeagueExclusive_Tests {
