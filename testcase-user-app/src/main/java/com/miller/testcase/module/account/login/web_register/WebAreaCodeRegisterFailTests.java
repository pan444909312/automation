 ...
 */
@Scenario(
        scenarioID = "01K3Q89KEFNTADZFMWMCKEWMNR", // 自动生成，不要修改
        scenarioName = "WEB站渠道：新账户注册失败（验证码区号不匹配）",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("WEB站渠道：新账户注册失败（验证码区号不匹配）")
public class WebAreaCodeRegisterFailTests {
