 ...
 * @author yancancan
 * @version 2.0
 * @since 2025/06/17 11:07:35
 */
@Scenario(
        scenarioID = "01JXXXPFADRZ5QDMWW412SNJX1", // 自动生成，不要修改
        scenarioName = "关闭特殊任务成功",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("关闭特殊任务成功")
public class SpecialTaskCloseTests {
    // TestcaseConfig.HOST 是接口的请求域名。 后面的 + "是接口的请求路径"
    String uri = TestcaseConfig.HOST_APP + "/api/app/user/task/close";
    ...
    public static void beforeAll(){
        //领取特殊任务
        new SpecialTaskReceiveTests().shouldSuccess();
    }
    @DisplayName("正向流程:关闭特殊任务")
    @Test
    void shouldSuccess() {
    ...
    public static void afterAll(){
        ...
        PandaTestDBHelpful.executeInsertOrUpdateOrDelete("delete from hp_task_center_special_close   where is_del=0\n");
    }
} 