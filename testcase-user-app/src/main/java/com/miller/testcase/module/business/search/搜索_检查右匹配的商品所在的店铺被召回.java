...
@Scenario(scenarioID = "01K73T5TVDGX8NN041S6CJPE7Q",
        scenarioName = "搜索_检查右匹配的商品所在的店铺被召回",
        author = "panjuxiang@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("/api/user/v2/search")
public class 搜索_检查右匹配的商品所在的店铺被召回 {
    private static final String uri = TestcaseConfig.HOST_APP + "/api/user/v2/search";

    private String shopId = "151015504";
    private String productId = "82552228";

    @DisplayName("搜索_检查右匹配的商品所在的店铺被召回")
    @Test
