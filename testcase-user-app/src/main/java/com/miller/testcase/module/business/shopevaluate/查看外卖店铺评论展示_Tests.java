 ...
 * @author yaoqianhu
 * @version 2.0
 * @since 2025/10/20 11:24:50
 */
@Scenario(
        scenarioID = "01K7ZTBWB1DC0FVQVC8R22JQEY", // 自动生成，不要修改
        scenarioName = "查看外卖店铺评论展示",
        author = "yaoqianhu@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("查看外卖店铺评论展示")
public class 查看外卖店铺评论展示_Tests {
    ...
    void shouldSuccess() {
        ...
        String params = "module/business/shopevaluate/查看外卖店铺评论展示/request/params.json";
