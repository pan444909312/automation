...
@Scenario(
        scenarioID = "01K795S4SHZFTPS3HPNWFP5XNT",
        scenarioName = "商品详情推荐列表-角标：火爆",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商品详情推荐列表-角标：火爆")
public class recommendlist_角标_火爆 {
    // 接口请求的 path
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/recommendlist_角标-火爆.json";
