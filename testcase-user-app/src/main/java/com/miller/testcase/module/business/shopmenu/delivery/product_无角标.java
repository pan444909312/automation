...
@Scenario(
        scenarioID = "01K4BW57SX9294QV2QPKKAQ2DS",
        scenarioName = "商卡-商品信息-角标：无角标",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("商卡-商品信息-角标：无角标")
public class product_无角标 {
    // 接口请求的 path
    ...
    String assert1 = "module/home/shop/response/product_无角标.json";
    @DisplayName("正向流程")
    @Test
