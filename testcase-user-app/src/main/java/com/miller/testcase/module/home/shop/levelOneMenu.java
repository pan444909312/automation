...
@Scenario(
        scenarioID = "01K10F199CTJJT1HPSY4AWH5QM",
        scenarioName = "超市店铺一级菜单",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("超市店铺一级菜单")
public class levelOneMenu {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/app/user/shop/levelOneMenu";
    // 请求方式
    String method = "POST";
    // 请求头
    String headers = "module/headers.json";
    // 请求体。如果没有传 null 即可（body = null）。比如 GET 请求
    String body = "module/home/shop/request/levelOneMenuReq.json";
    // 断言
    String assert2 = "module/home/shop/response/levelOneMenuResp.json";
