...
@Scenario(
        scenarioID = "01KM75HC2MVS94DEFMFGMM67EY",
        scenarioName = "自取商品详情页-是套餐商品",
        author = "yaoqianhu@hungrypandagroup.com",
        developmentTime = 15, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("自取商品详情页-是套餐商品")
public class product_是套餐_pickup {
    // 接口请求的 path
    String uri = TestcaseConfig.HOST_APP + "/api/user/v1/product/detail?productId=82457768&deliveryType=2";
    // 请求方式
    String method = "GET";
    // 请求头
    ...
    String body = null;
    // 断言
    String assert1 = "module/home/shop/productDetail/product_是套餐.json";
