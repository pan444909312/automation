 ...
 * @author yancancan
 * @version 2.0
 * @since 2025/06/30 18:21:48
 */
@Scenario(
        scenarioID = "01JZ05PWTB973GSQ607X65516E", // 自动生成，不要修改
        scenarioName = "en shoplist v1",
        author = "yancancan@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 3)
@DisplayName("en shoplist v1")
public class En_Shoplist_V1_Tests {
    ...
    void shouldSuccess() {
        ...
        String headers = "module/home/en_shoplist_v1/request/headers.json";
