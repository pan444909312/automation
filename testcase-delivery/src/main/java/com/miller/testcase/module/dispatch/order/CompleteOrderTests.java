 ...
 */
@Scenario(
        scenarioID = "01JPPF4JST68ZG9FP01HCKB7RS", // 自动生成，不要修改
        scenarioName = "调度系统-订单列表-获取已完成列表",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取已完成订单列表")
public class CompleteOrderTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/order/completeOrder";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/order/completeOrder/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/completeOrder/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/completeOrder/request/body.json");
