 ...
 */
@Scenario(
        scenarioID = "01JPPF2Q1SAS27G81TDDTMH2SY", // 自动生成，不要修改
        scenarioName = "调度系统-订单列表-获取预派单池",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取预派单池")
public class AdvanceOrderPackageTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/advance/order/package";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/order/advanceOrderPackage/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/advanceOrderPackage/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/advanceOrderPackage/request/body.json");
