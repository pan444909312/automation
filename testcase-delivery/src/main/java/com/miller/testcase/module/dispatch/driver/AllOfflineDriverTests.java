 ...
 */
@Scenario(
        scenarioID = "01JPPFJM3GD45A16F11TX1V0PH", // 自动生成，不要修改
        scenarioName = "【主干用例】调度系统-骑手列表-获取所有下线骑手",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取所有下线骑手")
public class AllOfflineDriverTests {
    String assertFullField = "module/dispatch/driver/allOffline/response/assert_full_field.json";

    @DisplayName("获取下线骑手总数")
    @Test
    void shouldGetOfflineDriverCount() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/driver/allOffline/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/allOffline/request/count_body.json");
        ...
        requestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.pageSize", 0);
    ...
    @DisplayName("获取下线骑手列表")
    @Test
    void shouldGetOfflineDriverList() {
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/driver/offlineDriverList";
        String method = "POST";
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/allOffline/request/list_body.json");
