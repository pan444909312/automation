 ...
 */
@Scenario(
        scenarioID = "01JPPF11FW47KT33QWSQAKTH0V", // 自动生成，不要修改
        scenarioName = "调度系统-获取基础信息-获取公告",
...
public class AnnouncementQueryTests {
    ...
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/driver/announcement/queryOneByCityName";
    // 接口请求方式。如： GET、POST、PUT、DELETE
    String method = "POST";
    // 请求参数。如果没有传 null 即可（params = null）。比如 POST 请求通常没有 params 参数
    String params = null;
    // 断言。默认从resources目录下读取文件。下面的代码表示从 resource 的 module/xxx/response/assert_full_field.json 读取文件内容作为断言
    String assertFullField = "module/dispatch/driver/announcement/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/driver/announcement/request/headers.json");
        // 设置请求头参数
        ...
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/announcement/request/body.json");
        // 更新请求体中的动态参数
