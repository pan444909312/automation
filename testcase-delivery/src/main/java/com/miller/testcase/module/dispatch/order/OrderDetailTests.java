 ...
 */
@Scenario(
        scenarioID = "01JPPFBAKMM5FG9P1T1PXHHYM9", // 自动生成，不要修改
        scenarioName = "调度系统-订单列表-订单详情页",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("订单详情")
public class OrderDetailTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/order/orderDetail";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/order/orderDetail/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/orderDetail/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/orderDetail/request/body.json");
