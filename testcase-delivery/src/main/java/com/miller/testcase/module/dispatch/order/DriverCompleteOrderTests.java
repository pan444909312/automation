 ...
 */
@Scenario(
        scenarioID = "01JPPF9A66SCCPNN5920CZ1GQQ", // 自动生成，不要修改
        scenarioName = "调度系统-订单列表-骑手已完成订单列表",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("单个骑手已完成订单列表")
public class DriverCompleteOrderTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/order/driverCompleteOrder";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/order/driverCompleteOrder/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/driverCompleteOrder/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/driverCompleteOrder/request/body.json");
