 ...
 */
@Scenario(
        scenarioID = "01KE6218M9M5GSZ2GFMXR7850T", // 自动生成，不要修改
        scenarioName = "预约排班-详情",
...
public class SchedulingDetailInfoTests {
    ...
    String assertFullField = "module/delivery/capacityScheduling/response/assert_full_field.json";
