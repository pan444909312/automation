package com.miller.testcase.module.dispatch.driver;
 ...
 */
@Scenario(
        scenarioID = "01JPPFNBW6NX9TT0SJZPWHAB97", // 自动生成，不要修改
        scenarioName = "【主干用例】调度系统-骑手列表-获取仅接hp的骑手",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取仅接HP骑手")
public class HpOnlyDriverTests {
    String assertFullField = "module/dispatch/driver/hpOnly/response/assert_full_field.json";

    @DisplayName("仅接HP-在线骑手")
    @Test
    void shouldGetHpOnlyOnlineDrivers() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/driver/hpOnly/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/hpOnly/request/online_body.json");
        ...
        JSONArray driverBusinessTypeList = new JSONArray();
        driverBusinessTypeList.add(0);
        requestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.driverBusinessTypeList", driverBusinessTypeList);
    ...
    @DisplayName("仅接HP-下线骑手")
    @Test
    void shouldGetHpOnlyOfflineDrivers() {
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/driver/offlineDriverList";
        String method = "POST";
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/hpOnly/request/offline_body.json");
        ...
        requestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.pageSize", 20);
