 ...
 */
@Scenario(
        scenarioID = "01JPPF6YEZ4C7P2GJQ38P6EJ8H", // 自动生成，不要修改
        scenarioName = "调度系统-订单列表-未完成订单列表",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取未完成订单列表")
public class UnCompleteOrderTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/order/unCompleteOrder";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/order/unCompleteOrder/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/unCompleteOrder/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/unCompleteOrder/request/body.json");
