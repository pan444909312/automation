 ...
 */
@Scenario(
        scenarioID = "01JPPFMWDFYY4X7HRNKVP6YNMR", // 自动生成，不要修改
        scenarioName = "【主干用例】调度系统-骑手列表-获取仅接pf骑手",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取仅接PF骑手")
public class PfOnlyDriverTests {
    String assertFullField = "module/dispatch/driver/pfOnly/response/assert_full_field.json";

    @DisplayName("仅接PF-在线骑手")
    @Test
    void shouldGetPfOnlyOnlineDrivers() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/driver/pfOnly/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/pfOnly/request/online_body.json");
    ...
    @DisplayName("仅接PF-下线骑手")
    @Test
    void shouldGetPfOnlyOfflineDrivers() {
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/driver/pfOnly/request/offline_body.json");
