package com.miller.testcase.module.dispatch.order;
 ...
 */
@Scenario(
        scenarioID = "01JPPFA3Y5271VNR6M8SC5C4TR", // 自动生成，不要修改
        scenarioName = "调度系统-订单列表-骑手未完成订单列表",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("单个骑手未完成订单列表")
public class DriverUnCompleteOrderTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/order/driverUnCompleteOrder";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/order/driverUnCompleteOrder/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/driverUnCompleteOrder/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/driverUnCompleteOrder/request/body.json");
