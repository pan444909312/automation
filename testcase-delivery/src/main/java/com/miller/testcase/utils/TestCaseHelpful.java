...
//                body = JSONUtils.parseObject(body.toString()).toJavaObject(Map.class);
     ...
     * @return token
     */
    public static String deliveryLogin(String mobilePhone, String password) {
        password = MD5Util.string2MD5(password);
    ...
    public static Integer getVerificationCode(String tel) {
        ...
        String uri = TestcaseConfig.HOST_USER_APP + "/api/app/user/sendVerificationCode";
    ...
    public static JSONObject getShopVOByShopId(String shopId, String mobilePhone, String password, String testgroup, String longitude, String latitude, String apptypeid) {
        String uri = TestcaseConfig.HOST_USER_APP + "/api/user/v2/index/shopList";
        String method = "POST";
    ...
    public static JSONObject categoryGetShopVOByShopId(String shopId, String mobilePhone, String password, String testgroup, String longitude, String latitude, String apptypeid, String language, Integer isNeedMarketCategory, Integer marketCategoryId, String zipcode) {
        String uri = TestcaseConfig.HOST_USER_APP + "/api/app/user/category/channel";
        String method = "POST";
    ...
    public static String searchGetShopVOByShopId(String shopId, String requestBody, Map<String, Object> headers, String testgroup, String longitude, String latitude, String apptypeid) {
        String uri = TestcaseConfig.HOST_USER_APP + "/api/user/v2/search";
        String method = "POST";
    ...
    public static JSONObject redPacketGetShopVOByShopId(String shopId, String mobilePhone, String password, String testgroup, String longitude, String latitude, String apptypeid, String language, String cityName, String shopCategoryIds, String zipcode) {
        String uri = TestcaseConfig.HOST_USER_APP + "/api/user/redPacket/shopList/v1";
        String method = "POST";
	...
	public static JSONObject pandaLeagueGetShopVOByShopId(String shopId, String mobilePhone, String password, String testgroup, String longitude, String latitude, String apptypeid, String language, String cityName, String filtering, String filters, String isUse, String redPacketList, String tabType, String zipcode) {
        String uri = TestcaseConfig.HOST_USER_APP + "/api/app/user/panda/league/channel";
        String method = "POST";
