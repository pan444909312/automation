 ...
 */
@Scenario(
        scenarioID = "01KK1ACK2BH6XJDCSV447FWGQ2",
        scenarioName = "新调度-订单其他可用骑手列表",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-订单其他可用骑手列表")
public class OtherDriverList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryDriver/otherList";
        String method = "POST";
