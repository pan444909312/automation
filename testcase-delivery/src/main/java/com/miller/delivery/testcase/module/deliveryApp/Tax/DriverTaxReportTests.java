...
@DisplayName("获取骑手报税详情")
public class DriverTaxReportTests {

    @DisplayName("获取骑手报税详情")
    @Test
    void shouldGetDriverTaxDetail() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 获取骑手报税详情
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/tax/detail";
        String method = "POST";
