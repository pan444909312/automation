 ...
 */
@Scenario(
        scenarioID = "01KGS55DQCQM94MCND3RDFB0N6",
        scenarioName = "删除补贴调整配置",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("删除补贴调整配置")
public class SubsidyDeleteTests {
    ...
    public void delete(String token,String id) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/subsidyAdjust/delConfig";
        String method = "POST";
