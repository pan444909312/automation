...
@Scenario(
        scenarioID = "01JPSSBXXN6CZGKEYZDE8865CA",
        scenarioName = "司管后台-订单管理-顺路度设置-查看",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("顺路度设置查看")
public class SameRoadConfigDetailTests {

    @DisplayName("查看顺路度设置详情")
    @Test
    void shouldGetSameRoadConfigDetail() {
        // 1) 司管登录获取 token
        ...
        // 3) 查看详情
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/delivery/same/road/config/detail";
        String method = "POST";
        Map<String, Object> headers = createHeaders(token);
        String body = String.format("{\"configId\":%d}", sameRoadConfigId);
