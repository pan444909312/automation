...
@Scenario(
        scenarioID = "01KDQHDKJSV4VXEQC3HBCMES4Y",
        scenarioName = "司管_PF基础定价_修改指定站点PF定价_不区分载具+时段+群组",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("修改指定站点PF定价_不区分载具+时段+群组")
public class PfPriceRuleSiteUpdateSimpleTests {
    ...
    @DisplayName("修改指定站点PF定价_不区分载具+时段+群组")
    @Test
    void shouldUpdatePfPriceRuleSiteSimple() {
        // 1) 司管登录获取 token
