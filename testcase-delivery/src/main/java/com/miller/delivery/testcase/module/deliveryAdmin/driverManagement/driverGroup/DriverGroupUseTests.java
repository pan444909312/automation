 ...
 */
@Scenario(
        scenarioID = "01KGRXGEE3V5Y6NKA353GNEC9P",
        scenarioName = "查看群组应用",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("查看群组应用")
public class DriverGroupUseTests {
    ...
    public void delete(String token, int groupId) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/driverGroup/driverGroupUseFor";
        String method = "POST";
