package com.miller.delivery.testcase.module.deliveryApp.routing;
 ...
 */
@Scenario(
        scenarioID = "01JPP6JZKVFDP69QAFDSE85G8H",
        scenarioName = "骑手app-登录后默认请求的接口-路径规划引导",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("路径规划引导")
public class NavigationGuideInfoTests {

    @DisplayName("路径规划引导")
    @Test
    void shouldGetNavigationGuideInfo() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 路径规划引导
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/navigation/guideInfo";
        String method = "POST";
    ...
    @Test
    void shouldGetNavigationGuideInfoWithoutLogin() {
        // 路径规划引导-未登录（异常case）
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/navigation/guideInfo";
        String method = "POST";
        Map<String, Object> headers = createDriverAppHeaders();
