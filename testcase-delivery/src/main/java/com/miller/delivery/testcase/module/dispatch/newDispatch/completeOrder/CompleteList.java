package com.miller.delivery.testcase.module.dispatch.newDispatch.completeOrder;
 ...
 */
@Scenario(
        scenarioID = "01KK12NZ6FYPGQASM7T8QSKEGA",
        scenarioName = "新调度-已完成列表",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-已完成列表")
public class CompleteList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryOrder/completeList";
        String method = "POST";
