...
/**
 * 司管后台-订单管理-实时看板-远距离尾单-新老骑手报表（全距离）
 *
 * Apifox: docs/d-apifox/toCheck/全距离-新老骑手报表.apifox-cli.json
 */
@Scenario(
        scenarioID = "01JPPQ7G5SH35HRBBH64NM9M0P",
        scenarioName = "司管后台-订单管理-实时看板-远距离尾单-新老骑手报表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("全距离新老骑手报表")
public class AllDistanceNewOldDriverReportTests {

    @DisplayName("新老骑手报表（全距离）")
    @Test
    void shouldGetNewOldDriverReportForAllDistance() {
        // 1) 司管登录获取 token
