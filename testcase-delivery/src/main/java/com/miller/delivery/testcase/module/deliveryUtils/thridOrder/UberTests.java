...
/**
 * C侧下即时单-自动化平台页面一键创建uber订单，需要参数构造
 *
...
public class UberTests {
    ...
    private static final long PRODUCT_ID = 82641675L;
    ...
    public Long getShopProductInfo(String userAppAccessToken) {
        ...
        var requestBody = "{\"deliveryType\":1,\"shopId\":490145156}";
    ...
    public Long addToCart(String userAppAccessToken) {
        ...
        var requestBody = String.format("{\"deliveryType\":1,\"shopId\":490145156,\"items\":[{\"productId\":%d,\"purchaseTime\":%d,\"skuId\":0,\"stability\":0}]}", PRODUCT_ID, nowTime);
    ...
    public void createVirtualOrder(String userAppAccessToken, Long shopId) {
        ...
        var requestBody = String.format("{\"orderType\":1,\"openRedPacket\":0,\"autoUseRedPacketStatus\":1,\"orderReqType\":0,\"deliveryType\":0,\"platform\":1,\"addressId\":1398683792,\"productCartList\":\"[{\\\"PRODUCT_ID\\\":%d,\\\"skuId\\\":0,\\\"stability\\\":0,\\\"tagId\\\":[]}]\",\"payType\":0,\"verify\":0,\"shopId\":%d,\"stability\":0,\"requestSourceType\":0}", PRODUCT_ID, shopId);
        
        var responseBody = TestCaseHelpful.sendRequest(method, uri, null, headers, requestBody);
        TestCaseHelpful.assertThatJson(responseBody).node("resultCode").isEqualTo(1000);
    }
    /**
     * 创建订单 地址必须是 addressId=1398683792
     *
     *
     */
    public String createOrder(String userAppAccessToken, Long shopId) {
        ...
        var requestBody = String.format("{\"deliveryTime\":\"尽快送达\",\"deliverableAction\":\"17\",\"tablewareCount\":\"1\",\"userPhone\":\"86 19539027926\",\"orderReqType\":\"1\",\"deliveryType\":\"1\",\"platform\":\"1\",\"addressId\":\"1398683792\",\"productCartList\":[{\"pickUpType\":0,\"productId\":%d,\"secKillFlag\":0,\"skuId\":0,\"tagId\":[]}],\"payType\":\"16\",\"saType\":\"0\",\"verify\":\"0\",\"shopId\":\"490145156\",\"superValueExchangeList\":null,\"tipPrice\":4.39,\"needNumberMasking\":false,\"isOnlinePay\":true}", PRODUCT_ID);
