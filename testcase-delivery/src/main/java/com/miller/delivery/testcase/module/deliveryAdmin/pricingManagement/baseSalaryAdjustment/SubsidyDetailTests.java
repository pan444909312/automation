 ...
 */
@Scenario(
        scenarioID = "01KGS55BPCKCV9WMQ97JKZ8NFH",
        scenarioName = "查看补贴调整配置",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("查看补贴调整配置")
public class SubsidyDetailTests {
    ...
    public void detail(String token,String id) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/subsidyAdjust/detailConfig";
        String method = "POST";
        Map<String, Object> headers = createErpHeaders();
        headers.put("authorization", token);
        String body = "{\"adjustmentNo\":\""+id+"\"}";
