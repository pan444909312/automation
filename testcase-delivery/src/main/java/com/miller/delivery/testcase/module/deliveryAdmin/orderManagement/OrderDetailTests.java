package com.miller.delivery.testcase.module.deliveryAdmin.orderManagement;
...
@Scenario(
        scenarioID = "01JPS9SB74HXXH10JB3G4EPQQ3",
        scenarioName = "司管后台-订单管理-实时看板-订单数据-获取订单详情页数据",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取订单详情数据")
public class OrderDetailTests {
    ...
    void shouldGetOrderDetail() {
        ...
        String body = "{\"orderSn\":\"729488959833971737410\"}";
