 ...
 */
@Scenario(
        scenarioID = "01KJHQ96AF504NWSP3G2BK4H0J",
        scenarioName = "司管后台-roi-上线-活动群组下线司机数-导出",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-上线-活动群组下线司机数-导出")
public class OnlineOfflineDriversImportTests {
