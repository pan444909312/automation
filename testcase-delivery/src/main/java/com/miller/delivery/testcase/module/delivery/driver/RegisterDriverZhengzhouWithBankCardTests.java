 ...
 */
@Scenario(
        scenarioID = "01KEDNG43262W23GSYBG299HE9", // 需要从质量平台获取实际的 scenarioID
        scenarioName = "郑州市-注册骑手-有银行卡",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 300, maintenanceTime = 0, manualTestTime = 120)
@DisplayName("郑州市-注册骑手-有银行卡")
public class RegisterDriverZhengzhouWithBankCardTests {
    ...
    @DisplayName("完整端到端流程-郑州市注册骑手-有银行卡")
    @Test
    void shouldRegisterDriverZhengzhouWithBankCard() {
        // ========== 第一部分：准备数据 ==========
        // 步骤1: 从数据库获取最大手机号并+1
        preparePhoneNumber();
    ...
    private void registerNewDriver() {
        ...
        // 注意：郑州市的cityId需要根据实际情况调整（这里假设为2，需要确认）
        String body = String.format(
                "{\"country\":\"CN\",\"areaCode\":\"86\",\"password\":\"a9e18b3c663c627bd030c06fae4fe288\",\"captcha\":\"123456\",\"cityId\":2,\"account\":\"%s\",\"invitationCode\":\"LGAH7ETT\"}",
                newTel);
