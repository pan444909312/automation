 ...
 */
@Scenario(
        scenarioID = "01JWGRQT320P797RH26CMJZR6A",
        scenarioName = "骑手app-获取骑手认证信息",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("获取骑手认证信息")
public class DriverCertificationInfoTests {

    @DisplayName("认证信息-获取骑手认证信息")
    @Test
    void shouldGetDriverCertificationInfo() {
        // 1) 骑手登录获取 token
