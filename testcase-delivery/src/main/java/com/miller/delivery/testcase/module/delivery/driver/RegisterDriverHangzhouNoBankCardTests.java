 ...
 */
@Scenario(
        scenarioID = "01KEDNG43262W23GSYBG299HE7", // 需要从质量平台获取实际的 scenarioID
        scenarioName = "杭州-注册骑手-无银行卡",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 300, maintenanceTime = 0, manualTestTime = 120)
@DisplayName("杭州-注册骑手-无银行卡")
public class RegisterDriverHangzhouNoBankCardTests {
    ...
    @DisplayName("完整端到端流程-杭州注册骑手-无银行卡")
    @Test
    void shouldRegisterDriverHangzhouNoBankCard() {
        // ========== 第一部分：准备数据 ==========
        // 步骤1: 从数据库获取最大手机号并+1
        preparePhoneNumber();
