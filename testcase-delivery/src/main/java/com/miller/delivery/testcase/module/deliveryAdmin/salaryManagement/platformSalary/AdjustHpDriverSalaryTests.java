 ...
 */
@Scenario(
        scenarioID = "01KDQP7JMHVABQZKYR6GRHYMR0",
        scenarioName = "HP单个骑手调整薪资",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("调整HP单个骑手薪资")
public class AdjustHpDriverSalaryTests {

    @DisplayName("调整HP单个骑手薪资-完整流程")
    @Test
    void shouldAdjustHpDriverSalary() {
        // 1) 司管登录获取 token
        ...
        String adjustBody = String.format(
                "{\"amount\":\"10\",\"amountType\":2,\"city\":\"杭州市\",\"dateDesc\":\"%s\",\"driverId\":\"1398722226\",\"reasonType\":6,\"salaryBusinessType\":0}",
                dayBeforeYesterday);
