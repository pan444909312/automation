 ...
 */
@Scenario(
        scenarioID = "01KN1Y5WQBGSVFBWAHBEDEBQ1G",
        scenarioName = "手动添加禁止上线-解除管控",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("手动添加禁止上线-解除管控")
public class RelieveOnlinePunishTests {
    ...
    public void piliang(Long driverId,String token) {
        ...
        Map<String, Object> headers = createErpHeaders();
        headers.put("authorization", token);
        String body = "{\"relieveRemark\":\"自动化批量解除\",\"relieveType\":4,\"cityNameList\":[],\"areaIdList\":[],\"updateTimeStartStr\":null,\"updateTimeEndStr\":null,\"controlReason\":[],\"driverId\":\""+driverId+"\",\"driverName\":\"\",\"driverTel\":\"\",\"gradeTypeList\":[],\"punishActionList\":[],\"punishStatusList\":[0,1],\"driverBusinessType\":null,\"punishNo\":null}";
    ...
    public void relieve(String punish_no,String token) {
        ...
        Map<String, Object> headers = createErpHeaders();
        headers.put("authorization", token);
        String body = "{\"relieveRemark\":\"自动化解除人工禁止上线\",\"relieveType\":2,\"punishNo\":\""+punish_no+"\"}";
