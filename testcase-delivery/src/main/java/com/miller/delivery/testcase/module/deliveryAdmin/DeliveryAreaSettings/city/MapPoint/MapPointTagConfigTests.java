...
/**
 * 司管后台-城市区域配置-城市-城市地图网格标签获取
 */
@Scenario(
        scenarioID = "01KJHXBVXKRPB3FF9TQZWHY09D",
        scenarioName = "城市地图网格标签获取",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("城市地图网格标签获取")
public class MapPointTagConfigTests {
    @DisplayName("城市地图网格标签获取")
    @Test
    ...
    public  void  mapPointTagConfig(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/mapPoint/tag/config";
        String method = "POST";
