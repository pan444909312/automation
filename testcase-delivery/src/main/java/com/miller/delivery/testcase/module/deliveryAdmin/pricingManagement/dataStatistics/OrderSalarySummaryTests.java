...
@Scenario(
        scenarioID = "01KP0K0N846EQCCCSF63VWGKM9",
        scenarioName = "司管后台-骑手收入定价管理-数据统计列表指标",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("数据统计列表指标")
public class OrderSalarySummaryTests {
    ...
    void shouldGetOrderDataList() {
        ...
        // 3) 获取订单数据列表
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/orderSalary/summary";
        String method = "POST";
