...
@Scenario(
        ...
        scenarioName = "骑手app-骑手中心列表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("骑手中心列表")
public class DriverCenterListTests {

    @DisplayName("骑手中心列表")
    @Test
    void shouldGetDriverCenterList() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 骑手中心列表
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/driverCenter/list";
        String method = "POST";
