...
@Scenario(
        ...
        scenarioName = "司管后台-roi-加价活动-点击活动司机数",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-加价活动-点击活动司机数")
public class PricingClickDriversTests {
    ...
    public void capacityAreaInfo(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryDashboard/activity/roi/clickDrivers";
        String method = "POST";
