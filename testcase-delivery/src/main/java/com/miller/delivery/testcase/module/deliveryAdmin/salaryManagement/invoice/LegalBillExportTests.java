package com.miller.delivery.testcase.module.deliveryAdmin.salaryManagement.invoice;
 ...
 */
@Scenario(
        scenarioID = "01KDT261DTSKEADG8HW4EJYN1T",
        scenarioName = "法务账单-导出",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("法务账单-导出")
public class LegalBillExportTests {

    @DisplayName("法务账单列表-导出")
    @Test
    void shouldExportLegalBill() {
        // 1) 司管登录获取 token
        ...
        // 3) 法务账单列表-导出
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/act/data/listExport";
        String method = "POST";
        Map<String, Object> headers = createHeaders(token);
        String body = String.format(
                "{\"date\":[\"%s\",\"%s\"],\"city\":\"郑州市\",\"dateStart\":\"%s\",\"dateEnd\":\"%s\"}",
