...
@DisplayName("西雅图法案订单列表")
public class SeattleBillOrderListTests {

    @DisplayName("西雅图法案订单列表")
    @Test
    void shouldGetSeattleBillOrderList() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 西雅图法案订单列表
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/act/settle/batchOrderContent";
        String method = "POST";
