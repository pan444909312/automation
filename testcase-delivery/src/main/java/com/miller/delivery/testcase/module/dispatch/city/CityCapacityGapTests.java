package com.miller.delivery.testcase.module.dispatch.city;
 ...
 */
@Scenario(
        scenarioID = "01JPPF7ZAFXN5PC1SMYMTPTJBY", // 自动生成，不要修改
        scenarioName = "【主干用例】调度系统-订单列表-获取ND数据",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取城市ND")
public class CityCapacityGapTests {
    String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/city/order/capacity/gap";
    String method = "POST";
    String params = null;
    String assertFullField = "module/dispatch/city/capacityGap/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/city/capacityGap/request/headers.json");
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/city/capacityGap/request/body.json");
