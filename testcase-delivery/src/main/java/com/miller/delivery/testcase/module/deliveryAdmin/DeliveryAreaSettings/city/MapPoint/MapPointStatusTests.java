 ...
 */
@Scenario(
        scenarioID = "01KJHY5J3ZS52RQ35BPRBJT0Z4",
        scenarioName = "城市地图网格点位状态",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("城市地图网格点位状态")
public class MapPointStatusTests {
    @DisplayName("城市地图网格点位状态")
    @Test
    ...
    public  void  mapPointTagConfig(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/mapPoint/stats";
        String method = "POST";
