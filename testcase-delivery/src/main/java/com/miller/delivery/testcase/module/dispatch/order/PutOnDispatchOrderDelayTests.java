 ...
 */
@Scenario(
        scenarioID = "01JPPMZN73BHKE7CZMM308SQHK",
        scenarioName = "调度系统-订单挂起-延迟挂起",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("延迟挂起")
public class PutOnDispatchOrderDelayTests {

    @DisplayName("正向流程")
    @Test
    void shouldDelayPutOnDispatchOrder() {
        // 步骤1: 先登录获取token
        String token = erpLogin();
        
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/putOnDispatchOrderDelay/request/headers.json");
        ...
        // 步骤4: 发起请求
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/order/putOnDispatchOrderDelay";
        String method = "POST";
