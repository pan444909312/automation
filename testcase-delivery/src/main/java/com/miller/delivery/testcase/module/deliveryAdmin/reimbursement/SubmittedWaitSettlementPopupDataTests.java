...
@Scenario(
        scenarioID = "01KDQA6W0FT2Y68QSW7C517C32",
        scenarioName = "骑手个人薪资-已提交待结算",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取已提交待结算弹窗数据")
public class SubmittedWaitSettlementPopupDataTests {

    @DisplayName("获取已提交待结算弹窗数据")
    @Test
    void shouldGetSubmittedWaitSettlementPopupData() {
        // 1) 司管登录获取 token
