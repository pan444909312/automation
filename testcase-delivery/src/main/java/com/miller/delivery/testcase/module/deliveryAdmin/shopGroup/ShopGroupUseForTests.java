 ...
 */
@Scenario(
        scenarioID = "01KDT3NN72XY85PVND6NVY07EK",
        scenarioName = "商家群组-查看商家群组应用情况",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("查看商家群组应用情况")
public class ShopGroupUseForTests {
    ...
    @DisplayName("查看商家群组应用情况")
    @Test
    void shouldGetShopGroupUseFor() {
        // 1) 司管登录获取 token
        String token = erpLogin();

        // 2) 查看商家群组应用情况
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/shopGroup/groupUseFor";
        String method = "POST";
