...
@Scenario(
        scenarioID = "01JPPP1XQKANKWRF7NCWR92H8C",
        scenarioName = "司管后台-排班计划-获取计划列表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("获取计划列表")
public class CapacityPlanListTests {

    @DisplayName("获取计划列表")
    @Test
    void shouldGetCapacityPlanList() {
        // 1) 司管登录获取 token
        String token = erpLogin();

        // 2) 获取计划列表
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/capacityPlan/list";
        String method = "POST";
