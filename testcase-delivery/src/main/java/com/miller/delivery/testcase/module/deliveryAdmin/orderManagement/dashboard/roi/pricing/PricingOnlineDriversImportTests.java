 ...
 */
@Scenario(
        scenarioID = "01KJHNG47V6RETYEVYKBGYH92N",
        scenarioName = "司管后台-roi-加价活动-活动群组在线司机数-导出",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-加价活动-活动群组在线司机数-导出")
public class PricingOnlineDriversImportTests {
    ...
    public void capacityAreaInfo(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryDashboard/activity/roi/onlineDrivers/export";
        String method = "POST";
