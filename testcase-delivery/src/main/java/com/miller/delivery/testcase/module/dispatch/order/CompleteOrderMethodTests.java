...
@Scenario(
        ...
        scenarioName = "调度系统-订单-联系不到用户调度完成送达",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("联系不到用户调度完成送达")
public class CompleteOrderMethodTests {

    @DisplayName("正向流程")
    @Test
    void shouldCompleteOrderMethod() {
        // 步骤1: 先登录获取token
        ...
        // 步骤3: 设置请求体
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/order/completeOrderMethod/request/body.json");
        requestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.orderSn", "2701360924750706281430");
        requestBody = TestCaseHelpful.updateJsonValue(requestBody, "$.solveType", 1);
