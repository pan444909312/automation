...
/**
 * 司管_HP基础定价_查询A城B区域HP定价配置详情
 *
 * Apifox: docs/d-apifox/toCheck/司管_HP基础定价_查询A城B区域HP定价配置详情.apifox-cli.json
 */
@Scenario(
        scenarioID = "01KDQ2ZDAPCN9C98MQN0C5G7G4",
        scenarioName = "司管_HP基础定价_查询A城B区域HP定价配置详情",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("查询A城B区域HP定价配置详情")
public class HpPriceRuleAreaDetailTests {
    ...
    @DisplayName("查询A城B区域HP定价配置详情")
    @Test
    void shouldQueryAreaHpPriceRuleDetail() {
        // 1) 司管登录获取 token
        ...
        // 4) 提取ruleId（按 apifox 选择 HpPriceRuleId1）
