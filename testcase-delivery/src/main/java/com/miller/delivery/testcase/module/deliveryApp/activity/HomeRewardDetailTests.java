 ...
 */
@Scenario(
        scenarioID = "01K18DYBZPZAS40J6MNESA0ZNF",
        scenarioName = "骑手app-首页奖励详情",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("首页奖励详情")
public class HomeRewardDetailTests {

    @DisplayName("首页奖励详情")
    @Test
    void shouldGetHomeRewardDetail() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 首页奖励详情
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/home/rewardDetail";
        String method = "POST";
        Map<String, Object> headers = createDriverAppHeaders();
        headers.put("authorization", driverAccessToken);
        
        // 使用固定日期（JSON中使用的是2025-07-28）
        String body = "{\"endDate\":\"2025-07-28\",\"pageNo\":1,\"pageSize\":10}";
