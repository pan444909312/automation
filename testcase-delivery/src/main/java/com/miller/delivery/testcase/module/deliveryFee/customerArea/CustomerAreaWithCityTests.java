 ...
 */
@Scenario(
        scenarioID = "01K8W58X1Y617GYF53HHHBGPXC",
        scenarioName = "对外接口-用户商圈-有城市",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 60)
@DisplayName("用户商圈-有城市")
public class CustomerAreaWithCityTests {

    @DisplayName("查询用户商圈-有城市")
    @Test
    void shouldQueryCustomerAreaWithCity() {
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryFee/customerArea/gps";
        String method = "POST";
        
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/deliveryFee/customerArea/withCity/request/headers.json");

        headers.put("Content-Type", "application/json");

        var requestBody = TestCaseHelpful.getJsonRequestBody("module/deliveryFee/customerArea/withCity/request/body.json");
    ...
    @Test
    void shouldQueryCustomerAreaWithCityWithoutCity() {
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryFee/customerArea/gps";
        String method = "POST";
    ...
    @Test
    void shouldQueryCustomerAreaWithCityWithoutLat() {
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryFee/customerArea/gps";
        String method = "POST";
    ...
    @Test
    void shouldQueryCustomerAreaWithCityWithoutLon() {
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryFee/customerArea/gps";
        String method = "POST";
