 ...
 */
@Scenario(
        scenarioID = "01KK1A458PVD9BGKHD107M60TH",
        scenarioName = "新调度-订单拒绝骑手列表",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-订单拒绝骑手列表")
public class RejectList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryDriver/rejectList";
        String method = "POST";
