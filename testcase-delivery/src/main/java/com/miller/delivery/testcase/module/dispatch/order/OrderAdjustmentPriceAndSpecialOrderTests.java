...
public class OrderAdjustmentPriceAndSpecialOrderTests {
    ...
    void shouldCompleteAdjustmentPriceAndSpecialOrderFlow() {
        ...
        // ========== 第二部分：骑手操作流程 ==========
        // 步骤7: 骑手app-骑手登录
        Map<String, String> driverLoginInfo = TestCaseHelpful.deliveryLoginReturndriverId("13300010871", "Test1234");
        ...
        driverOffline.cancelDispatchAndOffline("13300010871",driverAccessToken);
        // 步骤8: 骑手app-司机上线操作
...
//
        ...
        // 步骤13: 调度-新增特殊单
        createSpecialOrder(siGuanToken, userAppOrderSn);
    }
