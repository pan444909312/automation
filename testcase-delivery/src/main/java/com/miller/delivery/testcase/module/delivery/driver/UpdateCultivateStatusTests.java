 ...
 */
@Scenario(
        scenarioID = "01JYRFM5B7GZ1QKCCV1EFVX6BG",
        scenarioName = "骑手app-更新骑手培训已执行数",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("更新骑手培训已执行数")
public class UpdateCultivateStatusTests {

    @DisplayName("更新骑手培训已执行数")
    @Test
    void shouldUpdateCultivateStatus() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 更新骑手培训已执行数
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/cultivate/modifyCultivateStatus";
        String method = "POST";
