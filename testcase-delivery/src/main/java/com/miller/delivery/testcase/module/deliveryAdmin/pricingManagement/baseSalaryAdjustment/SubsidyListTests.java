 ...
 */
@Scenario(
        scenarioID = "01KGS55CTP8C67N913H650QP15",
        scenarioName = "获取补贴调整配置列表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("获取补贴调整配置列表")
public class SubsidyListTests {
    ...
    public void list(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/subsidyAdjust/list";
        String method = "POST";
