 ...
 */
@Scenario(
        scenarioID = "01JPPETX60A2K0HMGNQCGEC3TJ", // 自动生成，不要修改
        scenarioName = "调度系统-获取基础信息-获取当前用户的城市列表",
        author = "chenchunxia@hungrypandagroup.com", // 配置本机 Git email 后可自动生成
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("获取当前用户的城市列表")
public class UserCityListTests {
    ...
    String assertFullField = "module/dispatch/city/userCityList/response/assert_full_field.json";
    ...
    void shouldSuccess() {
        ...
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/city/userCityList/request/headers.json");
        // 设置请求头参数
        ...
        var requestBody = TestCaseHelpful.getJsonRequestBody("module/dispatch/city/userCityList/request/body.json");
