...
@Scenario(
        scenarioID = "01KNS7CNJ4DH3JB4NYT6BK5GZK",
        scenarioName = "司管后台-骑手收入定价管理-区域加价-保存到草稿",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("保存到草稿")
public class AddRewardDraftTests {
    ...
    void shouldGetOrderDataList() {
        ...
        addRewardDraft(token);



    }

    public static String addRewardDraft(String token){
        String todayDate = LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        String activityName = "自动化创建加价活动" + todayDate;

        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/reward/addRewardDraft";
        ...
        Object countObj = result.get("reward_sn");
