...
public class StuartTests {

    private static final long PRODUCT_ID = 82645944;
    private static final long SHOP_ID = 666046499;
    private static final long ADDRESS_ID = 1398668316;

    @DisplayName("Stuart下单")
    @Test
    public void  createOrder() {
        ...
        int num = 1;
                ...
                System.out.println("Stuart单号===="+userAppOrderSn);
                // 更新订单构造参数
