 ...
 */
@Scenario(
        scenarioID = "01KK13YASHDQSQZR7FMFBD65MR",
        scenarioName = "新调度-运力数据",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-运力数据")
public class ApacityloadData {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/city/area/capacity/loadData";
        String method = "POST";
