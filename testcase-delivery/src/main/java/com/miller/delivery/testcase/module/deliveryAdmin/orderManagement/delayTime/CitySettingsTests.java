...
@Scenario(
        scenarioID = "01JPSS4F8TT10D3MR72KRTAR7R",
        scenarioName = "司管后台-订单管理-考核时间设置-获取城市下所有设置",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("获取城市下的所有设置")
public class CitySettingsTests {

    @DisplayName("获取城市下所有设置")
    @Test
    void shouldGetCitySettings() {
        // 1) 司管登录获取 token
        String token = erpLogin();

        // 2) 获取城市下所有设置
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/delivery/delay/time/onShopConfigList";
        String method = "POST";
