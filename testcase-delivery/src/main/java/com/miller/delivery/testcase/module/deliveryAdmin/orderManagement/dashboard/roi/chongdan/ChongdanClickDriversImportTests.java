 ...
 */
@Scenario(
        scenarioID = "01KJHQJ9KME9WYXZX55QB05226",
        scenarioName = "司管后台-roi-冲单-点击活动司机数-导出",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-冲单-点击活动司机数-导出")
public class ChongdanClickDriversImportTests {
