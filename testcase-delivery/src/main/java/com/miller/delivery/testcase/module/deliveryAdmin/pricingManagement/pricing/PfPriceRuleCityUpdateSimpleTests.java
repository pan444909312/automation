...
@Scenario(
        scenarioID = "01KDQHDKK7T1K7CKX4AENJBSM9",
        scenarioName = "司管_PF基础定价_修改全城PF定价_不区分载具+时段+群组",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("修改全城PF定价_不区分载具+时段+群组")
public class PfPriceRuleCityUpdateSimpleTests {
    ...
    @DisplayName("修改全城PF定价_不区分载具+时段+群组")
    @Test
    void shouldUpdatePfPriceRuleCitySimple() {
        // 1) 司管登录获取 token
