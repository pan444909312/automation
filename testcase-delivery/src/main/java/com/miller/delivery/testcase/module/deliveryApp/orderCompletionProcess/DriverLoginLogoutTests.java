 ...
 */
@Scenario(
        scenarioID = "01JPP7TK7BGAFESGMT17HCZXAC",
        scenarioName = "【主干用例】骑手app-登录登出",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("骑手登录、登出")
public class DriverLoginLogoutTests {
    ...
    void shouldLoginAndLogout() {
        ...
        // 2) 骑手退出
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/auth/logout";
        String method = "POST";
