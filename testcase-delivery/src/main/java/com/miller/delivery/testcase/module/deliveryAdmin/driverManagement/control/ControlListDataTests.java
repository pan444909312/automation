 ...
 */
@Scenario(
        scenarioID = "01KDQ7YYS4BX39HWTTJ3S26NE3",
        scenarioName = "【主干场景】司管后台-骑手管控-获取管控列表数据",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 20, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("获取管控列表数据")
public class ControlListDataTests {

    @DisplayName("查询管控列表数据")
    @Test
    void shouldFetchControlList() {
        // 1) 司管登录获取 token
