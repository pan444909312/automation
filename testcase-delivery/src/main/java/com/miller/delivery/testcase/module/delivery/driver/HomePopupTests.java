 ...
 */
@Scenario(
        scenarioID = "01JPP6VBNT9BFZJPDWCKA8QSE5",
        scenarioName = "骑手app-个人资料-首页弹窗app/home/homePopup",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("首页弹窗-新app/home/homePopup")
public class HomePopupTests {

    @DisplayName("首页弹窗")
    @Test
    void shouldGetHomePopup() {
        // 1) 骑手登录获取 token
