 ...
 */
@Scenario(
        scenarioID = "01KJHQM6RPX78REDMJ4W5HCQBP",
        scenarioName = "司管后台-roi-冲单-打开APP上线司机数-导出",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-冲单-打开APP上线司机数-导出")
public class ChongdaOpenAppOnlineDriversImportTests {
