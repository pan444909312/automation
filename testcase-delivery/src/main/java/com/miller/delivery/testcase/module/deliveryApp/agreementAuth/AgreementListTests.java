 ...
 */
@Scenario(
        scenarioID = "01JZ4WK0P5YAGT0BG0D6VXF5QS",
        scenarioName = "骑手app-获取协议列表",
        author = "chenchunxia@hungrypandagroup.com",
...
public class AgreementListTests {
    ...
    @DisplayName("获取协议列表")
    @Test
    void shouldGetAgreementList() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 获取协议列表
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/agreement/list";
        String method = "POST";
