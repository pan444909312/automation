...
public class SalaryListExportTests {
    ...
    @DisplayName("薪资列表-导出一个骑手")
    @Test
    void shouldExportSalaryListForOneDriver() {
        // 1) 司管登录获取 token
        ...
        // 3) 薪资列表-导出一个骑手
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/salary/manager/downloadFile";
        String method = "POST";
    ...
    @DisplayName("薪资列表-导出多个骑手")
    @Test
    void shouldExportSalaryListForMultipleDrivers() {
        // 1) 司管登录获取 token
        String token = erpLogin();
