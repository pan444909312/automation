 ...
 */
@Scenario(
        scenarioID = "01JYRFGE1THXTXH60XZBXYSF8W",
        scenarioName = "骑手app-个人信息设置页",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 10, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("个人信息设置页")
public class PersonalInfoSettingsTests {

    @DisplayName("个人信息设置页")
    @Test
    void shouldGetPersonalInfoSettings() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 个人信息设置页
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/config/loadConfig";
        String method = "POST";
