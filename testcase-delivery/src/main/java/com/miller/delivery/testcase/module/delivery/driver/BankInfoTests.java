 ...
 */
@Scenario(
        scenarioID = "01JPP6SJ7WG0EVTRZ7Q7GTEZV6",
        scenarioName = "骑手app-个人资料-银行卡信息",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("个人资料-银行卡信息")
public class BankInfoTests {

    @DisplayName("银行信息/bank/bankInfo")
    @Test
    void shouldGetBankInfo() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 银行信息/bank/bankInfo
    ...
    private Map<String, Object> createDriverAppHeaders() {
        ...
        headers.put("longitude", "120.21693");
        headers.put("latitude", "30.203517");
