 ...
 */
@Scenario(
        scenarioID = "01KK1AJNZK9KT2N0XQXK8TP3R8",
        scenarioName = "新调度-订单离线骑手tab",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-订单离线骑手tab")
public class OffLineDriverList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryDriver/offlineList";
        String method = "POST";
