...
@DisplayName("C侧下即时单-平台配送-杭州-滨江区-酒订单")
public class CreateInstantOrderWineTests {
    ...
    void shouldCreateInstantOrderWine() {
        ...
        // 步骤3: C侧下单-加购商品 (使用硬编码的productId=82493543)
    ...
    private void addToCart(String userAppAccessToken, Long shopId) {
        ...
        // 使用硬编码的productId=82493543 (酒订单)
        var requestBody = String.format("{\"deliveryType\":1,\"shopId\":%d,\"items\":[{\"productId\":82493543,\"purchaseTime\":%d,\"skuId\":0,\"stability\":0}]}", shopId, nowTime);
    ...
    private void createVirtualOrder(String userAppAccessToken, Long shopId) {
        ...
        // 使用硬编码的productId=82493543 (酒订单)
        var requestBody = String.format("{\"orderType\":1,\"openRedPacket\":0,\"autoUseRedPacketStatus\":1,\"orderReqType\":0,\"deliveryType\":0,\"platform\":1,\"addressId\":1398679458,\"productCartList\":\"[{\\\"productId\\\":82493543,\\\"skuId\\\":0,\\\"stability\\\":0,\\\"tagId\\\":[]}]\",\"payType\":0,\"verify\":0,\"shopId\":%d,\"stability\":0,\"requestSourceType\":0}", shopId);
    ...
    private String createOrder(String userAppAccessToken, Long shopId) {
        ...
        // deliverableAction=15, productId=82493543 (酒订单)
        var requestBody = "{\"deliveryTime\":\"尽快送达\",\"deliverableAction\":\"15\",\"tablewareCount\":\"1\",\"userPhone\":\"86+13251016327\",\"orderReqType\":\"1\",\"deliveryType\":\"1\",\"platform\":\"1\",\"addressId\":\"1398679388\",\"productCartList\":[{\"productId\":82493543,\"skuId\":0,\"stability\":0,\"tagId\":[]}],\"payType\":\"16\",\"verify\":\"0\",\"shopId\":\"892716498\",\"superValueExchangeList\":null,\"tipPrice\":0.24,\"needNumberMasking\":false,\"isOnlinePay\":true}";
        var responseBody = TestCaseHelpful.sendRequest(method, uri, null, headers, requestBody);
        TestCaseHelpful.assertThatJson(responseBody).node("resultCode").isEqualTo(1000);
