 ...
 */
@Scenario(
        scenarioID = "01K18C9VPF2M9FSRRB0RZQX8C0",
        scenarioName = "骑手app-老邀新奖励列表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@DisplayName("老邀新奖励列表")
public class InviteBonusListTests {

    @DisplayName("老邀新奖励列表")
    @Test
    void shouldGetInviteBonusList() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 老邀新奖励列表
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/driverSalary/inviteBonusList";
        String method = "POST";
