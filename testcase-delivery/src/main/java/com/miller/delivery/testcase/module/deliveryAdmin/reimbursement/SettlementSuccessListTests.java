...
@Scenario(
        scenarioID = "01KDQ9P7N6J7SJC58C9G3R5Z06",
        scenarioName = "骑手个人薪资-结算成功",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取结算成功tab下的数据")
public class SettlementSuccessListTests {

    @DisplayName("获取结算成功tab数据")
    @Test
    void shouldGetSettlementSuccessList() {
        // 1) 司管登录获取 token
        String token = erpLogin();

        // 2) 结算成功tab默认数据
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/reimbursement/settlementList";
        String method = "POST";
        Map<String, Object> headers = createHeaders(token);
        String body1 = "{\"cityList\":[],\"pageNo\":1,\"pageSize\":10,\"settlementStatus\":1}";
        ...
        // 4) 结算成功tab数据-查询杭州下的数据
        String body2 = "{\"cityList\":[\"杭州市\"],\"pageNo\":1,\"pageSize\":10,\"settlementStatus\":1}";
