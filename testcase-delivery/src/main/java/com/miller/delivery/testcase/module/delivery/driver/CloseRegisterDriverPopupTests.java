...
@Scenario(
        ...
        scenarioName = "骑手app-关闭骑手弹窗",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("关闭骑手弹窗")
public class CloseRegisterDriverPopupTests {

    @DisplayName("关闭骑手弹窗")
    @Test
    void shouldCloseRegisterDriverPopup() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 关闭骑手弹窗
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/auth/closeRegisterDriverPopup";
        String method = "POST";
