...
/**
 * 司管后台-订单管理-实时看板-远距离尾单-时段报表（全距离）
 *
 * Apifox: docs/d-apifox/toCheck/全距离-时段报表.apifox-cli.json
 */
@Scenario(
        scenarioID = "01JPPQ45918PZST2CNH9AYQF26",
        scenarioName = "司管后台-订单管理-实时看板-远距离尾单-时段报表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("全距离时段报表")
public class AllDistancePeriodReportTests {

    @DisplayName("获取当天时段报表（全距离）")
    @Test
    void shouldGetPeriodReportForAllDistance() {
        // 1) 司管登录获取 token
