...
@Scenario(
        scenarioID = "01KDQ9Q7VQ0KYRZ23W71441BYS",
        scenarioName = "骑手个人薪资-结算失败",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("获取结算失败tab下的数据")
public class SettlementFailedListTests {

    @DisplayName("获取结算失败tab数据")
    @Test
    void shouldGetSettlementFailedList() {
        // 1) 司管登录获取 token
