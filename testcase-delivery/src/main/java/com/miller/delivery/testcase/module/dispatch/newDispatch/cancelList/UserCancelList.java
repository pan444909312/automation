package com.miller.delivery.testcase.module.dispatch.newDispatch.cancelList;
 ...
 */
@Scenario(
        scenarioID = "01KK12V7R05FMG5RNTEDQ1B0VM",
        scenarioName = "新调度-已取消列表",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-已取消列表")
public class UserCancelList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryOrder/userCancelList";
        String method = "POST";
