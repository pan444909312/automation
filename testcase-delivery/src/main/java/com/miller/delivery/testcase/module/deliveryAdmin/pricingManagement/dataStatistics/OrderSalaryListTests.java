...
@Scenario(
        scenarioID = "01KP0K0MM2BW8MEE66808EBR26",
        scenarioName = "司管后台-骑手收入定价管理-数据统计列表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("数据统计列表")
public class OrderSalaryListTests {
    ...
    void shouldGetOrderDataList() {
        ...
        // 3) 获取订单数据列表
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/orderSalary/list";
        String method = "POST";
