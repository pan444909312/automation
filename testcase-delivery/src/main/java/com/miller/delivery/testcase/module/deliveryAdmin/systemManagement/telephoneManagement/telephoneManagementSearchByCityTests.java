 ...
 */
@Scenario(
        scenarioID = "01KMYP73QWN2FN3SK4AMZ4KYZ1",
        scenarioName = "电话管理-列表-指定城市查询",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("电话管理-列表-指定城市查询")
public class telephoneManagementSearchByCityTests {

    @DisplayName("电话管理-列表-指定城市查询")
    @Test
    void telephoneManagementListSearchByCity() {
        // 1) 司管登录获取 token
        ...
        String body = "{\"cityName\":\"杭州市\",\"pageNo\":1,\"pageSize\":10}";
