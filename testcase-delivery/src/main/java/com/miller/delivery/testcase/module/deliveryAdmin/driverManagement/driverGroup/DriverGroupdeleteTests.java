 ...
 */
@Scenario(
        scenarioID = "01KGRXG45PZ31VMA3HHSMNCWR6",
        scenarioName = "删除群组",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("删除群组")
public class DriverGroupdeleteTests {
    ...
    public void delete(String token, int groupId) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/driverGroup/deleteDriverGroup";
        String method = "POST";
