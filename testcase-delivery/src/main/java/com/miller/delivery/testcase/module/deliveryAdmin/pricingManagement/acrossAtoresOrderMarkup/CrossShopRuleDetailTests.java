...
@Scenario(
        scenarioID = "01KP0HHMCC1YJEEA24ADS8VEPM",
        scenarioName = "司管后台-骑手收入定价管理-跨店订单加价-查看详情",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("查看详情-跨店订单加价")
public class CrossShopRuleDetailTests {
    ...
    public void detail(String token,String rewardSn){
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/price/crossShopRuleDetail";
        String body = String.format("{\"ruleId\":\""+rewardSn+"\"}");
