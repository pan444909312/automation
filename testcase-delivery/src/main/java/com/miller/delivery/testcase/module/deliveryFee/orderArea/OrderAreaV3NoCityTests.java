 ...
 */
@Scenario(
        scenarioID = "01KJHEP2Z4E27VG0H7WBGS0ENE",
        scenarioName = "对外接口-接单商圈-无城市V3",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 60)
@DisplayName("接单商圈-无城市")
public class OrderAreaV3NoCityTests {

    @DisplayName("查询接单商圈（入参无城市）")
    @Test
    void shouldQueryOrderAreaNoCity() {
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryFee/orderArea/gps/v3";
        String method = "POST";
