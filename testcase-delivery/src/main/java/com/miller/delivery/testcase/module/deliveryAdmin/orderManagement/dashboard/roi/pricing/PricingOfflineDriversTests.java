 ...
 */
@Scenario(
        scenarioID = "01KJHNMEZJKMEAW4X3RW40QFPC",
        scenarioName = "司管后台-roi-加价活动-活动群组下线司机数",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-加价活动-活动群组下线司机数")
public class PricingOfflineDriversTests {
    ...
    public void capacityAreaInfo(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryDashboard/activity/roi/offlineDriver";
        String method = "POST";
