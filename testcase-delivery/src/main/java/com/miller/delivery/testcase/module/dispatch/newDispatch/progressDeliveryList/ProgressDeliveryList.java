package com.miller.delivery.testcase.module.dispatch.newDispatch.progressDeliveryList;
 ...
 */
@Scenario(
        scenarioID = "01KK123RS1WGM2T4074HNBV6ZS",
        scenarioName = "新调度-配送中列表",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-配送中列表")
public class ProgressDeliveryList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryOrder/progressDeliveryList";
        String method = "POST";
