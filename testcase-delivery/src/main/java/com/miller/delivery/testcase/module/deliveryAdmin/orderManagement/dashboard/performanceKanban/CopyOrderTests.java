...
@Scenario(
        scenarioID = "01KNS334PQKKWSQF3QZA82EJHP",
        scenarioName = "司管后台-订单管理-实时看板-订单数据-复制订单",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("复制订单")
public class CopyOrderTests {
    ...
    void shouldGetOrderDataList() {
        ...
        // 3) 获取订单数据列表
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/order/copyOrderInfo";
        String method = "POST";
