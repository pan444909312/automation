 ...
 */
@Scenario(
        scenarioID = "01KK17291Y3W8FN7SV3F4XSAPE",
        scenarioName = "新调度-订单推荐骑手列表",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-订单推荐骑手列表")
public class RecommendList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryDriver/recommendList";
        String method = "POST";
