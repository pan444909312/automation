 ...
 */
@Scenario(
        scenarioID = "01KDQR8AAY0MMQAHY8MCFKE7ES",
        scenarioName = "垫付管理-票据审核-获取待审核总数",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 20)
@DisplayName("票据审核-获取待审核的个数")
public class InvoiceAuditCountTests {
    ...
    @DisplayName("获取待审核总数")
    @Test
    void shouldGetPendingAuditCount() {
        // 1) 司管登录获取 token
        ...
        // 3) 获取待审核总数
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryAdmin/insteadOrder/insteadOrderAuditNum";
        String method = "POST";
        String body = String.format("{\"receiveDate\":[\"%s\",\"%s\"],\"pageNo\":1,\"pageSize\":10,\"auditStatus\":0,\"receiveDateStart\":\"%s\",\"receiveDateEnd\":\"%s\"}",
