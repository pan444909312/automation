 ...
 */
@Scenario(
        scenarioID = "01JPPN0M282MP5AYBNBREZJD2A",
        scenarioName = "调度系统-订单挂起-提前关闭挂起",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("提前关闭挂起")
public class PutOnDispatchOrderFinishTests {

    @DisplayName("正向流程")
    @Test
    void shouldFinishPutOnDispatchOrder() {
        // 步骤1: 先登录获取token
        String token = erpLogin();
        
        // 步骤2: 设置请求头
        Map<String, Object> headers = TestCaseHelpful.getHeaders("module/dispatch/order/putOnDispatchOrderFinish/request/headers.json");
