...
public class DispatchCombineAssignCompleteTests {
    ...
    void shouldCompleteCombineAssignAndCompleteFlow() {
        ...
        combineAssignOrders(siGuanToken, userAppOrderSn1, userAppOrderSn2,driverId);
     ...
     */
    private void combineAssignOrders(String siGuanToken, String orderSn1, String orderSn2,Long driverId) {
