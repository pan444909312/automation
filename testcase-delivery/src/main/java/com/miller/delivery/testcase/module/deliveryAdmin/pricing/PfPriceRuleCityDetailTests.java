...
@Scenario(
        scenarioID = "01KDQHCEHTB18657PT1VAQ0CZV",
        scenarioName = "司管_PF基础定价_查询A城全城PF定价配置详情",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("查询A城全城PF定价配置详情")
public class PfPriceRuleCityDetailTests {
    ...
    @DisplayName("查询A城全城PF定价配置详情")
    @Test
    void shouldGetPfPriceRuleCityDetail() {
        // 1) 司管登录获取 token
