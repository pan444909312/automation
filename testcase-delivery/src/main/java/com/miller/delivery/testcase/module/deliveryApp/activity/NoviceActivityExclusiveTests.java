...
@DisplayName("新人专区")
public class NoviceActivityExclusiveTests {

    @DisplayName("新人专区")
    @Test
    void shouldGetNoviceActivityExclusive() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 新人专区
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/noviceActivity/noviceActivityExclusive";
        String method = "POST";
