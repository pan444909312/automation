...
public class OrderDetailPageTests {
    ...
    void shouldGetOrderDetailPage() {
        ...
        // ========== 第四部分：获取订单详情页 ==========
        // 步骤14: 获取订单详情页
        getOrderDetailPage(driverAccessToken, userAppOrderSn);
    }
     ...
     * 获取订单详情页
     */
    private void getOrderDetailPage(String driverAccessToken, String orderSn) {
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/order/detail";
        String method = "POST";
        Map<String, Object> headers = createIOSDriverAppHeaders();
        headers.put("authorization", driverAccessToken);
