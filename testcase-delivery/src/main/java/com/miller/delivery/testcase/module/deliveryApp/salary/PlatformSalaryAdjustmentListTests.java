 ...
 */
@Scenario(
        scenarioID = "01JZ55DAQBECEVEPECZAAKTW4G",
        scenarioName = "骑手app-平台薪资调整列表",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 30)
@DisplayName("平台薪资调整列表")
public class PlatformSalaryAdjustmentListTests {

    @DisplayName("平台薪资调整列表")
    @Test
    void shouldGetPlatformSalaryAdjustmentList() {
        // 1) 骑手登录获取 token
        String driverAccessToken = TestCaseHelpful.deliveryLogin("13300010015", "Test1234");

        // 2) 平台薪资调整列表
        String uri = TestcaseConfig.HOST_DELIVERY_APP + "/api/delivery/app/driverSalary/bonus/platform/list";
        String method = "POST";
        Map<String, Object> headers = createDriverAppHeaders();
        headers.put("authorization", driverAccessToken);
        
        String body = "{\"pageNo\":2,\"pageSize\":10}";
