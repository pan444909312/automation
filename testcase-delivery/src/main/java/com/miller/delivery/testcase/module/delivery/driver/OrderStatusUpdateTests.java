...
public class OrderStatusUpdateTests {
    ...
    void shouldUpdateOrderStatus() {
        ...
        // ========== 第四部分：更新订单状态 ==========
        // 步骤14: 更新订单状态（到店）
        updateOrderStatus(driverAccessToken, userAppOrderSn, 1);
        
        // 步骤15: 更新订单状态（取餐）
        updateOrderStatus(driverAccessToken, userAppOrderSn, 2);
        
        // 步骤16: 更新订单状态（送达）
        updateOrderStatus(driverAccessToken, userAppOrderSn, 3);
    }
     ...
     */
    private void updateOrderStatus(String driverAccessToken, String orderSn, int operationType) {
        ...
        if (operationType == 1) {
            ...
            Object estimateOutMealMsg = TestCaseHelpful.extractValue(responseBody, 
                    "$.result.driverMerchantEstimateOutMealResp.estimateOutMealMsg");
