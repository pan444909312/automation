 ...
 */
@Scenario(
        scenarioID = "01KJHNG2YSVQ8KH8QR5DA148SD",
        scenarioName = "司管后台-roi-加价活动-活动群组在线司机数",
        author = "chenchunxia@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("司管后台-roi-加价活动-活动群组在线司机数")
public class PricingOnlineDriversTests {
    ...
    public void capacityAreaInfo(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/deliveryDashboard/activity/roi/onlineDrivers";
        String method = "POST";
