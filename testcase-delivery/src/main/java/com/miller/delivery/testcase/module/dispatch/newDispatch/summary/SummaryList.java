package com.miller.delivery.testcase.module.dispatch.newDispatch.summary;
 ...
 */
@Scenario(
        scenarioID = "01KK13213P4GS5JT0DN4CMWMC5",
        scenarioName = "新调度-列表统计",
        author = "TestingConsultant@hungrypandagroup.com",
        developmentTime = 60, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("新调度-列表统计")
public class SummaryList {
    ...
    public  void  unDispatchList(String token) {
        ...
        String uri = TestcaseConfig.HOST_ERP + "/api/dispatch/deliveryOrder/summaryList";
        String method = "POST";
