...
public class DistanceMismatchUploadTests {
    ...
    void shouldCompleteTranslateFlow() {
        ...
        // ========== 第二部分：骑手操作流程 ==========
        // 步骤7: 骑手app-骑手登录
        Map<String, String> driverLoginInfo = TestCaseHelpful.deliveryLoginReturndriverId("13300010870", "Test1234");
        ...
        driverOffline.cancelDispatchAndOffline("13300010870",driverAccessToken);
        ...
        // ========== 第四部分：翻译流程 ==========
        // 步骤14: 发送短信电话号码
        shouldUploadDistanceMismatchInfo( userAppOrderSn,driverAccessToken);
    ...
    void shouldSendSmsPhoneNumber(String driverAccessToken, String userAppOrderSn) {
        // 1) 骑手登录获取 token
    ...
    void shouldUploadDistanceMismatchInfo(String userAppOrderSn,String driverAccessToken) {
