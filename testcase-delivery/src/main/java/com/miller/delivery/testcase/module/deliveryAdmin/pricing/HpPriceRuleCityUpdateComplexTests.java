...
/**
 * 司管_HP基础定价_修改全城HP定价_区分载具+时段+群组
 *
 * Apifox: docs/d-apifox/toCheck/司管_HP基础定价_修改全城HP定价_区分载具+时段+群组.apifox-cli.json
 */
@Scenario(
        scenarioID = "01KDQC1Z9DMD0TTWWP8TAE2TRN",
        scenarioName = "司管_HP基础定价_修改全城HP定价_区分载具+时段+群组",
        author = "jiangbiao@hungrypandagroup.com",
        developmentTime = 120, maintenanceTime = 0, manualTestTime = 5)
@DisplayName("修改全城HP定价_区分载具+时段+群组")
public class HpPriceRuleCityUpdateComplexTests {
    ...
    @DisplayName("修改全城HP定价（区分载具+时段+群组）")
    @Test
    void shouldUpdateHpPriceRuleCityComplex() {
        // 1) 司管登录获取 token
