package com.miller.erp.moudle.manage.merchant.finance.commission.flow;
...
public class SaveCommissionFlow {
    ...
    public static SaveCommissionResponseDTO saveCommission(SaveCommissionRequestDTO saveCommissionRequestDTO) {
        // 更改请求头中的Content-Type参数。不要重新调用 RequestUtils.setHeaders(header)，因为请求头中已经包含了token
        RequestUtils.getHeaders().put("Content-Type", "application/json");

        return HttpUtils.sendPostRequestReturnJavaObject(uri, null, RequestUtils.getHeaders(),
                RequestUtils.putBodyOfJson(saveCommissionRequestDTO), null, SaveCommissionResponseDTO.class);
    }
