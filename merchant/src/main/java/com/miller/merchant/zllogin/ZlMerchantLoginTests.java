package com.miller.merchant.zllogin;

import com.miller.merchant.constants.ResponseConstant;
import com.miller.merchant.zllogin.flow.MerchantLoginFlow;
...
@TestFramework
@DisplayName("商家-登录")
public class ZlMerchantLoginTests {
    ...
    @MethodSource("com.miller.merchant.zllogin.provider.MerchantLoginDataProvider#loginDataProviderFromDB")
    @ParameterizedTest
