package com.miller.merchant.order.outing.request;
 ...
 * @author Miller Shan
 * @version 1.0
 * @since 2023/12/21 19:59:02
 */
public class OutingOrderRequestDTO extends OrderTerminalStatusUpdateQueryReqVO {
