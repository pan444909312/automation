package com.miller.merchant.summi.order.list;

import com.miller.merchant.constants.ResponseConstant;
import com.miller.merchant.summi.order.list.flow.OrderListFlow;
...
@TestFramework
@DisplayName("商家-订单列表")
public class SummiOrderListTests {

    @MethodSource("com.miller.merchant.summi.order.list.provider.OrderListDataProvider#orderListOfStatus")
    @ParameterizedTest
