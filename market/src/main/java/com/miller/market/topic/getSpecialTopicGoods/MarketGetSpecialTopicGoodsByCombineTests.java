...
@EnvTag.Test
@TestFramework
@DisplayName("PF_组合促销专题商品")
public class MarketGetSpecialTopicGoodsByCombineTests {
    ...
    @ParameterizedTest
    @DisplayName("PF_正常流程_获取组合促销专题商品")
    ...
    static Stream<Arguments> staticDataProvider() {
        ...
        queryWrapper.eq("type", SpecialTopicTypeEnum.COMBINE_GOODS.getCode());
