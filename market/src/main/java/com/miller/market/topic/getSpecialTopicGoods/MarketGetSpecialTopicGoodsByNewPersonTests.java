...
@EnvTag.Test
@TestFramework
@DisplayName("PF_新人专题商品")
public class MarketGetSpecialTopicGoodsByNewPersonTests {
    ...
    static Stream<Arguments> staticDataProvider() {
        ...
        queryWrapper.eq("type", SpecialTopicTypeEnum.NEW_PERSON.getCode());
