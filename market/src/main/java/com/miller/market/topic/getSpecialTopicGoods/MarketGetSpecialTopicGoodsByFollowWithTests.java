...
@EnvTag.Test
@TestFramework
@DisplayName("PF_随心配专题商品")
public class MarketGetSpecialTopicGoodsByFollowWithTests {
    ...
    static Stream<Arguments> staticDataProvider() {
        ...
        queryWrapper.eq("type", SpecialTopicTypeEnum.FOLLOW_WITH.getCode());
