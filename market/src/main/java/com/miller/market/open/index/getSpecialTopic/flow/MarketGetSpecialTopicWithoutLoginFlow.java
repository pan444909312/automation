package com.miller.market.open.index.getSpecialTopic.flow;
 ...
 *
 */
public class MarketGetSpecialTopicWithoutLoginFlow {
    /**
     * 获取首页专题推荐
     */
    private static final String uri = BusinessConstant.DOMAIN + "/open/index/getSpecialTopic";

    public static MarketGetSpecialTopicResponseDTO getSpecialTopic(MarketGetSpecialTopicRequestDTO requestDTO) {
...
//        RequestUtils.getHeaders().put("Content-Type", "application/json;charset=UTF-8");
        return HttpUtils.sendPostRequestReturnJavaObject(uri, null,RequestUtils.getHeaders(),
                ...
                // 有请求参数
                RequestUtils.putBodyOfJson(requestDTO), null, MarketGetSpecialTopicResponseDTO.class);
    }
