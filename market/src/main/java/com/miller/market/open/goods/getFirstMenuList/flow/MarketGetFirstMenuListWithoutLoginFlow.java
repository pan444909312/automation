package com.miller.market.open.goods.getFirstMenuList.flow;
 ...
 *
 */
public class MarketGetFirstMenuListWithoutLoginFlow {
    /**
     * 获取首页商品流
     */
    private static final String uri = BusinessConstant.DOMAIN + "/open/goods/getFirstMenuList";

    public static MarketGetFirstMenuListResponseDTO getFirstMenuList(MarketGetFirstMenuListRequestDTO requestDTO) {
...
//        RequestUtils.getHeaders().put("Content-Type", "application/json;charset=UTF-8");
        return HttpUtils.sendPostRequestReturnJavaObject(uri, null,RequestUtils.getHeaders(),
                ...
                // 有请求参数
                RequestUtils.putBodyOfJson(requestDTO), null, MarketGetFirstMenuListResponseDTO.class);
    }
