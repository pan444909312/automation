 ...
 * 商品sku
 */
@Scenario(scenarioID = "01JVY5PFWENMGCVJRAKNEF31NH",
        scenarioName = "正常流程_未登录_获取多规格商品sku",
        author = "zhangpei@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 10)
@EnvTag.Test
@DisplayName("PF_商品sku")
public class MarketGetSkusWithoutLoginScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("PF_正常流程_未登录_获取多规格商品sku")
