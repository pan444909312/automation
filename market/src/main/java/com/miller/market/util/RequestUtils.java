...
public class RequestUtils {
    ...
    private static Map<String, Object> commonHeaders() {
        ...
        headers.put("deviceNumber", BusinessConstant.deviceNumber);
        ...
        headers.put("abTestGroups", BusinessConstant.abTestGroups);
...
//        headers.put("_ts",BusinessConstant._ts);
    ...
    public static <T> String putBodyOfJson(T t) {
        ...
        var requestSignatureKey = "urmxajd03lg1*L8pp65_#1flvjk342589fdgjl&911";
