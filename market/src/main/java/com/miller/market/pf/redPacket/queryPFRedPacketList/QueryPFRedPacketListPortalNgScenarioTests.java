...
@EnvTag.Test
@TestFramework
@Scenario(scenarioID = "01JQTWM49QEBEH2HDDCTTY61GR", scenarioName = "APP-进入用户首页-融合App端根据红包id过滤出生效的PF红包：红包站点不符合"
        , author = "zhangpei@hungrypandagroup.com", developmentTime = 30, maintenanceTime = 0, manualTestTime = 15)
@DisplayName("APP-根据红包id过滤出生效的PF红包：红包站点不符合")
public class QueryPFRedPacketListPortalNgScenarioTests {
    ...
    @ParameterizedTest
    @DisplayName("PF融合_根据红包id过滤出生效的PF红包:红包站点不符合")
